 ...
 */
public class Doc_PaymentAWN extends Doc_Payment
{
	/**
	 *  Constructor
	 ...
	 * 	@param trxName trx
	 */
	public Doc_PaymentAWN (MAcctSchema as, ResultSet rs, String trxName)
	{
		super (as, rs, trxName);
		System.out.println("Extension point of IDocFactory");
	}	//	Doc_Payment
