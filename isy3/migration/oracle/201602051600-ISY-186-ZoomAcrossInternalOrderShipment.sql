...
--  
INSERT INTO AD_Ref_Table (IsValueDisplayed,WhereClause,AD_Window_ID,AD_Ref_Table_UU,CreatedBy,Updated,Created,UpdatedBy,AD_Org_ID,IsActive,AD_Client_ID,EntityType,AD_Display,AD_Key,AD_Reference_ID,AD_Table_ID) VALUES ('N','C_Order_ID = @C_Order_ID@ AND C_DocTypeTarget_ID IN (SELECT dt.C_DocType_ID FROM C_DocType dt WHERE dt.DocBaseType = ''SOO'' AND dt.DocSubTypeSO = ''WP'' AND dt.IsInternal = ''Y'')',550003,'7374bd26-dfb1-4d38-82ed-e78b59383fe0',100,TO_DATE('2016-02-05 15:38:26','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2016-02-05 15:38:26','YYYY-MM-DD HH24:MI:SS'),100,0,'Y',0,'U',2169,2161,550076,259)
;

-- Feb 5, 2016 3:38:48 PM WIT
--  
INSERT INTO AD_RelationType (Type,IsDirected,AD_Reference_Target_ID,AD_RelationType_ID,Name,AD_RelationType_UU,AD_Client_ID,AD_Org_ID,CreatedBy,UpdatedBy,Created,Updated,IsActive,AD_Reference_Source_ID) VALUES ('I','N',550076,800004,'Z RelType Internal Order <-> Internal Shipment','1bf28d03-5b55-42e8-81e7-4e3a7d10a5f4',0,0,100,100,TO_DATE('2016-02-05 15:38:48','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2016-02-05 15:38:48','YYYY-MM-DD HH24:MI:SS'),'Y',550075)
;

-- Feb 5, 2016 3:46:05 PM WIT
--  
UPDATE AD_Ref_Table SET WhereClause='C_Order_ID = @C_Order_ID@ AND MovementType IN (''C-'') AND C_DocType_ID IN (SELECT dt.C_DocType_ID FROM C_DocType dt WHERE dt.IsInternal = ''Y'')', OrderByClause=NULL,Updated=TO_DATE('2016-02-05 15:46:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Reference_ID=550075
;
