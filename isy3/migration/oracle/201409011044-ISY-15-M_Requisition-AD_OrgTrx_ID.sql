...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Column SET FKConstraintName='ADOrgTrx_MRequisition', FKConstraintType='N',Updated=TO_DATE('2014-09-01 10:19:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=550297
;

-- Sep 1, 2014 10:19:39 AM WIT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
ALTER TABLE M_Requisition ADD AD_OrgTrx_ID NUMBER(10) DEFAULT NULL 
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Field_UU,AD_Org_ID,AD_Tab_ID,ColumnSpan,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsAdvancedField,IsCentrallyMaintained,IsDefaultFocus,IsDisplayed,IsDisplayedGrid,IsEncrypted,IsFieldOnly,IsHeading,IsQuickEntry,IsReadOnly,IsSameLine,Name,NumLines,SeqNo,SeqNoGrid,SortNo,Updated,UpdatedBy,XPosition) VALUES (0,550297,550715,'19ddd507-9d35-4438-9abe-7200d51396c3',0,641,2,TO_DATE('2014-09-01 10:29:52','YYYY-MM-DD HH24:MI:SS'),100,'Performing or initiating organization',0,'U','The organization which performs or initiates this transaction (for another organization).  The owning Organization may not be the transaction organization in a service bureau environment, with centralized services, and inter-organization transactions.','Y','N','Y','N','Y','Y','N','N','N','N','N','Y','Trx Organization',1,28,200,0,TO_DATE('2014-09-01 10:29:52','YYYY-MM-DD HH24:MI:SS'),100,4)
;
