...
--  
UPDATE AD_Field SET AD_Column_ID=550074, Help='The User identifies a unique user in the system. This could be an internal user or a business partner contact', Description='User within the system - Internal or Business Partner Contact', Name='User/Contact',Updated=TO_DATE('2013-04-16 15:36:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=550009
;

-- Apr 16, 2013 3:36:43 PM WIT
--  
ALTER TABLE Z_TaxInvoice ADD AD_User_ID NUMBER(10) DEFAULT NULL 
;

-- Apr 16, 2013 3:37:59 PM WIT
--  
UPDATE AD_Column SET IsActive='N',Updated=TO_DATE('2013-04-16 15:37:59','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=550021
;
