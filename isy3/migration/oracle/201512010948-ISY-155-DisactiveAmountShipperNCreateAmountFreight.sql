...
--  
INSERT INTO AD_Column (SeqNoSelection,IsSyncDatabase,Version,AD_Column_ID,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,IsKey,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Description,Help,Name,IsAllowCopy,Updated,CreatedBy,AD_Org_ID,IsActive,Created,UpdatedBy,IsToolbarButton,IsAlwaysUpdateable,AD_Client_ID,EntityType,IsEncrypted,IsSecure,AD_Element_ID,AD_Reference_ID,AD_Table_ID) VALUES (0,'N',0,551564,'N','N','N',0,'N',20,'N','N','N','Y','63f1d0ca-320e-4685-a944-78cc932458f9','Y','Amount','Amount in a defined currency','The Amount indicates the amount for this document line.','Amount','Y',TO_DATE('2015-12-01 09:30:31','YYYY-MM-DD HH24:MI:SS'),100,0,'Y',TO_DATE('2015-12-01 09:30:31','YYYY-MM-DD HH24:MI:SS'),100,'N','N',0,'U','N','N',1367,22,596)
;
...
--  
ALTER TABLE M_Freight ADD Amount NUMBER DEFAULT NULL 
;

-- Dec 1, 2015 9:31:02 AM WIT
--  
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,UpdatedBy,AD_Org_ID,CreatedBy,Updated,IsActive,IsDisplayedGrid,AD_Client_ID,ColumnSpan,AD_Column_ID,EntityType,Created) VALUES ('N',513,36,'N','N','Y',552781,'N','M_Freight_UU','88499168-96aa-499e-85f6-ddbd37a9f40e','N','N',100,0,100,TO_DATE('2015-12-01 09:31:02','YYYY-MM-DD HH24:MI:SS'),'Y','N',0,2,60894,'D',TO_DATE('2015-12-01 09:31:02','YYYY-MM-DD HH24:MI:SS'))
;
...
--  
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,Description,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,UpdatedBy,AD_Org_ID,CreatedBy,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,AD_Client_ID,ColumnSpan,AD_Column_ID,EntityType,Created) VALUES ('N',513,20,'N','N',160,'Y',552782,'N','The Amount indicates the amount for this document line.','Amount in a defined currency','Amount','c7de99ee-a9cb-401c-ad1a-c0935241103a','Y','N',100,0,100,TO_DATE('2015-12-01 09:31:02','YYYY-MM-DD HH24:MI:SS'),'Y','Y',160,0,2,551564,'U',TO_DATE('2015-12-01 09:31:02','YYYY-MM-DD HH24:MI:SS'))
;
...
--  
UPDATE AD_Field SET Name='Biaya Lain-lain',Updated=TO_DATE('2015-12-01 09:31:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=552782
;
