...
--  
ALTER TABLE M_MovementLine ADD M_ProductionLine_ID NUMBER(10) DEFAULT NULL 
;
...
--  
INSERT INTO AD_Val_Rule (Code,AD_Val_Rule_ID,EntityType,Name,Type,AD_Val_Rule_UU,CreatedBy,UpdatedBy,Updated,AD_Org_ID,IsActive,AD_Client_ID,Created) VALUES ('M_Production.Processed=''N'' AND M_Production.IsCreated=''Y'' AND M_Production.AD_Org_ID = @AD_Org_ID@ AND M_Production_ID NOT IN (SELECT DISTINCT M_Production_ID FROM M_Movement)',550158,'U','Z M_Production not generated','S','c4695c75-a65f-46db-b065-cc1768e4dc92',100,100,TO_DATE('2015-12-17 16:00:30','YYYY-MM-DD HH24:MI:SS'),0,'Y',0,TO_DATE('2015-12-17 16:00:30','YYYY-MM-DD HH24:MI:SS'))
;

-- Dec 17, 2015 4:24:54 PM WIT
--  
UPDATE AD_Process_Para SET AD_Val_Rule_ID=550158,Updated=TO_DATE('2015-12-17 16:24:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=550445
;

-- Dec 17, 2015 4:43:28 PM WIT
--  
UPDATE AD_Val_Rule SET Code='M_Production.Processed=''N'' AND M_Production.IsCreated=''Y'' AND M_Production.AD_Org_ID = @AD_Org_ID@ AND M_Production.M_Production_ID NOT IN (SELECT DISTINCT COALESCE(M_Production_ID,0) FROM M_Movement)',Updated=TO_DATE('2015-12-17 16:43:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=550158
;
