...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Column SET FKConstraintName='CBankAccount_CBPBankAccount', FKConstraintType='N',Updated=TO_DATE('2014-09-20 11:36:41','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=550456
;

-- Sep 20, 2014 11:36:41 AM WIT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
ALTER TABLE C_BP_BankAccount ADD C_BankAccount_ID NUMBER(10) DEFAULT NULL 
;
