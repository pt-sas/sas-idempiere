...
--  
INSERT INTO AD_Element (ColumnName,AD_Element_ID,Name,PrintName,AD_Element_UU,AD_Org_ID,CreatedBy,UpdatedBy,IsActive,AD_Client_ID,EntityType,Created,Updated) VALUES ('C_DocTypeKwitansi_ID',550503,'Document Type Kwitansi','Document Type Kwitansi','0cbb3e39-e667-4ad1-8924-293a5282ceb5',0,100,100,'Y',0,'U',TO_DATE('2016-06-22 10:03:04','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2016-06-22 10:03:04','YYYY-MM-DD HH24:MI:SS'))
;
...
-- Jun 22, 2016 10:06:55 AM WIT
--  
UPDATE AD_Val_Rule SET Code='GL_Category_ID = 800043 AND IsActive = ''Y''',Updated=TO_DATE('2016-06-22 10:06:55','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=550176
;

-- Jun 22, 2016 10:09:29 AM WIT
--  
INSERT INTO AD_Column (SeqNoSelection,IsSyncDatabase,Version,AD_Column_ID,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,IsKey,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Name,IsAllowCopy,Updated,CreatedBy,AD_Org_ID,IsActive,Created,UpdatedBy,IsToolbarButton,IsAlwaysUpdateable,AD_Client_ID,EntityType,IsEncrypted,IsSecure,FKConstraintType,AD_Element_ID,AD_Reference_ID,AD_Reference_Value_ID,AD_Table_ID,AD_Val_Rule_ID) VALUES (0,'N',0,551999,'N','N','N',0,'N',10,'N','N','N','Y','7463ed71-dfad-4b3c-a15e-0627b91535ad','Y','C_DocTypeKwitansi_ID','Document Type Kwitansi','Y',TO_DATE('2016-06-22 10:09:27','YYYY-MM-DD HH24:MI:SS'),100,0,'Y',TO_DATE('2016-06-22 10:09:27','YYYY-MM-DD HH24:MI:SS'),100,'N','N',0,'U','N','N','N',550503,18,170,217,550176)
;
...
--  
UPDATE AD_Column SET FKConstraintType='N', FKConstraintName='CDocTypeKwitansi_CDocType',Updated=TO_DATE('2016-06-22 10:09:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=551999
;

-- Jun 22, 2016 10:09:33 AM WIT
--  
ALTER TABLE C_DocType ADD C_DocTypeKwitansi_ID NUMBER(10) DEFAULT NULL 
;
...
--  
INSERT INTO AD_Field (SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,UpdatedBy,AD_Org_ID,CreatedBy,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry,AD_Client_ID,ColumnSpan,NumLines,IsAdvancedField,IsDefaultFocus,AD_Column_ID,EntityType,Created) VALUES (0,'N',167,0,'N','N',390,'Y',553036,'N','Document Type Kwitansi','d18ff604-1f1f-4959-9320-da6bc28203c8','Y','N',100,0,100,TO_DATE('2016-06-22 10:11:10','YYYY-MM-DD HH24:MI:SS'),'Y','Y',380,1,'N',0,1,1,'N','N',551999,'U',TO_DATE('2016-06-22 10:11:10','YYYY-MM-DD HH24:MI:SS'))
;
