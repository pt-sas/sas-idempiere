CREATE OR REPLACE FORCE VIEW "RV_UNPOSTED" ("AD_CLIENT_ID", "AD_ORG_ID", "CREATED", "CREATEDBY", "UPDATED", "UPDATEDBY", "ISACTIVE", "DOCUMENTNO", "DATEDOC", "DATEACCT", "AD_TABLE_ID", "RECORD_ID", "ISSOTRX", "POSTED", "PROCESSING", "PROCESSED", "DOCSTATUS", "PROCESSEDON") AS 
