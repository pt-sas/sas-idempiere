CREATE OR REPLACE VIEW "RV_OPENITEMTODATE" ( "AD_ORG_ID", "AD_CLIENT_ID", "DOCUMENTNO", "C_INVOICE_ID", "C_ORDER_ID", "C_BPARTNER_ID", "ISSOTRX", "DATEINVOICED", "DATEACCT", "NETDAYS", "DUEDATE", "DAYSDUE", "DISCOUNTDATE", "DISCOUNTAMT", "GRANDTOTAL", "C_CURRENCY_ID", "C_CONVERSIONTYPE_ID", "C_PAYMENTTERM_ID", "ISPAYSCHEDULEVALID", "C_INVOICEPAYSCHEDULE_ID", "INVOICECOLLECTIONTYPE", "C_CAMPAIGN_ID", "C_PROJECT_ID", "C_ACTIVITY_ID", "AD_ORGTRX_ID" )
AS
