CREATE OR REPLACE EDITIONABLE FUNCTION "INVOICEOPENTODATER" 
(
 ...
 FOR a IN Cur_Alloc LOOP
  ...
  v_PaidAmt := v_PaidAmt
   ...
   + Currencyconvert(v_Temp * v_MultiplierAP,
    a.C_Currency_ID, v_Currency_ID, a.DateTrx, v_ConversionType_ID, a.AD_Client_ID, a.AD_Org_ID);
