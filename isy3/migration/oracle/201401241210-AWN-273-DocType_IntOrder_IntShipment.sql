...
--  
INSERT INTO AD_Sequence (StartNewYear,CurrentNextSys,IsTableID,CurrentNext,IsAudited,IsAutoSequence,AD_Sequence_ID,Description,Name,IncrementNo,AD_Sequence_UU,AD_Org_ID,Created,CreatedBy,MaxValue,UpdatedBy,Updated,IsActive,IsOrgLevelSequence,StartNo,StartNewMonth,AD_Client_ID) VALUES ('N',50000,'N',1000000,'N','Y',550880,'MM Shipment','Internal Shipment',1,'e537fdc5-283c-4416-aa41-aafcf7fd828b',0,TO_DATE('2014-01-24 12:02:38','YYYY-MM-DD HH24:MI:SS'),100,0,100,TO_DATE('2014-01-24 12:02:38','YYYY-MM-DD HH24:MI:SS'),'Y','N',500000,'N',1000001)
;

-- Jan 24, 2014 12:02:57 PM WIT
--  
UPDATE AD_Sequence SET Description='Internal Shipment',Updated=TO_DATE('2014-01-24 12:02:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Sequence_ID=550880
;

-- Jan 24, 2014 12:03:15 PM WIT
--  
INSERT INTO C_DocType (DocNoSequence_ID,GL_Category_ID,C_DocType_ID,IsDefault,AD_PrintFormat_ID,DocBaseType,IsSOTrx,DocumentCopies,IsCreateCounter,IsIndexed,IsShipConfirm,IsSplitWhenDifference,IsDefaultCounterDoc,IsInTransit,IsPickQAConfirm,IsOverwriteDateOnComplete,IsOverwriteSeqOnComplete,C_DocType_UU,IsPrepareSplitDocument,PrintName,Name,IsDocNoControlled,HasCharges,HasProforma,CreatedBy,UpdatedBy,Updated,AD_Org_ID,IsActive,Created,IsChargeOrProductMandatory,EntityType,IsInternal,CreateTaxInvoice,IsAROther,AD_Client_ID) VALUES (550880,1000005,550157,'N',1000042,'MMS','Y',0,'Y','Y','N','N','N','N','N','N','N','f82bbda4-0d05-49bf-ac2c-9f389e986eb8','Y','Delivery Note','Internal Shipment','Y','N','N',100,100,TO_DATE('2014-01-24 12:03:15','YYYY-MM-DD HH24:MI:SS'),0,'Y',TO_DATE('2014-01-24 12:03:15','YYYY-MM-DD HH24:MI:SS'),'N','U','N','N','N',1000001)
;
...
--  
UPDATE C_DocType SET IsInternal='Y',Updated=TO_DATE('2014-01-24 12:03:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550157
;

-- Jan 24, 2014 12:03:38 PM WIT
--  
UPDATE C_DocType SET C_DocTypeShipment_ID=550157,Updated=TO_DATE('2014-01-24 12:03:38','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550156
;
