...
--  
INSERT INTO C_DocType (GL_Category_ID,C_DocType_ID,IsDefault,DocBaseType,IsSOTrx,DocumentCopies,IsCreateCounter,IsIndexed,IsShipConfirm,IsSplitWhenDifference,IsDefaultCounterDoc,IsInTransit,IsPickQAConfirm,EntityType,IsOverwriteDateOnComplete,IsOverwriteSeqOnComplete,C_DocType_UU,IsPrepareSplitDocument,PrintName,Name,IsDocNoControlled,HasCharges,HasProforma,CreatedBy,UpdatedBy,Updated,AD_Org_ID,IsActive,Created,IsChargeOrProductMandatory,IsAROther,AD_Client_ID) VALUES (1000006,550150,'N','API','N',1,'N','Y','N','N','N','N','N','U','N','N','d59bbbc0-cf67-4aae-9e45-722a6f703ed4','Y','AP Other','AP Other','N','N','N',100,100,TO_DATE('2013-06-17 15:56:26','YYYY-MM-DD HH24:MI:SS'),0,'Y',TO_DATE('2013-06-17 15:56:26','YYYY-MM-DD HH24:MI:SS'),'N','Y',1000001)
;
...
--  
UPDATE C_DocType SET PrintName='AP Invoice Other', Name='AP Invoice Other',Updated=TO_DATE('2013-06-17 15:57:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550150
;
...
--  
UPDATE C_DocType SET PrintName='AR Invoice Other', Name='AR Invoice Other',Updated=TO_DATE('2013-06-17 15:57:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550149
;
...
--  
UPDATE C_DocType SET IsSOTrx='Y',Updated=TO_DATE('2013-06-17 15:57:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550149
;

-- Jun 17, 2013 3:58:00 PM WIT
--  
UPDATE C_DocType SET C_DocTypeTaxInvoice_ID=550004,Updated=TO_DATE('2013-06-17 15:58:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550150
;

-- Jun 17, 2013 3:58:09 PM WIT
--  
UPDATE C_DocType SET C_DocTypeTaxInvoice_ID=550000,Updated=TO_DATE('2013-06-17 15:58:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550149
;

-- Jun 17, 2013 3:58:28 PM WIT
--  
UPDATE C_DocType SET IsCreateCounter='Y',Updated=TO_DATE('2013-06-17 15:58:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550150
;
