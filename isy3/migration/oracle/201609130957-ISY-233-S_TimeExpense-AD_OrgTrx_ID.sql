...
--  
UPDATE AD_Column SET FKConstraintType='N', FKConstraintName='ADOrgTrx_STimeExpense',Updated=TO_DATE('2016-09-13 09:48:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552284
;

-- Sep 13, 2016 9:48:35 AM WIT
--  
ALTER TABLE S_TimeExpense ADD AD_OrgTrx_ID NUMBER(10) DEFAULT NULL 
;
