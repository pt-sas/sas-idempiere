...
--  
ALTER TABLE Z_TaxInvoice ADD C_BPartner_ID NUMBER(10) DEFAULT NULL 
;

-- Apr 10, 2013 3:45:37 PM WIT
--  
INSERT INTO AD_Column (SeqNoSelection,Version,AD_Table_ID,AD_Column_ID,EntityType,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,ReadOnlyLogic,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Description,Help,Name,IsAllowCopy,Updated,CreatedBy,AD_Org_ID,IsActive,Created,UpdatedBy,AD_Client_ID,IsToolbarButton,IsEncrypted,IsSyncDatabase,IsAlwaysUpdateable) VALUES (0,0,550001,550037,'U','N','N','N',0,'N',1,'N',20,'N',1106,'1=1','N','Y','1c695639-d6f4-423a-8acc-6b03e8c1bd4b','Y','IsSOTrx','This is a Sales Transaction','The Sales Transaction checkbox indicates if this item is a Sales Transaction.','Sales Transaction','Y',TO_DATE('2013-04-10 15:45:36','YYYY-MM-DD HH24:MI:SS'),100,0,'Y',TO_DATE('2013-04-10 15:45:36','YYYY-MM-DD HH24:MI:SS'),100,0,'N','N','N','N')
;
...
--  
ALTER TABLE Z_TaxInvoice ADD C_Currency_ID NUMBER(10) DEFAULT NULL 
;

-- Apr 10, 2013 3:51:27 PM WIT
--  
INSERT INTO AD_Column (SeqNoSelection,Version,AD_Table_ID,AD_Column_ID,EntityType,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,ReadOnlyLogic,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Description,Help,Name,IsAllowCopy,Updated,CreatedBy,AD_Org_ID,IsActive,Created,UpdatedBy,AD_Client_ID,IsToolbarButton,IsEncrypted,IsSyncDatabase,IsAlwaysUpdateable) VALUES (0,0,550001,550039,'U','N','N','N',0,'N',20,'N',10,'N',590,'1=1','N','Y','ba97878c-991f-4683-af62-c4c05758da87','Y','TaxID','Tax Identification','The Tax ID field identifies the legal Identification number of this Entity.','Tax ID','Y',TO_DATE('2013-04-10 15:51:27','YYYY-MM-DD HH24:MI:SS'),100,0,'Y',TO_DATE('2013-04-10 15:51:27','YYYY-MM-DD HH24:MI:SS'),100,0,'N','N','N','N')
;
...
--  
ALTER TABLE Z_TaxInvoice ADD TaxID NVARCHAR2(20) DEFAULT NULL 
;

-- Apr 10, 2013 3:53:04 PM WIT
--  
INSERT INTO AD_Column (SeqNoSelection,Version,AD_Table_ID,AD_Column_ID,EntityType,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,ReadOnlyLogic,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Description,Help,Name,IsAllowCopy,Updated,CreatedBy,AD_Org_ID,IsActive,Created,UpdatedBy,AD_Client_ID,IsToolbarButton,IsEncrypted,IsSyncDatabase,IsAlwaysUpdateable) VALUES (0,0,550001,550040,'U','N','N','N',0,'N',14,'N',12,'N',1133,'1=1','N','Y','ca4cf1d8-0128-494c-899e-257f4fb983d6','Y','TaxAmt','Tax Amount for a document','The Tax Amount displays the total tax amount for a document.','Tax Amount','Y',TO_DATE('2013-04-10 15:53:04','YYYY-MM-DD HH24:MI:SS'),100,0,'Y',TO_DATE('2013-04-10 15:53:04','YYYY-MM-DD HH24:MI:SS'),100,0,'N','N','N','N')
;
...
--  
INSERT INTO AD_Field (ColumnSpan,NumLines,SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,IsDisplayed,IsFieldOnly,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry) VALUES (2,1,0,'N',550000,0,'Y','N',550038,110,'Y',550086,'N','Indicates the Currency to be used when processing or reporting on this record','U','The Currency for this record','Currency','Y','N','6b8f2e66-4715-46c1-8fe4-ec37e0e27ac2',100,0,TO_DATE('2013-04-10 15:59:28','YYYY-MM-DD HH24:MI:SS'),0,100,TO_DATE('2013-04-10 15:59:28','YYYY-MM-DD HH24:MI:SS'),'Y','Y',110,4,'N')
;
...
--  
INSERT INTO AD_Field (ColumnSpan,NumLines,SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,IsDisplayed,IsFieldOnly,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry) VALUES (2,1,0,'N',550000,0,'Y','N',550039,130,'Y',550088,'N','The Tax ID field identifies the legal Identification number of this Entity.','U','Tax Identification','Tax ID','Y','N','261af6ab-fd07-4c27-9f47-08628068a400',100,0,TO_DATE('2013-04-10 16:00:42','YYYY-MM-DD HH24:MI:SS'),0,100,TO_DATE('2013-04-10 16:00:42','YYYY-MM-DD HH24:MI:SS'),'Y','Y',130,4,'N')
;
...
--  
INSERT INTO AD_Field (ColumnSpan,NumLines,SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,IsDisplayed,IsFieldOnly,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry) VALUES (2,1,0,'N',550000,0,'N','N',550040,140,'Y',550089,'N','The Tax Amount displays the total tax amount for a document.','U','Tax Amount for a document','Tax Amount','Y','N','d8682487-b9f3-445e-9a1f-695e87bc2db9',100,0,TO_DATE('2013-04-10 16:00:58','YYYY-MM-DD HH24:MI:SS'),0,100,TO_DATE('2013-04-10 16:00:58','YYYY-MM-DD HH24:MI:SS'),'Y','Y',140,1,'N')
;
...
--  
INSERT INTO AD_Field (ColumnSpan,NumLines,SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,IsDisplayed,IsFieldOnly,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry) VALUES (2,1,0,'N',550000,0,'Y','N',550041,150,'Y',550090,'N','The Tax Base Amount indicates the base amount used for calculating the tax amount.','U','Base for calculating the tax amount','Tax base Amount','Y','N','a94d93b3-a522-49ab-af4e-de306a0a57eb',100,0,TO_DATE('2013-04-10 16:01:13','YYYY-MM-DD HH24:MI:SS'),0,100,TO_DATE('2013-04-10 16:01:13','YYYY-MM-DD HH24:MI:SS'),'Y','Y',150,4,'N')
;
