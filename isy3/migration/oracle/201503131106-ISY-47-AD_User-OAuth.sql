...
--  
ALTER TABLE AD_User ADD OAuth VARCHAR2(100) DEFAULT NULL 
;

-- Mar 13, 2015 11:03:28 AM WIT
--  
INSERT INTO AD_Field (SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,UpdatedBy,AD_Org_ID,CreatedBy,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry,AD_Client_ID,ColumnSpan,NumLines,IsAdvancedField,IsDefaultFocus,AD_Column_ID,EntityType,Created) VALUES (0,'N',118,0,'Y','N',260,'Y',552088,'N','OAuth','e1cef134-41ae-45e5-871f-b34c1401fbd5','Y','N',100,0,100,TO_DATE('2015-03-13 11:03:28','YYYY-MM-DD HH24:MI:SS'),'Y','Y',260,4,'N',0,2,1,'N','N',551125,'U',TO_DATE('2015-03-13 11:03:28','YYYY-MM-DD HH24:MI:SS'))
;
