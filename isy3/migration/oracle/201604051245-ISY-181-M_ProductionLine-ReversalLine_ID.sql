...
--  
UPDATE AD_Column SET FKConstraintType='N', FKConstraintName='ReversalLine_MProductionLine',Updated=TO_DATE('2016-04-05 11:10:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=551943
;

-- Apr 5, 2016 11:10:01 AM WIT
--  
ALTER TABLE M_ProductionLine ADD ReversalLine_ID NUMBER(10) DEFAULT NULL 
;
