...
--  
INSERT INTO AD_Ref_Table (IsValueDisplayed,AD_Ref_Table_UU,CreatedBy,Updated,Created,UpdatedBy,AD_Org_ID,IsActive,AD_Client_ID,EntityType,AD_Display,AD_Key,AD_Reference_ID,AD_Table_ID) VALUES ('N','aefc67f2-6730-46f5-bb0c-516697e42898',100,TO_DATE('2014-11-20 13:07:10','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2014-11-20 13:07:10','YYYY-MM-DD HH24:MI:SS'),100,0,'Y',0,'U',522,528,550034,155)
;

-- Nov 20, 2014 1:08:06 PM WIT
--  
UPDATE AD_Ref_Table SET IsValueDisplayed='Y', WhereClause='AD_Org.AD_Org_ID<>0 AND AD_Org.IsOrgTrxDim <>''Y''',Updated=TO_DATE('2014-11-20 13:08:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Reference_ID=550034
;
