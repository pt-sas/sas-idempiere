...
-- Dec 14, 2015 9:27:16 AM WIT
--  
INSERT INTO AD_Process_Access (AD_Process_ID,AD_Process_Access_UU,UpdatedBy,CreatedBy,Updated,Created,IsActive,AD_Client_ID,AD_Org_ID,AD_Role_ID) VALUES (550219,'72c1691e-80f1-40fb-8fcd-9005ff7abd87',100,100,TO_DATE('2015-12-14 09:27:16','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2015-12-14 09:27:16','YYYY-MM-DD HH24:MI:SS'),'Y',11,0,103)
;

-- Dec 14, 2015 9:27:16 AM WIT
--  
INSERT INTO AD_Process_Access (AD_Process_ID,AD_Process_Access_UU,UpdatedBy,CreatedBy,Updated,Created,IsActive,AD_Client_ID,AD_Org_ID,AD_Role_ID) VALUES (550219,'3727c48a-c809-4fcc-88f5-9ea185edd0f6',100,100,TO_DATE('2015-12-14 09:27:16','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2015-12-14 09:27:16','YYYY-MM-DD HH24:MI:SS'),'Y',0,0,0)
;

-- Dec 14, 2015 9:27:16 AM WIT
--  
INSERT INTO AD_Process_Access (AD_Process_ID,AD_Process_Access_UU,UpdatedBy,CreatedBy,Updated,Created,IsActive,AD_Client_ID,AD_Org_ID,AD_Role_ID) VALUES (550219,'a71601e1-d6f7-4a3a-b2ae-7b920ab6035b',100,100,TO_DATE('2015-12-14 09:27:16','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2015-12-14 09:27:16','YYYY-MM-DD HH24:MI:SS'),'Y',11,0,102)
;

-- Dec 14, 2015 9:27:16 AM WIT
--  
INSERT INTO AD_Process_Access (AD_Process_ID,AD_Process_Access_UU,UpdatedBy,CreatedBy,Updated,Created,IsActive,AD_Client_ID,AD_Org_ID,AD_Role_ID) VALUES (550219,'efc1ada8-448f-4c53-a27a-1af5239cecc1',100,100,TO_DATE('2015-12-14 09:27:16','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2015-12-14 09:27:16','YYYY-MM-DD HH24:MI:SS'),'Y',1000001,0,1000003)
;

-- Dec 14, 2015 9:27:16 AM WIT
--  
INSERT INTO AD_Process_Access (AD_Process_ID,AD_Process_Access_UU,UpdatedBy,CreatedBy,Updated,Created,IsActive,AD_Client_ID,AD_Org_ID,AD_Role_ID) VALUES (550219,'86c0d15b-90a6-4b31-930b-b13b047025ea',100,100,TO_DATE('2015-12-14 09:27:16','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2015-12-14 09:27:16','YYYY-MM-DD HH24:MI:SS'),'Y',1000001,0,1000002)
;

-- Dec 14, 2015 9:28:05 AM WIT
--  
INSERT INTO AD_Process_Para (IsRange,AD_Element_ID,AD_Process_Para_ID,AD_Process_Para_UU,Help,AD_Reference_ID,IsMandatory,EntityType,Name,ColumnName,Description,FieldLength,IsCentrallyMaintained,SeqNo,IsActive,UpdatedBy,Updated,CreatedBy,AD_Org_ID,IsEncrypted,AD_Client_ID,AD_Process_ID,AD_Reference_Value_ID,Created) VALUES ('N',454,550522,'3c1cc5bf-be14-4c4a-8a96-d15fc7d608c0','Identifies an item which is either purchased or sold in this organization.',30,'N','U','Product','M_Product_ID','Product, Service, Item',0,'Y',10,'Y',100,TO_DATE('2015-12-14 09:28:05','YYYY-MM-DD HH24:MI:SS'),100,0,'N',0,550219,162,TO_DATE('2015-12-14 09:28:05','YYYY-MM-DD HH24:MI:SS'))
;
...
--  
INSERT INTO AD_Process_Para (IsRange,AD_Element_ID,AD_Process_Para_ID,AD_Process_Para_UU,Help,AD_Reference_ID,IsMandatory,EntityType,Name,ColumnName,Description,FieldLength,IsCentrallyMaintained,SeqNo,IsActive,UpdatedBy,Updated,CreatedBy,AD_Org_ID,IsEncrypted,AD_Client_ID,AD_Process_ID,Created) VALUES ('N',852,550523,'037b20d2-4f27-46a7-9014-13882f6c56ac','The Classification can be used to optionally group products.',10,'N','U','Classification','Classification','Classification for grouping',20,'Y',20,'Y',100,TO_DATE('2015-12-14 09:28:55','YYYY-MM-DD HH24:MI:SS'),100,0,'N',0,550219,TO_DATE('2015-12-14 09:28:55','YYYY-MM-DD HH24:MI:SS'))
;
...
-- Dec 14, 2015 9:36:10 AM WIT
--  
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', SysDate, 100, SysDate, 100,t.AD_Tree_ID, 550107, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=550107)
;
