-- Dec 17, 2014 1:31:32 PM WIT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET SeqNo=420,IsDisplayed='Y' WHERE AD_Field_ID=550248
;

-- Dec 17, 2014 1:31:33 PM WIT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
...
-- Dec 17, 2014 1:31:34 PM WIT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET SeqNo=750,IsDisplayed='Y' WHERE AD_Field_ID=4128
;

-- Dec 17, 2014 1:35:12 PM WIT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Column SET AD_Val_Rule_ID=269,Updated=TO_DATE('2014-12-17 13:35:12','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=5298
;

-- Dec 17, 2014 1:35:19 PM WIT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET SeqNo=115,Updated=TO_DATE('2014-12-17 13:35:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=4128
;

SELECT register_migration_script('201412171339-ISY-62-PaymentDisplayBPBankAccount.sql') FROM dual
;
