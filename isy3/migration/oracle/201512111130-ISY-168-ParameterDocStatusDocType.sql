...
--  
UPDATE AD_Process_Para SET DefaultValue='-1',Updated=TO_DATE('2015-12-11 11:06:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=550518
;

-- Dec 11, 2015 11:08:53 AM WIT
--  
UPDATE AD_Process_Para SET AD_Reference_Value_ID=200068,Updated=TO_DATE('2015-12-11 11:08:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=550518
;

-- Dec 11, 2015 11:18:34 AM WIT
--  
UPDATE AD_Process_Para SET AD_Element_ID=196, Help='The Document Type determines document sequence and processing rules', AD_Reference_ID=19, Name='Document Type', ColumnName='C_DocType_ID', Description='Document type or rules', AD_Reference_Value_ID=NULL,Updated=TO_DATE('2015-12-11 11:18:34','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=550518
;

-- Dec 11, 2015 11:19:14 AM WIT
--  
UPDATE AD_Process_Para SET AD_Val_Rule_ID=NULL,Updated=TO_DATE('2015-12-11 11:19:14','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=550518
;

-- Dec 11, 2015 11:21:36 AM WIT
--  
UPDATE AD_Process_Para SET AD_Reference_ID=17, AD_Val_Rule_ID=124, AD_Reference_Value_ID=200068,Updated=TO_DATE('2015-12-11 11:21:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=550518
;

-- Dec 11, 2015 11:22:47 AM WIT
--  
UPDATE AD_Process_Para SET AD_Reference_ID=18, AD_Reference_Value_ID=NULL,Updated=TO_DATE('2015-12-11 11:22:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=550518
;

-- Dec 11, 2015 11:24:09 AM WIT
--  
UPDATE AD_Process_Para SET SeqNo=80,Updated=TO_DATE('2015-12-11 11:24:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=550517
;

-- Dec 11, 2015 11:24:13 AM WIT
--  
UPDATE AD_Process_Para SET SeqNo=90,Updated=TO_DATE('2015-12-11 11:24:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=550518
;

-- Dec 11, 2015 11:25:59 AM WIT
--  
INSERT INTO AD_Process_Para (IsRange,AD_Element_ID,AD_Process_Para_ID,AD_Process_Para_UU,Help,AD_Reference_ID,IsMandatory,EntityType,Name,ColumnName,Description,FieldLength,IsCentrallyMaintained,SeqNo,IsActive,UpdatedBy,Updated,CreatedBy,AD_Org_ID,IsEncrypted,AD_Client_ID,AD_Process_ID,AD_Reference_Value_ID,Created) VALUES ('N',289,550519,'12569916-2c18-4296-a39a-498072420c2b','The Document Status indicates the status of a document at this time.  If you want to change the document status, use the Document Action field',17,'N','U','Document Status','DocStatus','The current status of the document',0,'Y',70,'Y',100,TO_DATE('2015-12-11 11:25:59','YYYY-MM-DD HH24:MI:SS'),100,0,'N',0,151,131,TO_DATE('2015-12-11 11:25:59','YYYY-MM-DD HH24:MI:SS'))
;
