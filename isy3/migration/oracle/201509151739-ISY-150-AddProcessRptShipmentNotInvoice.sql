...
--  
UPDATE AD_Process_Para SET AD_Val_Rule_ID=52053,Updated=TO_DATE('2015-09-15 15:48:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=550430
;

-- Sep 15, 2015 5:35:45 PM WIT
--  
INSERT INTO AD_Menu (AD_Menu_ID,IsSummary,IsSOTrx,IsReadOnly,AD_Process_ID,EntityType,IsCentrallyMaintained,Name,AD_Menu_UU,Action,IsActive,CreatedBy,UpdatedBy,AD_Client_ID,AD_Org_ID,Created,Updated) VALUES (550086,'N','N','N',550175,'U','Y','Rpt_ShipmentNotInvoice','45778da6-788a-4087-8df0-305dca823f81','R','Y',100,100,0,0,TO_DATE('2015-09-15 17:35:44','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2015-09-15 17:35:44','YYYY-MM-DD HH24:MI:SS'))
;
...
-- Sep 15, 2015 5:35:45 PM WIT
--  
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', SysDate, 100, SysDate, 100,t.AD_Tree_ID, 550086, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=550086)
;
