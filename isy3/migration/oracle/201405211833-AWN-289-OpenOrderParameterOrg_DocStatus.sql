...
--  
UPDATE AD_Process_Para SET AD_Element_ID=113, Help='An organization is a unit of your client or legal entity - examples are store, department. You can share data between organizations.', AD_Reference_ID=17, AD_Reference_Value_ID=NULL, Name='Organization', ColumnName='AD_Org_ID', Description='Organizational entity within client',Updated=TO_DATE('2014-05-21 18:23:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=550063
;

-- May 21, 2014 6:24:30 PM WIT
--  
UPDATE AD_Process_Para SET AD_Reference_ID=18, AD_Reference_Value_ID=276,Updated=TO_DATE('2014-05-21 18:24:30','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=550063
;

-- May 21, 2014 6:26:01 PM WIT
--  
UPDATE AD_Process_Para SET DefaultValue='@#AD_Org_ID@',Updated=TO_DATE('2014-05-21 18:26:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=550063
;
