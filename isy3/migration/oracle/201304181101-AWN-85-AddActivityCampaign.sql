...
--  
UPDATE AD_Field SET SeqNo=132, SeqNoGrid=132,Updated=TO_DATE('2013-04-18 10:58:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=550079
;

-- Apr 18, 2013 10:58:51 AM WIT
--  
UPDATE AD_Field SET SeqNo=134, SeqNoGrid=134,Updated=TO_DATE('2013-04-18 10:58:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=550080
;

-- Apr 18, 2013 10:59:29 AM WIT
--  
INSERT INTO AD_Field (NumLines,SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,IsDisplayed,IsFieldOnly,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,CreatedBy,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry,AD_Client_ID,ColumnSpan) VALUES (1,0,'N',641,0,'N','N',550089,136,'Y',550117,'N','Activities indicate tasks that are performed and used to utilize Activity based Costing','U','Business Activity','Activity','Y','N','38d57569-a168-4472-9ce1-16e02dcca52c',100,0,TO_DATE('2013-04-18 10:59:29','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2013-04-18 10:59:29','YYYY-MM-DD HH24:MI:SS'),'Y','Y',136,1,'N',0,2)
;
...
--  
INSERT INTO AD_Field (NumLines,SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,IsDisplayed,IsFieldOnly,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,CreatedBy,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry,AD_Client_ID,ColumnSpan) VALUES (1,0,'N',641,0,'Y','N',550090,138,'Y',550118,'N','The Campaign defines a unique marketing program.  Projects can be associated with a pre defined Marketing Campaign.  You can then report based on a specific Campaign.','U','Marketing Campaign','Campaign','Y','N','0edf8c9b-6fbd-405c-8732-80ec2765f308',100,0,TO_DATE('2013-04-18 10:59:54','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2013-04-18 10:59:54','YYYY-MM-DD HH24:MI:SS'),'Y','Y',138,4,'N',0,2)
;
