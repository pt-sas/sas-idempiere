...
--  
UPDATE AD_Column SET FKConstraintType='N', FKConstraintName='RemoteOrg_MLocator',Updated=TO_DATE('2016-07-27 16:17:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552185
;

-- Jul 27, 2016 4:17:03 PM WIT
--  
ALTER TABLE M_Locator ADD Remote_Org_ID NUMBER(10) DEFAULT NULL 
;
