...
-- Jun 6, 2016 10:30:26 AM WIT
--  
INSERT INTO AD_Process_Access (AD_Process_ID,AD_Process_Access_UU,UpdatedBy,CreatedBy,Updated,Created,IsActive,AD_Client_ID,AD_Org_ID,AD_Role_ID) VALUES (550249,'56f7ca62-bda5-4b08-aa24-b13bba9798b3',100,100,TO_DATE('2016-06-06 10:30:26','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2016-06-06 10:30:26','YYYY-MM-DD HH24:MI:SS'),'Y',11,0,103)
;

-- Jun 6, 2016 10:30:27 AM WIT
--  
INSERT INTO AD_Process_Access (AD_Process_ID,AD_Process_Access_UU,UpdatedBy,CreatedBy,Updated,Created,IsActive,AD_Client_ID,AD_Org_ID,AD_Role_ID) VALUES (550249,'3649e4bf-b573-47ff-bdf8-98f609f6b37e',100,100,TO_DATE('2016-06-06 10:30:26','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2016-06-06 10:30:26','YYYY-MM-DD HH24:MI:SS'),'Y',0,0,0)
;

-- Jun 6, 2016 10:30:27 AM WIT
--  
INSERT INTO AD_Process_Access (AD_Process_ID,AD_Process_Access_UU,UpdatedBy,CreatedBy,Updated,Created,IsActive,AD_Client_ID,AD_Org_ID,AD_Role_ID) VALUES (550249,'b65ffebc-8083-43c3-bb79-52143db01d76',100,100,TO_DATE('2016-06-06 10:30:27','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2016-06-06 10:30:27','YYYY-MM-DD HH24:MI:SS'),'Y',11,0,102)
;

-- Jun 6, 2016 10:30:27 AM WIT
--  
INSERT INTO AD_Process_Access (AD_Process_ID,AD_Process_Access_UU,UpdatedBy,CreatedBy,Updated,Created,IsActive,AD_Client_ID,AD_Org_ID,AD_Role_ID) VALUES (550249,'b5ba46ee-e181-4bf0-9f03-6d51e7dc0a9d',100,100,TO_DATE('2016-06-06 10:30:27','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2016-06-06 10:30:27','YYYY-MM-DD HH24:MI:SS'),'Y',1000001,0,1000003)
;

-- Jun 6, 2016 10:30:27 AM WIT
--  
INSERT INTO AD_Process_Access (AD_Process_ID,AD_Process_Access_UU,UpdatedBy,CreatedBy,Updated,Created,IsActive,AD_Client_ID,AD_Org_ID,AD_Role_ID) VALUES (550249,'2eee2749-a39f-46fd-91b4-bc2b8e57111a',100,100,TO_DATE('2016-06-06 10:30:27','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2016-06-06 10:30:27','YYYY-MM-DD HH24:MI:SS'),'Y',1000001,0,1000002)
;

-- Jun 6, 2016 10:30:28 AM WIT
--  
UPDATE AD_Process SET JasperReport='http://erp:8090/jasper/InvoiceNoShipment.jasper',Updated=TO_DATE('2016-06-06 10:30:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=550249
;

-- Jun 6, 2016 10:31:27 AM WIT
--  
INSERT INTO AD_Process_Para (IsRange,AD_Element_ID,AD_Process_Para_ID,AD_Process_Para_UU,Help,AD_Reference_ID,IsMandatory,EntityType,Name,ColumnName,Description,FieldLength,IsCentrallyMaintained,DefaultValue2,SeqNo,DefaultValue,IsActive,UpdatedBy,Updated,CreatedBy,AD_Org_ID,IsEncrypted,AD_Client_ID,AD_Process_ID,Created) VALUES ('Y',267,550655,'0c2d5772-68cb-4e50-8878-9ef2da22cde7','The Date Invoice indicates the date printed on the invoice.',15,'Y','U','Date Invoiced','DateInvoiced','Date printed on Invoice',0,'Y','@#Date@',10,'@#Date@','Y',100,TO_DATE('2016-06-06 10:31:26','YYYY-MM-DD HH24:MI:SS'),100,0,'N',0,550249,TO_DATE('2016-06-06 10:31:26','YYYY-MM-DD HH24:MI:SS'))
;
...
-- Jun 6, 2016 10:45:09 AM WIT
--  
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', SysDate, 100, SysDate, 100,t.AD_Tree_ID, 550127, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=550127)
;
