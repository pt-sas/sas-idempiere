...
--  
UPDATE AD_Field SET XPosition=4, ColumnSpan=2,Updated=TO_DATE('2017-11-15 15:22:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553745
;

-- Nov 15, 2017 3:22:51 PM WIT
--  
INSERT INTO AD_Field (SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,Description,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,UpdatedBy,AD_Org_ID,CreatedBy,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry,AD_Client_ID,ColumnSpan,NumLines,IsAdvancedField,IsDefaultFocus,AD_Column_ID,EntityType,Created) VALUES (0,'N',53239,0,'N','N',85,'Y',553746,'N','A Business Partner is anyone with whom you transact.  This can include Vendor, Customer, Employee or Salesperson','Identifies a Business Partner','Business Partner ','0a32e5d7-8704-44df-961a-e3c7bb6beb10','Y','N',100,0,100,TO_DATE('2017-11-15 15:22:51','YYYY-MM-DD HH24:MI:SS'),'Y','Y',85,4,'N',0,2,1,'N','N',552472,'U',TO_DATE('2017-11-15 15:22:51','YYYY-MM-DD HH24:MI:SS'))
;
