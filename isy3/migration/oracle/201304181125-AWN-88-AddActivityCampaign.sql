...
--  
ALTER TABLE S_TimeExpense ADD C_Campaign_ID NUMBER(10) DEFAULT NULL 
;

-- Apr 18, 2013 11:23:30 AM WIT
--  
INSERT INTO AD_Field (NumLines,SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,IsDisplayed,IsFieldOnly,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,CreatedBy,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry,AD_Client_ID,ColumnSpan) VALUES (1,0,'N',412,0,'N','N',550091,160,'Y',550119,'N','Activities indicate tasks that are performed and used to utilize Activity based Costing','U','Business Activity','Activity','Y','N','9108dfdc-6584-47b0-823e-2340aa5be1b8',100,0,TO_DATE('2013-04-18 11:23:30','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2013-04-18 11:23:30','YYYY-MM-DD HH24:MI:SS'),'Y','Y',150,1,'N',0,2)
;
...
--  
INSERT INTO AD_Field (NumLines,SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,IsDisplayed,IsFieldOnly,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,CreatedBy,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry,AD_Client_ID,ColumnSpan) VALUES (1,0,'N',412,0,'Y','N',550092,170,'Y',550120,'N','The Campaign defines a unique marketing program.  Projects can be associated with a pre defined Marketing Campaign.  You can then report based on a specific Campaign.','U','Marketing Campaign','Campaign','Y','N','3858347d-1271-49ce-9f15-7c0fea150da0',100,0,TO_DATE('2013-04-18 11:23:47','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2013-04-18 11:23:47','YYYY-MM-DD HH24:MI:SS'),'Y','Y',160,4,'N',0,2)
;
