...
--  
UPDATE AD_Column SET AD_Reference_ID=30,Updated=TO_DATE('2016-01-26 11:52:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=551898
;

-- Jan 26, 2016 11:52:39 AM WIT
--  
ALTER TABLE C_Payment MODIFY C_PaymentTransfer_ID NUMBER(10) DEFAULT NULL 
;
