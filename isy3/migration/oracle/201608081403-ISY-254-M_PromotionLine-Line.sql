...
--  
ALTER TABLE M_PromotionLine ADD Line NUMBER(10) DEFAULT NULL 
;

-- Aug 8, 2016 1:57:24 PM WIT
--  
UPDATE AD_Column SET SeqNo=2,Updated=TO_DATE('2016-08-08 13:57:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=57071
;

-- Aug 8, 2016 1:57:33 PM WIT
--  
UPDATE AD_Column SET SeqNo=3,Updated=TO_DATE('2016-08-08 13:57:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=57072
;

-- Aug 8, 2016 1:57:39 PM WIT
--  
UPDATE AD_Column SET IsIdentifier='Y', SeqNo=1,Updated=TO_DATE('2016-08-08 13:57:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552216
;

-- Aug 8, 2016 1:58:20 PM WIT
--  
INSERT INTO AD_Field (SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,Description,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,UpdatedBy,AD_Org_ID,CreatedBy,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry,AD_Client_ID,ColumnSpan,NumLines,IsAdvancedField,IsDefaultFocus,AD_Column_ID,EntityType,Created) VALUES (0,'N',53205,0,'Y','N',45,'Y',553367,'N','Indicates the unique line for a document.  It will also control the display order of the lines within a document.','Unique line for this document','Line No','e930bf65-9030-4886-9446-542f697e2278','Y','N',100,0,100,TO_DATE('2016-08-08 13:58:19','YYYY-MM-DD HH24:MI:SS'),'Y','Y',45,4,'N',0,2,1,'N','N',552216,'U',TO_DATE('2016-08-08 13:58:19','YYYY-MM-DD HH24:MI:SS'))
;
