...
--  
ALTER TABLE S_TimeExpense ADD C_DocTypeTarget_ID NUMBER(10) DEFAULT NULL 
;

-- Mar 23, 2013 4:35:16 PM WIT
--  
INSERT INTO AD_Column (SeqNoSelection,Version,AD_Table_ID,AD_Column_ID,EntityType,AD_Reference_Value_ID,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Description,Help,Name,IsAllowCopy,Updated,CreatedBy,AD_Org_ID,IsActive,Created,UpdatedBy,AD_Client_ID,IsToolbarButton,IsEncrypted,IsSyncDatabase,IsAlwaysUpdateable) VALUES (0,0,486,550027,'U',134,'N','N','N',0,'N',10,'N',18,'N',613,'N','Y','a98ec103-a0ca-409c-b8e2-18c1c31a8cbc','Y','User1_ID','User defined list element #1','The user defined element displays the optional elements that have been defined for this account combination.','User List 1','Y',TO_DATE('2013-03-23 16:35:16','YYYY-MM-DD HH24:MI:SS'),100,0,'Y',TO_DATE('2013-03-23 16:35:16','YYYY-MM-DD HH24:MI:SS'),100,0,'N','N','N','N')
;
...
--  
UPDATE AD_Field SET Name='Cost Center',Updated=TO_DATE('2013-03-23 16:36:41','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=550075
;
