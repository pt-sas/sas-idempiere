...
--  
INSERT INTO AD_Column (SeqNoSelection,IsSyncDatabase,Version,AD_Column_ID,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,IsKey,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Description,Help,Name,IsAllowCopy,Updated,CreatedBy,AD_Org_ID,IsActive,Created,UpdatedBy,IsToolbarButton,IsAlwaysUpdateable,AD_Client_ID,EntityType,IsEncrypted,IsSecure,AD_Element_ID,AD_Reference_ID,AD_Reference_Value_ID,AD_Table_ID) VALUES (0,'N',0,552070,'N','N','N',0,'N',22,'N','N','N','Y','ca751ed5-b097-45e2-bbcd-20b3725f2076','N','C_Invoice_ID','Invoice Identifier','The Invoice Document.','Invoice','Y',TO_DATE('2016-07-13 10:45:01','YYYY-MM-DD HH24:MI:SS'),100,0,'Y',TO_DATE('2016-07-13 10:45:01','YYYY-MM-DD HH24:MI:SS'),100,'N','N',0,'U','N','N',1008,30,336,486)
;
...
--  
UPDATE AD_Column SET FKConstraintType='N', FKConstraintName='CInvoice_STimeExpense',Updated=TO_DATE('2016-07-13 10:45:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552070
;

-- Jul 13, 2016 10:45:05 AM WIT
--  
ALTER TABLE S_TimeExpense ADD C_Invoice_ID NUMBER(10) DEFAULT NULL 
;
