...
--  
UPDATE AD_InfoWindow SET WhereClause='p.IsReceipt = ''Y'' AND p.CheckNo IS NOT NULL AND LENGTH(p.CheckNo) > 0 AND p.IsInTransit=''N'' AND p.IsCashed = ''N'' AND p.DocStatus = ''CO''',Updated=TO_TIMESTAMP('2016-07-26 13:18:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoWindow_ID=550005
;

-- Jul 26, 2016 1:21:18 PM WIT
--  
UPDATE AD_InfoColumn SET IsActive='N',Updated=TO_TIMESTAMP('2016-07-26 13:21:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoColumn_ID=550061
;
