...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
ALTER TABLE C_PaymentAllocate ADD COLUMN Description VARCHAR(2000) DEFAULT NULL 
;

-- Dec 11, 2014 4:32:28 PM WIT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Column SET IsAlwaysUpdateable='Y',Updated=TO_TIMESTAMP('2014-12-11 16:32:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=550677
;

-- Dec 11, 2014 4:33:43 PM WIT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Field_UU,AD_Org_ID,AD_Tab_ID,ColumnSpan,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsAdvancedField,IsCentrallyMaintained,IsDefaultFocus,IsDisplayed,IsDisplayedGrid,IsEncrypted,IsFieldOnly,IsHeading,IsQuickEntry,IsReadOnly,IsSameLine,Name,NumLines,SeqNo,SeqNoGrid,SortNo,Updated,UpdatedBy,XPosition) VALUES (0,550677,551687,'8fbf3060-1dc5-45d2-a4a0-495396e9d07a',0,755,5,TO_TIMESTAMP('2014-12-11 16:33:43','YYYY-MM-DD HH24:MI:SS'),100,'Optional short description of the record',0,'U','A description is limited to 255 characters.','Y','N','Y','N','Y','Y','N','N','N','N','N','N','Description',3,43,130,0,TO_TIMESTAMP('2014-12-11 16:33:43','YYYY-MM-DD HH24:MI:SS'),100,1)
;
