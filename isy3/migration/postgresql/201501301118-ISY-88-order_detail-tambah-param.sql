...
--  
UPDATE AD_Process_Para SET SeqNo=5,Updated=TO_TIMESTAMP('2015-01-30 11:06:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=550288
;

-- Jan 30, 2015 11:14:00 AM WIT
--  
UPDATE AD_Process_Para SET DefaultValue='-1',Updated=TO_TIMESTAMP('2015-01-30 11:14:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=550288
;

-- Jan 30, 2015 11:14:21 AM WIT
--  
UPDATE AD_Process_Para SET DefaultValue='-1',Updated=TO_TIMESTAMP('2015-01-30 11:14:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=550289
;
