...
--  
INSERT INTO AD_Menu (AD_Menu_ID,IsSummary,IsSOTrx,IsReadOnly,AD_Process_ID,EntityType,IsCentrallyMaintained,Name,"action",AD_Menu_UU,IsActive,CreatedBy,Updated,AD_Org_ID,Created,UpdatedBy,AD_Client_ID) VALUES (550010,'N','Y','N',200006,'U','Y','Create Production','P','d9f35a7c-8fcc-471b-a864-940c9496111d','Y',100,TO_TIMESTAMP('2013-12-16 16:46:27','YYYY-MM-DD HH24:MI:SS'),0,TO_TIMESTAMP('2013-12-16 16:46:27','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- Dec 16, 2013 4:46:28 PM WIT
--  
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', statement_timestamp(), 100, statement_timestamp(), 100,t.AD_Tree_ID, 550010, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=550010)
;
...
--  
INSERT INTO AD_Element (ColumnName,AD_Element_ID,Name,PrintName,AD_Element_UU,Created,Updated,AD_Org_ID,CreatedBy,UpdatedBy,IsActive,EntityType,AD_Client_ID) VALUES ('IgnorePrevProduction',550023,'Ignore Previous Production','Ignore Previous Production','de56d241-3487-4751-82bc-ce15be02a50b',TO_TIMESTAMP('2013-12-16 17:05:09','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2013-12-16 17:05:09','YYYY-MM-DD HH24:MI:SS'),0,100,100,'Y','U',0)
;
