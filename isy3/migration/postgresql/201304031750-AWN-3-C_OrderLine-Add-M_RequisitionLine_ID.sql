...
--  
INSERT INTO AD_Column (SeqNoSelection,Version,AD_Table_ID,AD_Column_ID,EntityType,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Description,Name,IsAllowCopy,Updated,CreatedBy,AD_Org_ID,IsActive,Created,UpdatedBy,AD_Client_ID,IsToolbarButton,IsEncrypted,IsSyncDatabase,IsAlwaysUpdateable) VALUES (0,0,260,550033,'U','N','N','N',0,'N',10,'N',19,'N',2453,'N','Y','11e7e85e-43f0-436b-b1c3-2b945596fe88','Y','M_RequisitionLine_ID','Material Requisition Line','Requisition Line','Y',TO_TIMESTAMP('2013-04-03 17:49:03','YYYY-MM-DD HH24:MI:SS'),100,0,'Y',TO_TIMESTAMP('2013-04-03 17:49:03','YYYY-MM-DD HH24:MI:SS'),100,0,'N','N','N','N')
;
...
--  
ALTER TABLE C_OrderLine ADD COLUMN M_RequisitionLine_ID NUMERIC(10) DEFAULT NULL 
;
