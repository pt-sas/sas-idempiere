...
--  
INSERT INTO AD_Field (SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,IsDisplayed,IsFieldOnly,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,CreatedBy,Updated,NumLines,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry,AD_Client_ID,ColumnSpan) VALUES (0,'N',550000,0,'N','N',550094,160,'Y',550213,'N','The Period indicates an exclusive range of dates for a calendar.','U','Period of the Calendar','Period','Y','N','e96657df-339f-4337-8b9f-998a5ac8a9c1',100,0,TO_TIMESTAMP('2013-05-06 17:04:36','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2013-05-06 17:04:36','YYYY-MM-DD HH24:MI:SS'),1,'Y','Y',160,1,'N',0,2)
;
...
--  
ALTER TABLE Z_TaxInvoice ADD COLUMN C_Period_ID NUMERIC(10) DEFAULT NULL 
;
