...
--  
INSERT INTO AD_Menu (AD_Menu_ID,IsSummary,IsSOTrx,IsReadOnly,AD_Process_ID,EntityType,IsCentrallyMaintained,Name,AD_Menu_UU,"action",IsActive,CreatedBy,UpdatedBy,AD_Client_ID,AD_Org_ID,Created,Updated) VALUES (550084,'N','N','N',550174,'U','Y','Rpt_CashAndBankRevaluation','4e5b02e3-0edc-4f25-b46d-a23e25822541','R','Y',100,100,0,0,TO_TIMESTAMP('2015-08-28 15:21:26','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2015-08-28 15:21:26','YYYY-MM-DD HH24:MI:SS'))
;
...
-- Aug 28, 2015 3:21:26 PM WIT
--  
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', statement_timestamp(), 100, statement_timestamp(), 100,t.AD_Tree_ID, 550084, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=550084)
;
...
-- Aug 28, 2015 3:21:40 PM WIT
--  
UPDATE AD_TreeNodeMM SET Parent_ID=236, SeqNo=37, Updated=statement_timestamp() WHERE AD_Tree_ID=10 AND Node_ID=550084
;

-- Aug 28, 2015 3:21:40 PM WIT
--  
UPDATE AD_TreeNodeMM SET Parent_ID=236, SeqNo=38, Updated=statement_timestamp() WHERE AD_Tree_ID=10 AND Node_ID=200024
;
