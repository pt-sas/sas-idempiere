...
--  
UPDATE AD_Column SET FKConstraintType='N', FKConstraintName='CBPartnerLocation_TAging',Updated=TO_TIMESTAMP('2016-09-13 11:25:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552285
;

-- Sep 13, 2016 11:25:08 AM WIT
--  
ALTER TABLE T_Aging ADD COLUMN C_BPartner_Location_ID NUMERIC(10) DEFAULT NULL 
;
