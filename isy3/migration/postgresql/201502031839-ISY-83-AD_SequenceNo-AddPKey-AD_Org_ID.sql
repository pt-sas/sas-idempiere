...
--  
UPDATE AD_Column SET IsParent='Y', IsUpdateable='N',Updated=TO_TIMESTAMP('2015-02-03 18:37:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=749
;

-- Feb 3, 2015 6:37:58 PM WIT
--  
INSERT INTO t_alter_column values('ad_sequence_no','AD_Org_ID','NUMERIC(10)',null,null)
;
