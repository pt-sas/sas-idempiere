...
--  
UPDATE AD_Column SET FKConstraintType='N', FKConstraintName='CPaymentGiro_CPaymentAllocate',Updated=TO_TIMESTAMP('2016-07-27 13:14:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552183
;

-- Jul 27, 2016 1:14:00 PM WIT
--  
ALTER TABLE C_PaymentAllocate ADD COLUMN C_PaymentGiro_ID NUMERIC(10) DEFAULT NULL 
;
...
--  
ALTER TABLE C_PaymentAllocate ADD COLUMN CheckNo VARCHAR(20) DEFAULT NULL 
;

-- Jul 27, 2016 1:15:17 PM WIT
--  
INSERT INTO AD_Field (SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,UpdatedBy,AD_Org_ID,CreatedBy,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry,AD_Client_ID,ColumnSpan,NumLines,IsAdvancedField,IsDefaultFocus,AD_Column_ID,EntityType,Created) VALUES (0,'N',755,0,'N','N',190,'Y',553334,'Y','Giro','f4df96f3-ccf6-437c-a2bd-7a3c7b7112c5','Y','N',100,0,100,TO_TIMESTAMP('2016-07-27 13:15:17','YYYY-MM-DD HH24:MI:SS'),'Y','Y',200,1,'N',0,2,1,'N','N',552183,'U',TO_TIMESTAMP('2016-07-27 13:15:17','YYYY-MM-DD HH24:MI:SS'))
;
...
--  
UPDATE AD_Field SET DisplayLogic='@C_PaymentGiro_ID@>0',Updated=TO_TIMESTAMP('2016-07-27 13:16:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553334
;
