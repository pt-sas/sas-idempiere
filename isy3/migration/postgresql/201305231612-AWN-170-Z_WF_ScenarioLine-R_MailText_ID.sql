...
For Multi-Lingual systems, the template is translated based on the Business Partner''s language selection.','Mail Template','Y',TO_TIMESTAMP('2013-05-23 16:07:37','YYYY-MM-DD HH24:MI:SS'),100,0,'Y',TO_TIMESTAMP('2013-05-23 16:07:37','YYYY-MM-DD HH24:MI:SS'),100,'N','N','N',0,'N')
;
...
--  
ALTER TABLE Z_WFScenarioLine ADD COLUMN R_MailText_ID NUMERIC(10) DEFAULT NULL 
;
...
So, @Name@ would resolve into the User name (if user is defined defined), then Business Partner name (if business partner is defined) and then the Name of the business object if it has a Name.<br>
For Multi-Lingual systems, the template is translated based on the Business Partner''s language selection.','U','Text templates for mailings','Mail Template','Y','N','a3985d65-b03f-48be-b8c2-4593b7ea75db',100,0,TO_TIMESTAMP('2013-05-23 16:08:43','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2013-05-23 16:08:43','YYYY-MM-DD HH24:MI:SS'),1,'Y','Y',90,1,'N',0,2)
;
