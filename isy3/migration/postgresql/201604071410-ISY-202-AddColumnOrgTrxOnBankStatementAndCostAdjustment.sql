...
--  
UPDATE AD_Column SET FKConstraintType='N', FKConstraintName='ADOrgTrx_CBankStatement',Updated=TO_TIMESTAMP('2016-03-31 14:07:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=551941
;

-- Mar 31, 2016 2:07:08 PM WIT
--  
ALTER TABLE C_BankStatement ADD COLUMN AD_OrgTrx_ID NUMERIC(10) DEFAULT NULL 
;
