...
--  
INSERT INTO AD_Element (ColumnName,AD_Element_ID,Name,Description,PrintName,AD_Element_UU,AD_Org_ID,CreatedBy,UpdatedBy,IsActive,AD_Client_ID,EntityType,Created,Updated) VALUES ('OpenAmtOri',550611,'Open Amount Original','Open item amount original','Open Original','535c8f05-c02f-4957-b15a-e7b0c052f423',0,100,100,'Y',0,'U',TO_TIMESTAMP('2017-01-27 13:41:43','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2017-01-27 13:41:43','YYYY-MM-DD HH24:MI:SS'))
;
...
--  
INSERT INTO AD_Column (SeqNoSelection,IsSyncDatabase,Version,AD_Column_ID,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,IsKey,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Description,Name,IsAllowCopy,Updated,CreatedBy,AD_Org_ID,IsActive,Created,UpdatedBy,IsToolbarButton,IsAlwaysUpdateable,AD_Client_ID,EntityType,IsEncrypted,IsSecure,AD_Element_ID,AD_Reference_ID,AD_Table_ID) VALUES (0,'N',0,552358,'N','N','N',0,'N',22,'N','N','N','Y','8013ea1b-40e8-41a9-9f89-e18d847bb553','N','OpenAmtOri','Open item amount original','Open Amount Original','Y',TO_TIMESTAMP('2017-01-27 13:42:05','YYYY-MM-DD HH24:MI:SS'),100,0,'Y',TO_TIMESTAMP('2017-01-27 13:42:05','YYYY-MM-DD HH24:MI:SS'),100,'N','N',0,'U','N','N',550611,12,631)
;
...
--  
ALTER TABLE T_Aging ADD COLUMN OpenAmtOri NUMERIC DEFAULT NULL 
;

-- Jan 27, 2017 1:42:48 PM WIT
--  
UPDATE AD_Element SET ColumnName='OpenAmtReval', Name='Open Amount Revaluated', Description='Open item amount revaluated', PrintName='Open Revaluated',Updated=TO_TIMESTAMP('2017-01-27 13:42:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=550611
;
...
--  
INSERT INTO AD_Column (SeqNoSelection,IsSyncDatabase,Version,AD_Column_ID,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,IsKey,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Description,Name,IsAllowCopy,Updated,CreatedBy,AD_Org_ID,IsActive,Created,UpdatedBy,IsToolbarButton,IsAlwaysUpdateable,AD_Client_ID,EntityType,IsEncrypted,IsSecure,FKConstraintType,AD_Element_ID,AD_Reference_ID,AD_Table_ID) VALUES (0,'N',0,552359,'N','N','N',0,'N',22,'N','N','N','Y','bd3da27e-583b-402a-b9dc-c14d1026d9ab','N','OpenAmtReval','Open item amount revaluated','Open Amount Revaluated','Y',TO_TIMESTAMP('2017-01-27 13:42:57','YYYY-MM-DD HH24:MI:SS'),100,0,'Y',TO_TIMESTAMP('2017-01-27 13:42:57','YYYY-MM-DD HH24:MI:SS'),100,'N','N',0,'U','N','N','N',550611,12,631)
;

-- Jan 27, 2017 1:44:24 PM WIT
--  
ALTER TABLE T_Aging ADD COLUMN OpenAmtReval NUMERIC DEFAULT NULL 
;

-- Jan 27, 2017 1:45:05 PM WIT
--  
INSERT INTO AD_Element (ColumnName,AD_Element_ID,Name,Description,PrintName,AD_Element_UU,AD_Org_ID,CreatedBy,UpdatedBy,IsActive,AD_Client_ID,EntityType,Created,Updated) VALUES ('OpenAmtOri',550612,'Open Amount Original','Open item amount','Open Original','65444472-6402-44d2-aa3a-de72742c9596',0,100,100,'Y',0,'U',TO_TIMESTAMP('2017-01-27 13:45:05','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2017-01-27 13:45:05','YYYY-MM-DD HH24:MI:SS'))
;
...
--  
UPDATE AD_Element SET Description='Open item amount original',Updated=TO_TIMESTAMP('2017-01-27 13:45:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=550612
;
...
--  
UPDATE AD_Column SET ColumnName='OpenAmtOri', Description='Open item amount original', Help=NULL, Name='Open Amount Original', FKConstraintType=NULL, AD_Element_ID=550612,Updated=TO_TIMESTAMP('2017-01-27 13:45:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552358
;

-- Jan 27, 2017 1:45:14 PM WIT
--  
INSERT INTO t_alter_column values('t_aging','OpenAmtOri','NUMERIC',null,'NULL')
;

-- Jan 27, 2017 1:46:02 PM WIT
--  
INSERT INTO AD_Column (SeqNoSelection,IsSyncDatabase,Version,AD_Column_ID,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,IsKey,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Description,Name,IsAllowCopy,Updated,CreatedBy,AD_Org_ID,IsActive,Created,UpdatedBy,IsToolbarButton,IsAlwaysUpdateable,AD_Client_ID,EntityType,IsEncrypted,IsSecure,FKConstraintType,AD_Element_ID,AD_Reference_ID,AD_Table_ID) VALUES (0,'N',0,552360,'N','N','N',0,'N',22,'N','N','N','Y','df5fdc2d-17cb-4fc0-9803-4d88f984fbf0','Y','OpenAmtReval','Open item amount revaluated','Open Amount Revaluated','Y',TO_TIMESTAMP('2017-01-27 13:46:01','YYYY-MM-DD HH24:MI:SS'),100,0,'Y',TO_TIMESTAMP('2017-01-27 13:46:01','YYYY-MM-DD HH24:MI:SS'),100,'N','N',0,'U','N','N','N',550611,12,631)
;
...
--  
INSERT INTO t_alter_column values('t_aging','OpenAmtReval','NUMERIC',null,'NULL')
;
