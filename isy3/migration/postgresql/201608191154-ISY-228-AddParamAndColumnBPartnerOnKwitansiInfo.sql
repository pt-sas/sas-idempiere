...
--  
UPDATE AD_InfoWindow SET IsValid='Y',Updated=TO_TIMESTAMP('2016-08-19 11:40:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoWindow_ID=550004
;

-- Aug 19, 2016 11:42:40 AM WIT
--  
UPDATE AD_InfoColumn SET SeqNoSelection=10,Updated=TO_TIMESTAMP('2016-08-19 11:42:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoColumn_ID=550047
;

-- Aug 19, 2016 11:42:47 AM WIT
--  
UPDATE AD_InfoColumn SET SeqNoSelection=20,Updated=TO_TIMESTAMP('2016-08-19 11:42:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoColumn_ID=550049
;

-- Aug 19, 2016 11:42:55 AM WIT
--  
UPDATE AD_InfoColumn SET SeqNoSelection=30,Updated=TO_TIMESTAMP('2016-08-19 11:42:55','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoColumn_ID=550050
;

-- Aug 19, 2016 11:43:00 AM WIT
--  
UPDATE AD_InfoColumn SET SeqNoSelection=40,Updated=TO_TIMESTAMP('2016-08-19 11:43:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoColumn_ID=550051
;

-- Aug 19, 2016 11:43:07 AM WIT
--  
UPDATE AD_InfoColumn SET SeqNoSelection=50,Updated=TO_TIMESTAMP('2016-08-19 11:43:07','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoColumn_ID=550116
;
