...
-- Dec 16, 2016 10:46:00 AM WIT
--  
INSERT INTO AD_Process_Access (AD_Process_ID,AD_Process_Access_UU,UpdatedBy,CreatedBy,Updated,Created,IsActive,AD_Client_ID,AD_Org_ID,AD_Role_ID) VALUES (550293,'d5ac0751-bdab-4e2c-aefc-4a45a4af50a0',100,100,TO_TIMESTAMP('2016-12-16 10:46:00','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2016-12-16 10:46:00','YYYY-MM-DD HH24:MI:SS'),'Y',11,0,103)
;

-- Dec 16, 2016 10:46:00 AM WIT
--  
INSERT INTO AD_Process_Access (AD_Process_ID,AD_Process_Access_UU,UpdatedBy,CreatedBy,Updated,Created,IsActive,AD_Client_ID,AD_Org_ID,AD_Role_ID) VALUES (550293,'8f2ad228-c4bf-4520-834f-3d7f837d827a',100,100,TO_TIMESTAMP('2016-12-16 10:46:00','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2016-12-16 10:46:00','YYYY-MM-DD HH24:MI:SS'),'Y',0,0,0)
;

-- Dec 16, 2016 10:46:00 AM WIT
--  
INSERT INTO AD_Process_Access (AD_Process_ID,AD_Process_Access_UU,UpdatedBy,CreatedBy,Updated,Created,IsActive,AD_Client_ID,AD_Org_ID,AD_Role_ID) VALUES (550293,'bafd7923-53e7-4139-aa86-93ac05c4443f',100,100,TO_TIMESTAMP('2016-12-16 10:46:00','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2016-12-16 10:46:00','YYYY-MM-DD HH24:MI:SS'),'Y',11,0,102)
;

-- Dec 16, 2016 10:46:00 AM WIT
--  
INSERT INTO AD_Process_Access (AD_Process_ID,AD_Process_Access_UU,UpdatedBy,CreatedBy,Updated,Created,IsActive,AD_Client_ID,AD_Org_ID,AD_Role_ID) VALUES (550293,'402d5a36-3303-4eb8-b109-5c34f10317b7',100,100,TO_TIMESTAMP('2016-12-16 10:46:00','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2016-12-16 10:46:00','YYYY-MM-DD HH24:MI:SS'),'Y',1000001,0,1000003)
;

-- Dec 16, 2016 10:46:00 AM WIT
--  
INSERT INTO AD_Process_Access (AD_Process_ID,AD_Process_Access_UU,UpdatedBy,CreatedBy,Updated,Created,IsActive,AD_Client_ID,AD_Org_ID,AD_Role_ID) VALUES (550293,'90d63718-d311-4fba-a5af-c7ffdfac61ad',100,100,TO_TIMESTAMP('2016-12-16 10:46:00','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2016-12-16 10:46:00','YYYY-MM-DD HH24:MI:SS'),'Y',1000001,0,1000002)
;

-- Dec 16, 2016 10:46:48 AM WIT
--  
INSERT INTO AD_Process_Para (IsRange,AD_Element_ID,AD_Process_Para_ID,AD_Process_Para_UU,Help,AD_Reference_ID,AD_Val_Rule_ID,IsMandatory,EntityType,Name,ColumnName,Description,FieldLength,IsCentrallyMaintained,SeqNo,IsActive,UpdatedBy,Updated,CreatedBy,AD_Org_ID,IsEncrypted,AD_Client_ID,AD_Process_ID,AD_Reference_Value_ID,Created) VALUES ('N',113,550799,'dca10e8a-fc0d-4355-a0ae-4eae0d533478','An organization is a unit of your client or legal entity - examples are store, department. You can share data between organizations.',30,550111,'N','U','Organization','AD_Org_ID','Organizational entity within client',0,'Y',10,'Y',100,TO_TIMESTAMP('2016-12-16 10:46:48','YYYY-MM-DD HH24:MI:SS'),100,0,'N',0,550293,322,TO_TIMESTAMP('2016-12-16 10:46:48','YYYY-MM-DD HH24:MI:SS'))
;
...
--  
UPDATE AD_Process_Para SET Name='Periode',Updated=TO_TIMESTAMP('2016-12-16 10:47:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=550800
;

-- Dec 16, 2016 10:48:36 AM WIT
--  
INSERT INTO AD_Menu (AD_Menu_ID,IsSummary,IsSOTrx,IsReadOnly,AD_Process_ID,EntityType,IsCentrallyMaintained,Name,AD_Menu_UU,"action",IsActive,CreatedBy,UpdatedBy,AD_Client_ID,AD_Org_ID,Created,Updated) VALUES (550152,'N','N','N',550293,'U','Y','e-Faktur','3a133348-9cf2-4c39-ab10-12526caa1629','R','Y',100,100,0,0,TO_TIMESTAMP('2016-12-16 10:48:35','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2016-12-16 10:48:35','YYYY-MM-DD HH24:MI:SS'))
;
...
-- Dec 16, 2016 10:48:36 AM WIT
--  
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', statement_timestamp(), 100, statement_timestamp(), 100,t.AD_Tree_ID, 550152, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=550152)
;

-- Dec 16, 2016 10:50:13 AM WIT
--  
UPDATE AD_Process_Para SET AD_Reference_ID=19,Updated=TO_TIMESTAMP('2016-12-16 10:50:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=550799
;

-- Dec 16, 2016 10:50:59 AM WIT
--  
UPDATE AD_Process_Para SET AD_Reference_ID=18,Updated=TO_TIMESTAMP('2016-12-16 10:50:59','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=550799
;
