...
--  
UPDATE AD_Column SET FKConstraintType='N', FKConstraintName='CDocType_STimeExpense',Updated=TO_TIMESTAMP('2016-06-24 14:20:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552002
;

-- Jun 24, 2016 2:20:03 PM WIT
--  
ALTER TABLE S_TimeExpense ADD COLUMN C_DocType_ID NUMERIC(10) NOT NULL
;

-- Jun 24, 2016 2:20:36 PM WIT
--  
UPDATE AD_Column SET DefaultValue='550003',Updated=TO_TIMESTAMP('2016-06-24 14:20:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552002
;

-- Jun 24, 2016 2:20:38 PM WIT
--  
UPDATE AD_Column SET FKConstraintType='N', FKConstraintName='CDocType_STimeExpense',Updated=TO_TIMESTAMP('2016-06-24 14:20:38','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552002
;

-- Jun 24, 2016 2:20:38 PM WIT
--  
ALTER TABLE S_TimeExpense ADD COLUMN C_DocType_ID NUMERIC(10) DEFAULT '550003' NOT NULL
;
...
INSERT INTO AD_Val_Rule (Code,AD_Val_Rule_ID,EntityType,Name,Type,AD_Val_Rule_UU,CreatedBy,UpdatedBy,Updated,AD_Org_ID,IsActive,AD_Client_ID,Created) VALUES ('(C_Charge.C_Charge_ID IN (
 ...
 (SELECT COUNT(*) FROM C_ChargeType_DocType WHERE AD_Client_ID=@AD_Client_ID@) = 0)',550180,'U','Z C_Charge by Doc Type AP Invoice','S','7defc050-46a6-450d-9f14-6624d96e05fa',100,100,TO_TIMESTAMP('2016-06-24 14:26:22','YYYY-MM-DD HH24:MI:SS'),0,'Y',0,TO_TIMESTAMP('2016-06-24 14:26:22','YYYY-MM-DD HH24:MI:SS'))
;

-- Jun 24, 2016 2:39:08 PM WIT
--  
INSERT INTO AD_Column (SeqNoSelection,IsSyncDatabase,Version,AD_Column_ID,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,IsKey,ReadOnlyLogic,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Description,Help,Name,IsAllowCopy,Updated,CreatedBy,AD_Org_ID,IsActive,Created,UpdatedBy,IsToolbarButton,IsAlwaysUpdateable,AD_Client_ID,EntityType,IsEncrypted,IsSecure,AD_Element_ID,AD_Reference_ID,AD_Table_ID,AD_Val_Rule_ID) VALUES (0,'N',0,552003,'N','N','N',0,'N',10,'N','N','@M_Product_ID@!0','N','Y','64c559cd-9ef4-41cf-b482-74abfef134fe','Y','C_Charge_ID','Additional document charges','The Charge indicates a type of Charge (Handling, Shipping, Restocking)','Charge','Y',TO_TIMESTAMP('2016-06-24 14:39:08','YYYY-MM-DD HH24:MI:SS'),100,0,'Y',TO_TIMESTAMP('2016-06-24 14:39:08','YYYY-MM-DD HH24:MI:SS'),100,'N','N',0,'U','N','N',968,19,488,550180)
;
...
--  
UPDATE AD_Column SET FKConstraintType='N', FKConstraintName='CCharge_STimeExpenseLine',Updated=TO_TIMESTAMP('2016-06-24 14:39:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552003
;

-- Jun 24, 2016 2:39:11 PM WIT
--  
ALTER TABLE S_TimeExpenseLine ADD COLUMN C_Charge_ID NUMERIC(10) DEFAULT NULL 
;
...
--  
UPDATE AD_Column SET ReadOnlyLogic='@S_ResourceAssignment_ID@!0 | @C_Charge_ID@!0',Updated=TO_TIMESTAMP('2016-06-24 14:40:41','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=6876
;

-- Jun 24, 2016 2:40:45 PM WIT
--  
INSERT INTO t_alter_column values('s_timeexpenseline','M_Product_ID','NUMERIC(10)',null,'NULL')
;
...
--  
INSERT INTO AD_Field (SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,Description,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,UpdatedBy,AD_Org_ID,CreatedBy,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry,AD_Client_ID,ColumnSpan,NumLines,IsAdvancedField,IsDefaultFocus,AD_Column_ID,EntityType,Created) VALUES (0,'N',412,0,'N','N',180,'Y',553042,'N','The Document Type determines document sequence and processing rules','Document type or rules','Document Type','92db431e-8bc7-458b-931d-35483874e7ca','Y','N',100,0,100,TO_TIMESTAMP('2016-06-24 14:41:52','YYYY-MM-DD HH24:MI:SS'),'Y','Y',170,1,'N',0,1,1,'N','N',552002,'U',TO_TIMESTAMP('2016-06-24 14:41:52','YYYY-MM-DD HH24:MI:SS'))
;
...
--  
UPDATE AD_Field SET ColumnSpan=2,Updated=TO_TIMESTAMP('2016-06-24 14:42:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553042
;
...
--  
INSERT INTO AD_Field (SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,Description,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,UpdatedBy,AD_Org_ID,CreatedBy,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry,AD_Client_ID,ColumnSpan,NumLines,IsAdvancedField,IsDefaultFocus,AD_Column_ID,EntityType,Created) VALUES (0,'N',413,0,'N','N',270,'Y',553043,'N','The Charge indicates a type of Charge (Handling, Shipping, Restocking)','Additional document charges','Charge','2ad4549c-38d1-4512-8b26-f4ca1f7e56a4','Y','N',100,0,100,TO_TIMESTAMP('2016-06-24 14:43:17','YYYY-MM-DD HH24:MI:SS'),'Y','Y',270,4,'N',0,2,1,'N','N',552003,'U',TO_TIMESTAMP('2016-06-24 14:43:17','YYYY-MM-DD HH24:MI:SS'))
;
...
--  
UPDATE AD_Column SET FieldLength=10, AD_Reference_ID=19, AD_Reference_Value_ID=NULL,Updated=TO_TIMESTAMP('2016-06-24 14:47:44','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552002
;

-- Jun 24, 2016 2:47:47 PM WIT
--  
INSERT INTO t_alter_column values('s_timeexpense','C_DocType_ID','NUMERIC(10)',null,'550003')
;
