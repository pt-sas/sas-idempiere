...
WHERE rl.M_RMA_ID=@M_RMA_ID@))',Updated=TO_TIMESTAMP('2017-07-19 15:58:38','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Reference_ID=550053
;
...
WHERE rl.M_RMA_ID=@M_RMA_ID@))',Updated=TO_TIMESTAMP('2017-07-19 15:59:10','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Reference_ID=550054
;
...
WHERE iol.M_InOut_ID=@M_InOut_ID@)', AD_Window_ID=320,Updated=TO_TIMESTAMP('2017-07-19 15:59:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Reference_ID=550056
;
...
WHERE il.C_Invoice_ID=@C_Invoice_ID@)', OrderByClause='DocumentNo',Updated=TO_TIMESTAMP('2017-07-19 16:00:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Reference_ID=550057
;
