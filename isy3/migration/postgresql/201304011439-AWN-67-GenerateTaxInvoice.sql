...
--  
UPDATE AD_Form SET Name='_Generate Tax Invoice (Manual)',Updated=TO_TIMESTAMP('2013-04-01 14:24:55','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Form_ID=1000001
;

-- Apr 1, 2013 2:25:55 PM WIT
--  
INSERT INTO AD_Menu (AD_Menu_ID,IsSummary,IsSOTrx,IsReadOnly,AD_Form_ID,EntityType,IsCentrallyMaintained,Name,"action",AD_Menu_UU,IsActive,AD_Client_ID,CreatedBy,Updated,AD_Org_ID,Created,UpdatedBy) VALUES (1000000,'N','Y','N',1000001,'U','Y','Generate Tax Invoice (Manual)','X','0f79c352-1500-4c73-bcff-66134194c5ff','Y',0,100,TO_TIMESTAMP('2013-04-01 14:25:55','YYYY-MM-DD HH24:MI:SS'),0,TO_TIMESTAMP('2013-04-01 14:25:55','YYYY-MM-DD HH24:MI:SS'),100)
;
