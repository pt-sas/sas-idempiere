...
--  
UPDATE AD_InfoColumn SET Name='Document Type',Updated=TO_TIMESTAMP('2015-11-15 15:29:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoColumn_ID=550044
;

-- Nov 15, 2015 3:29:39 PM WIT
--  
UPDATE AD_InfoColumn SET SeqNoSelection=100,Updated=TO_TIMESTAMP('2015-11-15 15:29:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoColumn_ID=550044
;

-- Nov 15, 2015 3:31:46 PM WIT
--  
INSERT INTO AD_InfoColumn (Help,SeqNo,AD_InfoColumn_UU,AD_InfoColumn_ID,IsQueryCriteria,EntityType,Description,CreatedBy,Updated,AD_Org_ID,UpdatedBy,Name,IsCentrallyMaintained,ColumnName,IsDisplayed,IsActive,QueryOperator,SelectClause,SeqNoSelection,IsIdentifier,AD_Client_ID,AD_Element_ID,AD_InfoWindow_ID,AD_Reference_ID,AD_Reference_Value_ID,Created) VALUES ('The Document Status indicates the status of a document at this time.  If you want to change the document status, use the Document Action field',150,'305deabf-5872-4676-a31d-e35e0b2bb6b6',550045,'Y','U','The current status of the document',100,TO_TIMESTAMP('2015-11-15 15:31:46','YYYY-MM-DD HH24:MI:SS'),0,100,'Document Status','Y','DocStatus','Y','Y','=','o.DocStatus',110,'N',0,289,200002,17,131,TO_TIMESTAMP('2015-11-15 15:31:46','YYYY-MM-DD HH24:MI:SS'))
;
