...
-- Jun 3, 2013 2:42:48 PM WIT
--  
INSERT INTO AD_Process_Access (AD_Process_ID,AD_Role_ID,AD_Process_Access_UU,UpdatedBy,CreatedBy,Updated,AD_Org_ID,Created,IsActive,AD_Client_ID) VALUES (550009,50002,'ed37ce22-14ef-4bc5-bd68-6c7a99c2f695',100,100,TO_TIMESTAMP('2013-06-03 14:42:48','YYYY-MM-DD HH24:MI:SS'),0,TO_TIMESTAMP('2013-06-03 14:42:48','YYYY-MM-DD HH24:MI:SS'),'Y',0)
;

-- Jun 3, 2013 2:42:48 PM WIT
--  
INSERT INTO AD_Process_Access (AD_Process_ID,AD_Role_ID,AD_Process_Access_UU,UpdatedBy,CreatedBy,Updated,AD_Org_ID,Created,IsActive,AD_Client_ID) VALUES (550009,0,'1cf82191-2b68-4e67-a0e3-1102c1ae4669',100,100,TO_TIMESTAMP('2013-06-03 14:42:48','YYYY-MM-DD HH24:MI:SS'),0,TO_TIMESTAMP('2013-06-03 14:42:48','YYYY-MM-DD HH24:MI:SS'),'Y',0)
;

-- Jun 3, 2013 2:42:49 PM WIT
--  
INSERT INTO AD_Process_Access (AD_Process_ID,AD_Role_ID,AD_Process_Access_UU,UpdatedBy,CreatedBy,Updated,AD_Org_ID,Created,IsActive,AD_Client_ID) VALUES (550009,102,'99fe6f87-d694-474a-978f-8b79e647b0a4',100,100,TO_TIMESTAMP('2013-06-03 14:42:48','YYYY-MM-DD HH24:MI:SS'),0,TO_TIMESTAMP('2013-06-03 14:42:48','YYYY-MM-DD HH24:MI:SS'),'Y',11)
;

-- Jun 3, 2013 2:42:49 PM WIT
--  
INSERT INTO AD_Process_Access (AD_Process_ID,AD_Role_ID,AD_Process_Access_UU,UpdatedBy,CreatedBy,Updated,AD_Org_ID,Created,IsActive,AD_Client_ID) VALUES (550009,50001,'51749c2b-b254-405d-8573-91cfbbbc2735',100,100,TO_TIMESTAMP('2013-06-03 14:42:49','YYYY-MM-DD HH24:MI:SS'),0,TO_TIMESTAMP('2013-06-03 14:42:49','YYYY-MM-DD HH24:MI:SS'),'Y',0)
;

-- Jun 3, 2013 2:42:49 PM WIT
--  
INSERT INTO AD_Process_Access (AD_Process_ID,AD_Role_ID,AD_Process_Access_UU,UpdatedBy,CreatedBy,Updated,AD_Org_ID,Created,IsActive,AD_Client_ID) VALUES (550009,1000003,'fdc4ed68-932e-47ce-8240-ffb1edea8424',100,100,TO_TIMESTAMP('2013-06-03 14:42:49','YYYY-MM-DD HH24:MI:SS'),0,TO_TIMESTAMP('2013-06-03 14:42:49','YYYY-MM-DD HH24:MI:SS'),'Y',1000001)
;
...
-- Jun 3, 2013 2:42:49 PM WIT
--  
INSERT INTO AD_Process_Access (AD_Process_ID,AD_Role_ID,AD_Process_Access_UU,UpdatedBy,CreatedBy,Updated,AD_Org_ID,Created,IsActive,AD_Client_ID) VALUES (550009,1000120,'2a9d89c1-6465-47b0-b2d9-c52fec5f73ac',100,100,TO_TIMESTAMP('2013-06-03 14:42:49','YYYY-MM-DD HH24:MI:SS'),0,TO_TIMESTAMP('2013-06-03 14:42:49','YYYY-MM-DD HH24:MI:SS'),'Y',1000003)
;

-- Jun 3, 2013 2:42:49 PM WIT
--  
INSERT INTO AD_Process_Access (AD_Process_ID,AD_Role_ID,AD_Process_Access_UU,UpdatedBy,CreatedBy,Updated,AD_Org_ID,Created,IsActive,AD_Client_ID) VALUES (550009,1000121,'0c31aac2-4de8-4dbc-bce3-0b536304fdb6',100,100,TO_TIMESTAMP('2013-06-03 14:42:49','YYYY-MM-DD HH24:MI:SS'),0,TO_TIMESTAMP('2013-06-03 14:42:49','YYYY-MM-DD HH24:MI:SS'),'Y',1000003)
;
...
--  
UPDATE AD_Process_Para SET Help=NULL, Name='Script Path', Description='Script Path',Updated=TO_TIMESTAMP('2013-06-03 14:45:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=550010
;

-- Jun 3, 2013 2:46:24 PM WIT
--  
INSERT INTO AD_Process_Para (IsRange,AD_Process_Para_ID,AD_Process_Para_UU,AD_Process_ID,AD_Reference_ID,IsMandatory,DisplayLogic,EntityType,Name,ColumnName,Description,FieldLength,IsCentrallyMaintained,SeqNo,DefaultValue,IsActive,UpdatedBy,Updated,CreatedBy,Created,AD_Org_ID,IsEncrypted,AD_Client_ID) VALUES ('N',550011,'efd0c361-baa2-4202-ae7c-24ba8f4023cd',550009,10,'Y','0=1','U','File Path','Name','File Path',200,'N',20,'/opt/access.txt','Y',100,TO_TIMESTAMP('2013-06-03 14:46:24','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2013-06-03 14:46:24','YYYY-MM-DD HH24:MI:SS'),0,'N',0)
;
...
--  
INSERT INTO AD_Menu (AD_Menu_ID,IsSummary,IsSOTrx,IsReadOnly,AD_Process_ID,EntityType,IsCentrallyMaintained,Name,"action",AD_Menu_UU,IsActive,CreatedBy,Updated,AD_Org_ID,Created,UpdatedBy,AD_Client_ID) VALUES (550005,'N','N','N',550009,'U','Y','Reset Email Access','P','16f56cbb-7922-45b3-b049-ceae797d6bf7','Y',100,TO_TIMESTAMP('2013-06-03 14:48:45','YYYY-MM-DD HH24:MI:SS'),0,TO_TIMESTAMP('2013-06-03 14:48:45','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- Jun 3, 2013 2:48:46 PM WIT
--  
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', statement_timestamp(), 100, statement_timestamp(), 100,t.AD_Tree_ID, 550005, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=550005)
;
