...
--  
INSERT INTO AD_InfoWindow_Access (AD_Client_ID,AD_Org_ID,CreatedBy,IsActive,AD_InfoWindow_Access_UU,UpdatedBy,AD_Role_ID,Created,Updated,AD_InfoWindow_ID) VALUES (11,0,100,'Y','04f77fd4-4dc0-41f7-97ae-a57e67d3b305',100,103,TO_TIMESTAMP('2016-09-14 16:17:18','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2016-09-14 16:17:18','YYYY-MM-DD HH24:MI:SS'),550012)
;

-- Sep 14, 2016 4:17:18 PM WIT
--  
INSERT INTO AD_InfoWindow_Access (AD_Client_ID,AD_Org_ID,CreatedBy,IsActive,AD_InfoWindow_Access_UU,UpdatedBy,AD_Role_ID,Created,Updated,AD_InfoWindow_ID) VALUES (0,0,100,'Y','a4957147-2109-4a67-8f60-1ab1be1746b6',100,0,TO_TIMESTAMP('2016-09-14 16:17:18','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2016-09-14 16:17:18','YYYY-MM-DD HH24:MI:SS'),550012)
;

-- Sep 14, 2016 4:17:18 PM WIT
--  
INSERT INTO AD_InfoWindow_Access (AD_Client_ID,AD_Org_ID,CreatedBy,IsActive,AD_InfoWindow_Access_UU,UpdatedBy,AD_Role_ID,Created,Updated,AD_InfoWindow_ID) VALUES (11,0,100,'Y','36857e3a-7635-4bd5-bdcb-f9c5e3b4f670',100,102,TO_TIMESTAMP('2016-09-14 16:17:18','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2016-09-14 16:17:18','YYYY-MM-DD HH24:MI:SS'),550012)
;

-- Sep 14, 2016 4:17:18 PM WIT
--  
INSERT INTO AD_InfoWindow_Access (AD_Client_ID,AD_Org_ID,CreatedBy,IsActive,AD_InfoWindow_Access_UU,UpdatedBy,AD_Role_ID,Created,Updated,AD_InfoWindow_ID) VALUES (1000001,0,100,'Y','ef1a5046-9fa3-43d0-80b8-c35c13842693',100,1000003,TO_TIMESTAMP('2016-09-14 16:17:18','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2016-09-14 16:17:18','YYYY-MM-DD HH24:MI:SS'),550012)
;

-- Sep 14, 2016 4:17:18 PM WIT
--  
INSERT INTO AD_InfoWindow_Access (AD_Client_ID,AD_Org_ID,CreatedBy,IsActive,AD_InfoWindow_Access_UU,UpdatedBy,AD_Role_ID,Created,Updated,AD_InfoWindow_ID) VALUES (1000001,0,100,'Y','c04b6e45-a8a6-4361-bbe1-96f0f827f79b',100,1000002,TO_TIMESTAMP('2016-09-14 16:17:18','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2016-09-14 16:17:18','YYYY-MM-DD HH24:MI:SS'),550012)
;

-- Sep 14, 2016 4:17:58 PM WIT
--  
INSERT INTO AD_InfoColumn (Help,SeqNo,AD_InfoColumn_UU,AD_InfoColumn_ID,IsQueryCriteria,EntityType,Description,CreatedBy,Updated,AD_Org_ID,UpdatedBy,Name,AD_Val_Rule_ID,IsCentrallyMaintained,ColumnName,IsDisplayed,IsActive,QueryOperator,SelectClause,SeqNoSelection,IsIdentifier,AD_Client_ID,AD_Element_ID,AD_InfoWindow_ID,AD_Reference_ID,Created) VALUES ('An organization is a unit of your client or legal entity - examples are store, department. You can share data between organizations.',10,'8b60473b-b970-407a-a682-8060ab56f7e4',550120,'Y','U','Organizational entity within client',100,TO_TIMESTAMP('2016-09-14 16:17:58','YYYY-MM-DD HH24:MI:SS'),0,100,'Organization',550111,'Y','AD_Org_ID','Y','Y','=','m.AD_Org_ID',1,'N',0,113,550012,19,TO_TIMESTAMP('2016-09-14 16:17:58','YYYY-MM-DD HH24:MI:SS'))
;
...
--  
UPDATE AD_InfoColumn SET SeqNoSelection=10,Updated=TO_TIMESTAMP('2016-09-14 16:18:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoColumn_ID=550120
;

-- Sep 14, 2016 4:18:27 PM WIT
--  
INSERT INTO AD_InfoColumn (SeqNo,AD_InfoColumn_UU,AD_InfoColumn_ID,IsQueryCriteria,EntityType,Description,CreatedBy,Updated,AD_Org_ID,UpdatedBy,Name,IsCentrallyMaintained,ColumnName,IsDisplayed,IsActive,QueryFunction,QueryOperator,SelectClause,SeqNoSelection,IsIdentifier,AD_Client_ID,AD_Element_ID,AD_InfoWindow_ID,AD_Reference_ID,Created) VALUES (20,'1407a07c-ecb0-4c1a-b4f7-f78b123a093d',550121,'Y','U','Document sequence number of the document',100,TO_TIMESTAMP('2016-09-14 16:18:27','YYYY-MM-DD HH24:MI:SS'),0,100,'Document No','Y','DocumentNo','Y','Y','Upper','Like','m.DocumentNo',20,'Y',0,290,550012,10,TO_TIMESTAMP('2016-09-14 16:18:27','YYYY-MM-DD HH24:MI:SS'))
;
...
--  
UPDATE AD_InfoWindow SET IsValid='Y',Updated=TO_TIMESTAMP('2016-09-14 16:21:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoWindow_ID=550012
;

-- Sep 14, 2016 4:23:18 PM WIT
--  
UPDATE AD_InfoWindow SET Name='Inventory Move Info',Updated=TO_TIMESTAMP('2016-09-14 16:23:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoWindow_ID=550012
;
