...
--  
INSERT INTO C_Bank (C_Bank_UU,RoutingNo,C_Bank_ID,IsOwnBank,Name,Description,CreatedBy,UpdatedBy,AD_Client_ID,IsActive,Created,Updated,AD_Org_ID) VALUES ('cf654fb2-c1e9-47ae-b406-0e2d9f1f1f86','.',800003,'Y','CQ','Cheque',100,100,1000001,'Y',TO_TIMESTAMP('2016-07-28 15:23:46','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2016-07-28 15:23:46','YYYY-MM-DD HH24:MI:SS'),0)
;

-- Jul 28, 2016 3:24:17 PM WIT
--  
INSERT INTO C_BankAccount (IsDefault,BankAccountType,CreditLimit,C_BankAccount_ID,C_BankAccount_UU,CreatedBy,Updated,UpdatedBy,AD_Client_ID,IsActive,AccountNo,Value,Name,C_Bank_ID,C_Currency_ID,Created,AD_Org_ID,CurrentBalance) VALUES ('N','C',0,800008,'88cf3e7a-9122-4499-bc7a-2234840d43ce',100,TO_TIMESTAMP('2016-07-28 15:24:17','YYYY-MM-DD HH24:MI:SS'),100,1000001,'Y','Cheque','Cheque','Cheque',800003,303,TO_TIMESTAMP('2016-07-28 15:24:17','YYYY-MM-DD HH24:MI:SS'),1000001,0)
;
