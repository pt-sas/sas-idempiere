...
--  
UPDATE AD_InfoColumn SET IsQueryCriteria='Y', QueryOperator='=', SeqNoSelection=5,Updated=TO_TIMESTAMP('2016-07-27 14:13:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoColumn_ID=550057
;

-- Jul 27, 2016 2:15:08 PM WIT
--  
INSERT INTO AD_InfoColumn (Help,SeqNo,AD_InfoColumn_UU,AD_InfoColumn_ID,IsQueryCriteria,EntityType,Description,CreatedBy,Updated,AD_Org_ID,UpdatedBy,Name,AD_Val_Rule_ID,IsCentrallyMaintained,ColumnName,IsDisplayed,IsActive,QueryOperator,SelectClause,SeqNoSelection,IsIdentifier,AD_Client_ID,AD_Element_ID,AD_InfoWindow_ID,AD_Reference_ID,Created) VALUES ('An organization is a unit of your client or legal entity - examples are store, department. You can share data between organizations.',2,'e5bd75a3-f5f8-4f91-8bb5-2054c850c4fe',550073,'Y','U','Organizational entity within client',100,TO_TIMESTAMP('2016-07-27 14:15:08','YYYY-MM-DD HH24:MI:SS'),0,100,'Organization',550111,'Y','AD_Org_ID','Y','Y','=','p.AD_Org_ID',2,'N',0,113,550005,19,TO_TIMESTAMP('2016-07-27 14:15:08','YYYY-MM-DD HH24:MI:SS'))
;
