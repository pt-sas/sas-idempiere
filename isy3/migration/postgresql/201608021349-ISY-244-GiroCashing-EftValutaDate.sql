...
--  
UPDATE AD_InfoColumn SET SelectClause='p.CheckNo',Updated=TO_TIMESTAMP('2016-08-02 13:41:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoColumn_ID=550072
;

-- Aug 2, 2016 1:42:46 PM WIT
--  
INSERT INTO AD_InfoColumn (Help,SeqNo,AD_InfoColumn_UU,AD_InfoColumn_ID,IsQueryCriteria,EntityType,Description,CreatedBy,Updated,AD_Org_ID,UpdatedBy,Name,IsCentrallyMaintained,ColumnName,IsDisplayed,IsActive,SelectClause,SeqNoSelection,IsIdentifier,AD_Client_ID,AD_Element_ID,AD_InfoWindow_ID,AD_Reference_ID,Created) VALUES ('Information from EFT media',170,'247350fd-4d1a-489b-892f-11d22c5d1e8a',550097,'N','U','Electronic Funds Transfer Valuta (effective) Date',100,TO_TIMESTAMP('2016-08-02 13:42:46','YYYY-MM-DD HH24:MI:SS'),0,100,'EFT Effective Date','Y','EftValutaDate','Y','Y','p.EftValutaDate',0,'N',0,2294,550005,15,TO_TIMESTAMP('2016-08-02 13:42:46','YYYY-MM-DD HH24:MI:SS'))
;
...
--  
INSERT INTO AD_InfoColumn (Help,SeqNo,AD_InfoColumn_UU,AD_InfoColumn_ID,IsQueryCriteria,EntityType,Description,CreatedBy,Updated,AD_Org_ID,UpdatedBy,Name,IsCentrallyMaintained,ColumnName,IsDisplayed,IsActive,QueryFunction,QueryOperator,SelectClause,SeqNoSelection,IsIdentifier,AD_Client_ID,AD_Element_ID,AD_InfoWindow_ID,AD_Reference_ID,Created) VALUES ('Information from EFT media',180,'afef3077-c598-4538-a235-a485916acfa3',550098,'Y','U','Electronic Funds Transfer Valuta (effective) Date',100,TO_TIMESTAMP('2016-08-02 13:44:38','YYYY-MM-DD HH24:MI:SS'),0,100,'EFT Effective Date','Y','EftValutaDate','N','Y','Trunc','>=','p.EftValutaDate AS EftValutaDateFrom',80,'N',0,2294,550005,15,TO_TIMESTAMP('2016-08-02 13:44:38','YYYY-MM-DD HH24:MI:SS'))
;
