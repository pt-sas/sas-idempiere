...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Column SET FKConstraintType='N', FKConstraintName='ADOrgTrx_MRequisitionLine',Updated=TO_TIMESTAMP('2015-03-04 09:52:52','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=551124
;

-- Mar 4, 2015 9:52:52 AM WIT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
ALTER TABLE M_RequisitionLine ADD COLUMN AD_OrgTrx_ID NUMERIC(10) DEFAULT NULL 
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET DefaultValue='@AD_OrgTrx_ID@',Updated=TO_TIMESTAMP('2015-03-04 10:03:34','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=552086
;
