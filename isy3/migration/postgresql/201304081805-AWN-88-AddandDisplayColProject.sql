...
--  
ALTER TABLE S_TimeExpense ADD COLUMN C_Project_ID NUMERIC(10) DEFAULT NULL 
;

-- Apr 8, 2013 5:43:14 PM WIT
--  
INSERT INTO AD_Field (ColumnSpan,NumLines,SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,IsDisplayed,IsFieldOnly,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry) VALUES (1,1,0,'N',412,0,'N','N',550034,150,'Y',550083,'N','A Project allows you to track and control internal or external activities.','U','Financial Project','Project','Y','N','604f33e2-b10a-4264-bf2b-8f108a4403d4',100,0,TO_TIMESTAMP('2013-04-08 17:43:14','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-04-08 17:43:14','YYYY-MM-DD HH24:MI:SS'),'Y','Y',150,1,'N')
;
...
--  
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2013-04-08 17:49:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=550075
;

-- Apr 8, 2013 5:50:10 PM WIT
--  
UPDATE AD_Field SET ColumnSpan=50,Updated=TO_TIMESTAMP('2013-04-08 17:50:10','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=550075
;

-- Apr 8, 2013 5:51:05 PM WIT
--  
UPDATE AD_Field SET ColumnSpan=1,Updated=TO_TIMESTAMP('2013-04-08 17:51:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=550075
;

-- Apr 8, 2013 5:59:01 PM WIT
--  
UPDATE AD_Field SET ColumnSpan=2,Updated=TO_TIMESTAMP('2013-04-08 17:59:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=550075
;

-- Apr 8, 2013 5:59:45 PM WIT
--  
UPDATE AD_Field SET XPosition=2,Updated=TO_TIMESTAMP('2013-04-08 17:59:45','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=550075
;

-- Apr 8, 2013 6:01:38 PM WIT
--  
UPDATE AD_Field SET XPosition=4,Updated=TO_TIMESTAMP('2013-04-08 18:01:38','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=550075
;

-- Apr 8, 2013 6:01:44 PM WIT
--  
UPDATE AD_Field SET ColumnSpan=2,Updated=TO_TIMESTAMP('2013-04-08 18:01:44','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=550083
;

-- Apr 8, 2013 6:03:41 PM WIT
--  
UPDATE AD_Field SET NumLines=2,Updated=TO_TIMESTAMP('2013-04-08 18:03:41','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=550083
;

-- Apr 8, 2013 6:04:32 PM WIT
--  
UPDATE AD_Field SET NumLines=1,Updated=TO_TIMESTAMP('2013-04-08 18:04:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=550083
;
