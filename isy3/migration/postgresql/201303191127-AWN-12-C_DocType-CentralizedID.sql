...
For customizations, copy the entity and select "User"!','Entity Type','Y',TO_TIMESTAMP('2013-03-19 10:21:56','YYYY-MM-DD HH24:MI:SS'),100,0,'Y',TO_TIMESTAMP('2013-03-19 10:21:56','YYYY-MM-DD HH24:MI:SS'),100,0,'N','N','N','N')
;
...
--  
ALTER TABLE C_DocType ADD EntityType VARCHAR(40) DEFAULT 'U'
;
...
For customizations, copy the entity and select "User"!','U','Dictionary Entity Type; Determines ownership and synchronization','Entity Type','Y','N','fac3253b-72f1-43d0-b254-1fa93e6d9890',100,0,TO_TIMESTAMP('2013-03-19 10:34:14','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-03-19 10:34:14','YYYY-MM-DD HH24:MI:SS'),'Y','N',330,1,'N')
;
