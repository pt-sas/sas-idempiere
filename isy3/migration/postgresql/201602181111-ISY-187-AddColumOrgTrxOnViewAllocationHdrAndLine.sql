...
--  
UPDATE AD_Column SET FKConstraintType='N', FKConstraintName='ADOrgTrx_CAllocationHdr',Updated=TO_TIMESTAMP('2016-02-18 10:29:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=551907
;

-- Feb 18, 2016 10:29:23 AM WIT
--  
ALTER TABLE C_AllocationHdr ADD COLUMN AD_OrgTrx_ID NUMERIC(10) DEFAULT NULL 
;
...
--  
INSERT INTO AD_Column (SeqNoSelection,IsSyncDatabase,Version,AD_Column_ID,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,IsKey,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Description,Help,Name,IsAllowCopy,Updated,CreatedBy,AD_Org_ID,IsActive,Created,UpdatedBy,IsToolbarButton,IsAlwaysUpdateable,AD_Client_ID,EntityType,IsEncrypted,IsSecure,FKConstraintType,AD_Element_ID,AD_Reference_ID,AD_Reference_Value_ID,AD_Table_ID,AD_Val_Rule_ID) VALUES (0,'N',0,551908,'N','N','N',0,'N',22,'N','N','N','Y','870149b4-b431-4bc7-88e1-57421249f0cd','Y','AD_OrgTrx_ID','Performing or initiating organization','The organization which performs or initiates this transaction (for another organization).  The owning Organization may not be the transaction organization in a service bureau environment, with centralized services, and inter-organization transactions.','Trx Organization','Y',TO_TIMESTAMP('2016-02-18 10:30:30','YYYY-MM-DD HH24:MI:SS'),100,0,'Y',TO_TIMESTAMP('2016-02-18 10:30:30','YYYY-MM-DD HH24:MI:SS'),100,'N','N',0,'U','N','N','N',112,18,130,390,550110)
;
...
--  
UPDATE AD_Column SET FKConstraintType='N', FKConstraintName='ADOrgTrx_CAllocationLine',Updated=TO_TIMESTAMP('2016-02-18 10:30:38','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=551908
;

-- Feb 18, 2016 10:30:38 AM WIT
--  
ALTER TABLE C_AllocationLine ADD COLUMN AD_OrgTrx_ID NUMERIC(10) DEFAULT NULL 
;
...
--  
UPDATE AD_Field SET XPosition=4, ColumnSpan=2,Updated=TO_TIMESTAMP('2016-02-18 10:31:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=552893
;
...
--  
UPDATE AD_Field SET XPosition=4, ColumnSpan=2,Updated=TO_TIMESTAMP('2016-02-18 10:32:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=552894
;
...
--  
UPDATE AD_Column SET IsUpdateable='N',Updated=TO_TIMESTAMP('2016-02-18 10:35:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=551907
;

-- Feb 18, 2016 10:35:25 AM WIT
--  
INSERT INTO t_alter_column values('c_allocationhdr','AD_OrgTrx_ID','NUMERIC(10)',null,'NULL')
;
...
--  
UPDATE AD_Column SET IsUpdateable='N',Updated=TO_TIMESTAMP('2016-02-18 10:35:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=551908
;

-- Feb 18, 2016 10:35:51 AM WIT
--  
INSERT INTO t_alter_column values('c_allocationline','AD_OrgTrx_ID','NUMERIC(10)',null,'NULL')
;
...
--  
UPDATE AD_Field SET IsReadOnly='Y',Updated=TO_TIMESTAMP('2016-02-18 10:38:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=552893
;

-- Feb 18, 2016 10:38:16 AM WIT
--  
UPDATE AD_Field SET IsReadOnly='Y',Updated=TO_TIMESTAMP('2016-02-18 10:38:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=552894
;
