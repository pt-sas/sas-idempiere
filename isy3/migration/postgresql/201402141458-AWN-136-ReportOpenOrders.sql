...
--  
UPDATE AD_Process_Para SET SeqNo=35,Updated=TO_TIMESTAMP('2014-02-14 14:51:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=550062
;

-- Feb 14, 2014 2:57:11 PM WIT
--  
UPDATE AD_Process_Para SET DefaultValue='CO',Updated=TO_TIMESTAMP('2014-02-14 14:57:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=550062
;
