 ...
 *****************************************************************************/
package id.co.databiz.awn.ui.zk.factory;

import id.co.databiz.awn.model.MTaxInvoice;
import id.co.databiz.awn.ui.zk.panel.InfoAssignmentPanel;
import id.co.databiz.awn.ui.zk.panel.InfoInOutPanel;
import id.co.databiz.awn.ui.zk.panel.InfoInvoicePanel;
import id.co.databiz.awn.ui.zk.panel.InfoOrderPanel;
import id.co.databiz.awn.ui.zk.panel.InfoTaxInvoicePanel;
...
public class InfoFactory implements IInfoFactory {
	...
	public InfoPanel create(int WindowNo, String tableName, String keyColumn,
        ...
        if (tableName.equals("C_BPartner")) {
        	...
        	info = new InfoTaxInvoicePanel (WindowNo, value,
                    multiSelection, whereClause, lookup);
        } else {
