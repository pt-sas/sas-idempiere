...
public class ReportCtl
{
	...
	public final static int 	Z_PROCESS_RPT_M_REQUISITION = 550167;
	...
	static public boolean start (IProcessUI parent, int WindowNo, ProcessInfo pi)
	{
		...
		**/
		...
		// ISY-19
	   else if (pi.getAD_Process_ID() == Z_PROCESS_RPT_M_REQUISITION)
			return startDocumentPrint(REQUISITION, pi.getRecord_ID(), parent, WindowNo, !pi.isPrintPreview());
		/********************
		 *	Standard Report
		 *******************/
