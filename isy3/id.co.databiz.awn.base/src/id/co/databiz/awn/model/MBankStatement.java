...
*/
public class MBankStatement extends org.compiere.model.MBankStatement implements DocAction
{
	/**
	 * 
	 */
	...
	public String prepareIt()
	{
		...
		// AWN-246 disable period validation on line
...
//		MPeriod.testPeriodOpen(getCtx(), maxDate, MDocType.DOCBASETYPE_BankStatement, 0);
	...
	public boolean voidIt()
	{
		...
		MBankAccount ba = getBankAccount();
		MBankStatementLine bsl = new MBankStatementLine(getCtx(), getC_BankStatement_ID(), get_TrxName());
		
		ba.load(get_TrxName());
		
		//	ISY-9
		if(DOCSTATUS_Drafted.equals(getDocStatus()) && bsl!=null){
		}else{
