...
import org.compiere.CurrencyUtil;
...
*/
	...
	public String getSummary()
	{
		...
		sb.append(": ")
			.append(Msg.translate(getCtx(),"PayAmt")).append("=").append(CurrencyUtil.formatCurrency(getPayAmt(), getC_Currency_ID()))
			.append(",").append(Msg.translate(getCtx(),"WriteOffAmt")).append("=").append(CurrencyUtil.formatCurrency(getWriteOffAmt(), getC_Currency_ID()));
		//	 - Description
