...
public class MPaymentAllocate extends org.compiere.model.MPaymentAllocate
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7393819350538763654L;
	...
	protected boolean beforeSave (boolean newRecord)
	{
		...
		ICPaymentAllocate allocateCustom = POWrapper.create(this, ICPaymentAllocate.class);
		...
		BigDecimal check = getAmount()
			...
			.add(getWriteOffAmt())
			.add(getOverUnderAmt());
		if (check.compareTo(getInvoiceAmt()) != 0 && allocateCustom.getC_Charge_ID() == 0)
		{
