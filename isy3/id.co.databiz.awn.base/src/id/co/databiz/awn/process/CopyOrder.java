...
public class CopyOrder extends SvrProcess
{
	...
	protected String doIt() throws Exception
	{
		...
		//	ISY-217
		String sqlInvoice = "UPDATE C_Order set C_Quotation_ID=" + from.getC_Order_ID() + 
						   " WHERE C_Order_ID=" + newOrder.getC_Order_ID();
		int no = DB.executeUpdate(sqlInvoice, get_TrxName());
		if (log.isLoggable(Level.FINE)) log.fine("Quotation -> #" + no);
