...
Please note that the Business Partner <b>must</b> be an Employee with an Address and Contact! ',Updated=TO_DATE('2016-07-18 17:27:04','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=412
;

-- Jul 18, 2016 5:27:19 PM WIT
--  
INSERT INTO AD_Column (SeqNoSelection,IsSyncDatabase,Version,AD_Column_ID,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,IsKey,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Description,Help,DefaultValue,Name,IsAllowCopy,Updated,AD_Org_ID,IsActive,Created,IsAlwaysUpdateable,AD_Client_ID,EntityType,IsEncrypted,IsSecure,AD_Element_ID,AD_Reference_ID,AD_Table_ID,IsToolbarButton,CreatedBy,UpdatedBy) VALUES (0,'N',0,552093,'N','N','N',0,'N',1,'N','N','N','Y','d80add96-099a-4c5a-a4d2-23ef8512b3d8','Y','IsManual','This is a manual process','The Manual check box indicates if the process will done manually.','Y','Manual','Y',TO_DATE('2016-07-18 17:27:18','YYYY-MM-DD HH24:MI:SS'),0,'Y',TO_DATE('2016-07-18 17:27:18','YYYY-MM-DD HH24:MI:SS'),'N',0,'U','N','N',1474,20,486,'Y',100,100)
;
...
--  
UPDATE AD_Column SET DefaultValue='N',Updated=TO_DATE('2016-07-18 17:27:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552093
;

-- Jul 18, 2016 5:27:34 PM WIT
--  
ALTER TABLE S_TimeExpense ADD IsManual CHAR(1) DEFAULT 'N' CHECK (IsManual IN ('Y','N'))
;

-- Jul 18, 2016 5:28:04 PM WIT
--  
INSERT INTO AD_Field (SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,Description,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,AD_Org_ID,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry,AD_Client_ID,ColumnSpan,NumLines,IsAdvancedField,IsDefaultFocus,AD_Column_ID,Created,EntityType,UpdatedBy,CreatedBy) VALUES (0,'N',412,0,'N','N',210,'Y',553128,'N','The Manual check box indicates if the process will done manually.','This is a manual process','Manual','df17aae1-f55a-4893-bdaf-aa09b94d9051','Y','N',0,TO_DATE('2016-07-18 17:28:04','YYYY-MM-DD HH24:MI:SS'),'Y','Y',200,1,'N',0,1,1,'N','N',552093,TO_DATE('2016-07-18 17:28:04','YYYY-MM-DD HH24:MI:SS'),'U',100,100)
;
...
--  
UPDATE AD_Field SET Name='Advanced',Updated=TO_DATE('2016-07-18 17:28:12','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553128
;

-- Jul 18, 2016 5:29:21 PM WIT
--  
UPDATE AD_Field SET Help='The Manual check box indicates if the approval process will be done manually.', Description='This is a cash advance request',Updated=TO_DATE('2016-07-18 17:29:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553128
;
...
--  
UPDATE AD_Field SET XPosition=4, ColumnSpan=2,Updated=TO_DATE('2016-07-18 17:30:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553128
;

-- Jul 18, 2016 5:31:04 PM WIT
--  
UPDATE AD_Field SET XPosition=4,Updated=TO_DATE('2016-07-18 17:31:04','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=5444
;

-- Jul 18, 2016 5:31:13 PM WIT
--  
UPDATE AD_Field SET XPosition=4,Updated=TO_DATE('2016-07-18 17:31:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553072
;

-- Jul 18, 2016 5:32:18 PM WIT
--  
UPDATE AD_Field SET XPosition=5,Updated=TO_DATE('2016-07-18 17:32:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553128
;

-- Jul 18, 2016 5:33:02 PM WIT
--  
UPDATE AD_Field SET ColumnSpan=2,Updated=TO_DATE('2016-07-18 17:33:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553072
;
