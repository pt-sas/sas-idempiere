-- Aug 29, 2016 3:58:12 PM WIT
--  
INSERT INTO AD_Column (SeqNoSelection,IsSyncDatabase,Version,AD_Column_ID,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,IsKey,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Name,IsAllowCopy,Updated,AD_Org_ID,IsActive,Created,IsAlwaysUpdateable,AD_Client_ID,EntityType,IsEncrypted,IsSecure,AD_Element_ID,AD_Reference_ID,AD_Reference_Value_ID,AD_Table_ID,IsToolbarButton,CreatedBy,UpdatedBy) VALUES (0,'N',0,552256,'N','N','N',0,'N',10,'N','N','N','Y','b031e750-f97e-484c-bbe6-ea99ca6df44c','Y','Ref_Invoice_ID','Referenced Invoice','N',TO_DATE('2016-08-29 15:58:09','YYYY-MM-DD HH24:MI:SS'),0,'Y',TO_DATE('2016-08-29 15:58:09','YYYY-MM-DD HH24:MI:SS'),'N',0,'U','N','N',2429,30,336,417,'Y',100,100)
;
...
--  
UPDATE AD_Column SET FKConstraintName='RefInvoice_RRequest', FKConstraintType='N',Updated=TO_DATE('2016-08-29 15:58:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552256
;

-- Aug 29, 2016 3:58:32 PM WIT
--  
ALTER TABLE R_Request ADD Ref_Invoice_ID NUMBER(10) DEFAULT NULL 
;
