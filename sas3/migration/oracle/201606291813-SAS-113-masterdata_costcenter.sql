...
-- Jun 29, 2016 6:10:23 PM WIT
--  
INSERT INTO AD_TreeNodeU1 (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeU1_UU) SELECT t.AD_Client_ID, 0, 'Y', SysDate, 100, SysDate, 100,t.AD_Tree_ID, 1001049, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=1000001 AND t.IsActive='Y' AND EXISTS (SELECT * FROM C_Element ae WHERE ae.C_Element_ID=1000002 AND t.AD_Tree_ID=ae.AD_Tree_ID) AND NOT EXISTS (SELECT * FROM AD_TreeNodeU1 e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=1001049)
;

-- Jun 29, 2016 6:10:28 PM WIT
--  
INSERT INTO C_ElementValue (IsSummary,PostEncumbrance,AccountSign,IsDocControlled,C_ElementValue_ID,PostStatistical,AccountType,C_Element_ID,PostActual,IsForeignCurrency,C_Currency_ID,IsBankAccount,PostBudget,C_ElementValue_UU,Value,Updated,AD_Client_ID,IsActive,Name,AD_Org_ID,Created,IsReadOnly,IsDetailBPartner,IsDetailProduct,UpdatedBy,CreatedBy) VALUES ('N','Y','N','N',1001050,'Y','E',1000002,'Y','N',303,'N','Y','34393472-6219-4dfb-851f-c5dcbb2c99a4','1000003',TO_DATE('2016-06-29 18:10:28','YYYY-MM-DD HH24:MI:SS'),1000001,'Y','Warehouse',0,TO_DATE('2016-06-29 18:10:28','YYYY-MM-DD HH24:MI:SS'),'N','N','N',100,100)
;
...
-- Jun 29, 2016 6:10:28 PM WIT
--  
INSERT INTO AD_TreeNodeU1 (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeU1_UU) SELECT t.AD_Client_ID, 0, 'Y', SysDate, 100, SysDate, 100,t.AD_Tree_ID, 1001050, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=1000001 AND t.IsActive='Y' AND EXISTS (SELECT * FROM C_Element ae WHERE ae.C_Element_ID=1000002 AND t.AD_Tree_ID=ae.AD_Tree_ID) AND NOT EXISTS (SELECT * FROM AD_TreeNodeU1 e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=1001050)
;

-- Jun 29, 2016 6:10:32 PM WIT
--  
INSERT INTO C_ElementValue (IsSummary,PostEncumbrance,AccountSign,IsDocControlled,C_ElementValue_ID,PostStatistical,AccountType,C_Element_ID,PostActual,IsForeignCurrency,C_Currency_ID,IsBankAccount,PostBudget,C_ElementValue_UU,Value,Updated,AD_Client_ID,IsActive,Name,AD_Org_ID,Created,IsReadOnly,IsDetailBPartner,IsDetailProduct,UpdatedBy,CreatedBy) VALUES ('N','Y','N','N',1001051,'Y','E',1000002,'Y','N',303,'N','Y','330c034b-33f0-4cdd-8381-c1f7fec23d3b','1000004',TO_DATE('2016-06-29 18:10:32','YYYY-MM-DD HH24:MI:SS'),1000001,'Y','IT',0,TO_DATE('2016-06-29 18:10:32','YYYY-MM-DD HH24:MI:SS'),'N','N','N',100,100)
;
...
-- Jun 29, 2016 6:10:32 PM WIT
--  
INSERT INTO AD_TreeNodeU1 (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeU1_UU) SELECT t.AD_Client_ID, 0, 'Y', SysDate, 100, SysDate, 100,t.AD_Tree_ID, 1001051, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=1000001 AND t.IsActive='Y' AND EXISTS (SELECT * FROM C_Element ae WHERE ae.C_Element_ID=1000002 AND t.AD_Tree_ID=ae.AD_Tree_ID) AND NOT EXISTS (SELECT * FROM AD_TreeNodeU1 e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=1001051)
;

-- Jun 29, 2016 6:10:38 PM WIT
--  
INSERT INTO C_ElementValue (IsSummary,PostEncumbrance,AccountSign,IsDocControlled,C_ElementValue_ID,PostStatistical,AccountType,C_Element_ID,PostActual,IsForeignCurrency,C_Currency_ID,IsBankAccount,PostBudget,C_ElementValue_UU,Value,Updated,AD_Client_ID,IsActive,Name,AD_Org_ID,Created,IsReadOnly,IsDetailBPartner,IsDetailProduct,UpdatedBy,CreatedBy) VALUES ('N','Y','N','N',1001052,'Y','E',1000002,'Y','N',303,'N','Y','6dab2c67-45f2-4fe9-9f21-33a2e9fcb3ce','1000005',TO_DATE('2016-06-29 18:10:38','YYYY-MM-DD HH24:MI:SS'),1000001,'Y','Delivery',0,TO_DATE('2016-06-29 18:10:38','YYYY-MM-DD HH24:MI:SS'),'N','N','N',100,100)
;
...
-- Jun 29, 2016 6:10:42 PM WIT
--  
INSERT INTO AD_TreeNodeU1 (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeU1_UU) SELECT t.AD_Client_ID, 0, 'Y', SysDate, 100, SysDate, 100,t.AD_Tree_ID, 1001053, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=1000001 AND t.IsActive='Y' AND EXISTS (SELECT * FROM C_Element ae WHERE ae.C_Element_ID=1000002 AND t.AD_Tree_ID=ae.AD_Tree_ID) AND NOT EXISTS (SELECT * FROM AD_TreeNodeU1 e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=1001053)
;

-- Jun 29, 2016 6:10:46 PM WIT
--  
INSERT INTO C_ElementValue (IsSummary,PostEncumbrance,AccountSign,IsDocControlled,C_ElementValue_ID,PostStatistical,AccountType,C_Element_ID,PostActual,IsForeignCurrency,C_Currency_ID,IsBankAccount,PostBudget,C_ElementValue_UU,Value,Updated,AD_Client_ID,IsActive,Name,AD_Org_ID,Created,IsReadOnly,IsDetailBPartner,IsDetailProduct,UpdatedBy,CreatedBy) VALUES ('N','Y','N','N',1001054,'Y','E',1000002,'Y','N',303,'N','Y','1c6a93a1-6d88-4965-8a8f-7ca98c684abe','1000007',TO_DATE('2016-06-29 18:10:46','YYYY-MM-DD HH24:MI:SS'),1000001,'Y','Sales',0,TO_DATE('2016-06-29 18:10:46','YYYY-MM-DD HH24:MI:SS'),'N','N','N',100,100)
;
...
-- Jun 29, 2016 6:10:46 PM WIT
--  
INSERT INTO AD_TreeNodeU1 (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeU1_UU) SELECT t.AD_Client_ID, 0, 'Y', SysDate, 100, SysDate, 100,t.AD_Tree_ID, 1001054, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=1000001 AND t.IsActive='Y' AND EXISTS (SELECT * FROM C_Element ae WHERE ae.C_Element_ID=1000002 AND t.AD_Tree_ID=ae.AD_Tree_ID) AND NOT EXISTS (SELECT * FROM AD_TreeNodeU1 e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=1001054)
;
