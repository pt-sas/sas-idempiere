...
--  
UPDATE AD_Column SET FKConstraintName='RemoteOrg_SASRequestBundle', FKConstraintType='N',Updated=TO_DATE('2016-08-12 17:49:17','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552221
;

-- Aug 12, 2016 5:49:17 PM WIT
--  
ALTER TABLE SAS_RequestBundle ADD Remote_Org_ID NUMBER(10) DEFAULT NULL 
;
...
--  
UPDATE AD_Field SET Help=NULL, Description=NULL,Updated=TO_DATE('2016-08-12 17:50:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553376
;

-- Aug 12, 2016 5:51:51 PM WIT
--  
UPDATE AD_Field SET ReadOnlyLogic='@Depart@=Y',Updated=TO_DATE('2016-08-12 17:51:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553376
;
