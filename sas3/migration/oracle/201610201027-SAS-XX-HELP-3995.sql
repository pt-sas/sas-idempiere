...
--  
INSERT INTO AD_WF_Node (AD_WF_Node_ID,Cost,YPosition,OverlapUnits,UnitsCycles,Yield,WaitTime,Priority,Duration,EMailRecipient,IsCentrallyMaintained,JoinElement,Limit,WorkingTime,XPosition,WaitingTime,IsMilestone,IsSubcontracting,SplitElement,Action,Value,Name,AD_WF_Node_UU,DynPriorityChange,AD_Workflow_ID,IsActive,DocAction,AD_Client_ID,EntityType,R_MailText_ID,AD_Org_ID,Created,Updated,CreatedBy,UpdatedBy) VALUES (550149,0,0,0,0,100,0,0,0,'D','Y','X',0,0,0,0,'N','N','X','M','Shoot Email Expense Report','Shoot Email Expense Report','fcf9aad5-390e-4f65-9f60-6a6d96df1a97',0,126,'Y','CO',1000001,'U',1000001,0,TO_DATE('2016-10-20 10:09:21','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2016-10-20 10:09:21','YYYY-MM-DD HH24:MI:SS'),100,100)
;
