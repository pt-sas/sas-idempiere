...
--  
ALTER TABLE M_PromotionDistribution ADD IsReward CHAR(1) DEFAULT 'N' CHECK (IsReward IN ('Y','N')) NOT NULL
;

-- Jun 27, 2016 8:15:11 PM WIT
--  
INSERT INTO AD_Field (SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,AD_Org_ID,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry,AD_Client_ID,ColumnSpan,NumLines,IsAdvancedField,IsDefaultFocus,AD_Column_ID,Created,EntityType,UpdatedBy,CreatedBy) VALUES (0,'N',53206,0,'N','N',110,'Y',553044,'N','Reward','1ab34c58-c965-4000-9c50-58101ca1ec10','Y','N',0,TO_DATE('2016-06-27 20:15:11','YYYY-MM-DD HH24:MI:SS'),'Y','Y',110,2,'N',0,2,1,'N','N',552004,TO_DATE('2016-06-27 20:15:11','YYYY-MM-DD HH24:MI:SS'),'U',100,100)
;
