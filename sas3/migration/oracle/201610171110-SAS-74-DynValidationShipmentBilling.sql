...
AND NOT EXISTS(SELECT 1 FROM R_Request r WHERE r.M_InOut_ID = M_InOut.M_InOut_ID AND r.R_Status_ID IN (1000007,1000008) AND r.R_RequestType_ID = @R_RequestType_ID@)',Updated=TO_DATE('2016-10-17 11:02:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=550223
;
