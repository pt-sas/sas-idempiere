...
AND
(M_Warehouse_ID NOT IN (1000018,1000019,1000020,1000021,1000022,1000023))',Updated=TO_DATE('2017-02-08 16:27:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=550200
;
