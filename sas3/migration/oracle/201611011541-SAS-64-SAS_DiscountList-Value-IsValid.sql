...
--  
ALTER TABLE SAS_DiscountList ADD IsValid CHAR(1) DEFAULT 'N' CHECK (IsValid IN ('Y','N')) NOT NULL
;
...
If you leave the search key empty, the system automatically creates a numeric number.  The document sequence used for this fallback number is defined in the "Maintain Sequence" window with the name "DocumentNo_<TableName>", where TableName is the actual name of the table (e.g. C_Order).','Search Key','N',TO_DATE('2016-11-01 15:34:31','YYYY-MM-DD HH24:MI:SS'),0,'Y',TO_DATE('2016-11-01 15:34:31','YYYY-MM-DD HH24:MI:SS'),'N',0,'U','N','N',620,10,550076,'Y',100,100)
;
...
--  
ALTER TABLE SAS_DiscountList ADD Value VARCHAR2(40) DEFAULT NULL 
;

-- Nov 1, 2016 3:36:06 PM WIT
--  
UPDATE AD_Column SET IsAlwaysUpdateable='Y',Updated=TO_DATE('2016-11-01 15:36:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552266
;
...
If you leave the search key empty, the system automatically creates a numeric number.  The document sequence used for this fallback number is defined in the "Maintain Sequence" window with the name "DocumentNo_<TableName>", where TableName is the actual name of the table (e.g. C_Order).','Search key for the record in the format required - must be unique','Search Key','cf32141f-5a46-4ca8-a8a9-a23d08e56aaa','Y','N',0,TO_DATE('2016-11-01 15:37:11','YYYY-MM-DD HH24:MI:SS'),'Y','Y',32,1,'N',0,2,1,'N','N',552343,TO_DATE('2016-11-01 15:37:11','YYYY-MM-DD HH24:MI:SS'),'U',100,100)
;
...
--  
INSERT INTO AD_Field (SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,Description,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,AD_Org_ID,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry,AD_Client_ID,ColumnSpan,NumLines,IsAdvancedField,IsDefaultFocus,AD_Column_ID,Created,EntityType,UpdatedBy,CreatedBy) VALUES (0,'N',550132,0,'Y','N',37,'Y',553478,'N','The element passed the validation check','Element is valid','Valid','a00572fb-213d-4380-969c-d7fd2e94a104','Y','N',0,TO_DATE('2016-11-01 15:37:32','YYYY-MM-DD HH24:MI:SS'),'Y','Y',37,5,'N',0,2,1,'N','N',552342,TO_DATE('2016-11-01 15:37:32','YYYY-MM-DD HH24:MI:SS'),'U',100,100)
;
...
--  
UPDATE AD_Tab SET ReadOnlyLogic='@IsValid@=Y',Updated=TO_DATE('2016-11-01 15:38:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=550132
;

-- Nov 1, 2016 3:38:14 PM WIT
--  
UPDATE AD_Tab SET ReadOnlyLogic='@IsValid@=Y',Updated=TO_DATE('2016-11-01 15:38:14','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=550133
;
