...
--  
UPDATE C_Activity SET Description='Discount less than 5%', Name='Discount < 5%',Updated=TO_DATE('2016-08-31 18:13:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_Activity_ID=1000000
;
...
--  
UPDATE C_Activity SET Description='Discount between 5% and 16%', Name='Discount >= 5% and <= 16%',Updated=TO_DATE('2016-08-31 18:13:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_Activity_ID=1000004
;
...
--  
UPDATE C_Activity SET Description='Discount greater than 16%', Name='Discount > 16%',Updated=TO_DATE('2016-08-31 18:14:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_Activity_ID=1000003
;
