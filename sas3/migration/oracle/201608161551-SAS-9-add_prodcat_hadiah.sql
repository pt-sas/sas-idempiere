...
--  
INSERT INTO M_Product_Category (M_Product_Category_ID,IsDefault,PlannedMargin,MMPolicy,IsSelfService,Value,IsActive,M_Product_Category_UU,AD_PrintColor_ID,Created,Updated,Name,UpdatedBy,CreatedBy,AD_Client_ID,AD_Org_ID) VALUES (1000017,'N',0,'F','Y','Hadiah','Y','ea95b21c-40e5-4cda-9c75-838a757b45ba',100,TO_DATE('2016-08-16 15:48:09','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2016-08-16 15:48:09','YYYY-MM-DD HH24:MI:SS'),'Hadiah',100,100,1000001,0)
;
...
--  
UPDATE M_Product_Category SET Value='Y',Updated=TO_DATE('2016-08-16 15:50:52','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE M_Product_Category_ID=1000017
;
