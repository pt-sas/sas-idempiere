...
--  
INSERT INTO AD_Sequence (StartNewYear,CurrentNextSys,IsTableID,CurrentNext,IsAudited,Prefix,IsAutoSequence,AD_Sequence_ID,DateColumn,DecimalPattern,Description,Name,IncrementNo,AD_Sequence_UU,AD_Org_ID,IsOrgLevelSequence,Updated,IsActive,StartNo,StartNewMonth,AD_Client_ID,Created,MaxValue,CreatedBy,UpdatedBy) VALUES ('Y',5000,'N',1,'N','IMK-@MovementDate<yyMM>@-','Y',551787,'MovementDate','0000','IM Kirim','IM Kirim',1,'7a27571f-50fb-4882-b01a-2a702639f9ea',0,'N',TO_DATE('2016-07-21 17:14:52','YYYY-MM-DD HH24:MI:SS'),'Y',1,'Y',1000001,TO_DATE('2016-07-21 17:14:52','YYYY-MM-DD HH24:MI:SS'),0,100,100)
;

-- Jul 21, 2016 5:15:20 PM WIT
--  
INSERT INTO AD_Sequence (StartNewYear,CurrentNextSys,IsTableID,CurrentNext,IsAudited,Prefix,IsAutoSequence,AD_Sequence_ID,DateColumn,DecimalPattern,Description,Name,IncrementNo,AD_Sequence_UU,AD_Org_ID,IsOrgLevelSequence,Updated,IsActive,StartNo,StartNewMonth,AD_Client_ID,Created,MaxValue,CreatedBy,UpdatedBy) VALUES ('Y',5000,'N',1,'N','IMT-@MovementDate<yyMM>@-','Y',551788,'MovementDate','0000','IM Terima','IM Terima',1,'74a23da2-a1ee-4dd4-a23c-91d0750a8bc5',0,'N',TO_DATE('2016-07-21 17:15:20','YYYY-MM-DD HH24:MI:SS'),'Y',1,'Y',1000001,TO_DATE('2016-07-21 17:15:20','YYYY-MM-DD HH24:MI:SS'),0,100,100)
;

-- Jul 21, 2016 5:15:34 PM WIT
--  
INSERT INTO AD_Sequence (StartNewYear,CurrentNextSys,IsTableID,CurrentNext,IsAudited,Prefix,IsAutoSequence,AD_Sequence_ID,DateColumn,DecimalPattern,Description,Name,IncrementNo,AD_Sequence_UU,AD_Org_ID,IsOrgLevelSequence,Updated,IsActive,StartNo,StartNewMonth,AD_Client_ID,Created,MaxValue,CreatedBy,UpdatedBy) VALUES ('Y',5000,'N',1,'N','IMR-@MovementDate<yyMM>@-','Y',551789,'MovementDate','0000','IM Rusak','IM Rusak',1,'56907802-31d1-4de9-b8dd-829f7714852b',0,'N',TO_DATE('2016-07-21 17:15:34','YYYY-MM-DD HH24:MI:SS'),'Y',1,'Y',1000001,TO_DATE('2016-07-21 17:15:34','YYYY-MM-DD HH24:MI:SS'),0,100,100)
;

-- Jul 21, 2016 5:16:06 PM WIT
--  
UPDATE C_DocType SET PrintName='IM Kirim', Name='IM Kirim', DocNoSequence_ID=551787,Updated=TO_DATE('2016-07-21 17:16:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=1000022
;
