...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
ALTER TABLE M_Promotion ADD IsDiscountAllowedOnTotal CHAR(1) DEFAULT 'Y' CHECK (IsDiscountAllowedOnTotal IN ('Y','N'))
;

-- Jul 20, 2016 1:31:06 PM WIT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Field (SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,AD_Org_ID,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry,AD_Client_ID,ColumnSpan,NumLines,IsAdvancedField,IsDefaultFocus,AD_Column_ID,Created,EntityType,UpdatedBy,CreatedBy) VALUES (0,'N',53203,0,'N','N',80,'Y',553165,'N','IsDiscountAllowedOnTotal','e574386a-216d-4012-8200-45926c4f86f2','Y','N',0,TO_DATE('2016-07-20 13:31:05','YYYY-MM-DD HH24:MI:SS'),'Y','Y',80,2,'N',0,2,1,'N','N',552169,TO_DATE('2016-07-20 13:31:05','YYYY-MM-DD HH24:MI:SS'),'U',100,100)
;
