...
--  
UPDATE C_DocType SET AD_PrintFormat_ID=1000042,Updated=TO_DATE('2016-08-02 22:53:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550286
;

-- Aug 2, 2016 10:54:51 PM WIT
--  
INSERT INTO AD_Sequence (StartNewYear,CurrentNextSys,IsTableID,CurrentNext,IsAudited,Prefix,IsAutoSequence,AD_Sequence_ID,DateColumn,DecimalPattern,Description,Name,IncrementNo,AD_Sequence_UU,AD_Org_ID,IsOrgLevelSequence,Updated,IsActive,StartNo,StartNewMonth,AD_Client_ID,Created,MaxValue,CreatedBy,UpdatedBy) VALUES ('Y',55000,'N',1,'N','ST-@MovementDate<yyMM>@-','Y',551795,'MovementDate','0000','SJ Titipan','SJ Titipan',1,'a9eed026-82ff-4252-9106-e1395ee35108',0,'N',TO_DATE('2016-08-02 22:54:51','YYYY-MM-DD HH24:MI:SS'),'Y',1,'Y',1000001,TO_DATE('2016-08-02 22:54:51','YYYY-MM-DD HH24:MI:SS'),0,100,100)
;

-- Aug 2, 2016 10:55:12 PM WIT
--  
UPDATE C_DocType SET DocNoSequence_ID=551795,Updated=TO_DATE('2016-08-02 22:55:12','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550286
;

-- Aug 2, 2016 10:56:09 PM WIT
--  
UPDATE AD_Sequence SET Prefix='OT-@DateOrdered<yyMM>@-',Updated=TO_DATE('2016-08-02 22:56:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Sequence_ID=551794
;

-- Aug 2, 2016 10:56:18 PM WIT
--  
UPDATE C_DocType SET C_DocTypeShipment_ID=550286,Updated=TO_DATE('2016-08-02 22:56:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550283
;

-- Aug 2, 2016 10:56:27 PM WIT
--  
UPDATE C_DocType SET C_DocTypeInvoice_ID=NULL,Updated=TO_DATE('2016-08-02 22:56:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550283
;
