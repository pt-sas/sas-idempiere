...
--  
UPDATE AD_Column SET FKConstraintName='SalesRep_SASBPRule', FKConstraintType='N',Updated=TO_DATE('2016-08-04 17:10:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552197
;

-- Aug 4, 2016 5:10:21 PM WIT
--  
ALTER TABLE SAS_BPRule ADD SalesRep_ID NUMBER(10) DEFAULT NULL 
;
...
--  
INSERT INTO AD_Column (SeqNoSelection,IsSyncDatabase,Version,AD_Column_ID,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,IsKey,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Description,Help,Name,IsAllowCopy,Updated,AD_Org_ID,IsActive,Created,IsAlwaysUpdateable,AD_Client_ID,EntityType,IsEncrypted,IsSecure,AD_Element_ID,AD_Reference_ID,AD_Table_ID,IsToolbarButton,CreatedBy,UpdatedBy) VALUES (0,'N',0,552198,'N','N','N',0,'N',10,'N','N','N','Y','5bcf8012-bb15-4051-9463-8daded3ad183','Y','C_PaymentTerm_ID','The terms of Payment (timing, discount)','Payment Terms identify the method and timing of payment.','Payment Term','Y',TO_DATE('2016-08-04 17:10:43','YYYY-MM-DD HH24:MI:SS'),0,'Y',TO_DATE('2016-08-04 17:10:43','YYYY-MM-DD HH24:MI:SS'),'N',0,'U','N','N',204,19,550066,'Y',100,100)
;
...
--  
UPDATE AD_Column SET FKConstraintName='CPaymentTerm_SASBPRule', FKConstraintType='N',Updated=TO_DATE('2016-08-04 17:10:46','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552198
;

-- Aug 4, 2016 5:10:46 PM WIT
--  
ALTER TABLE SAS_BPRule ADD C_PaymentTerm_ID NUMBER(10) DEFAULT NULL 
;
