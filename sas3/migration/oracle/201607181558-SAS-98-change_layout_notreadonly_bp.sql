...
--  
UPDATE AD_Field SET Help='A Business Partner is anyone with whom you transact.  This can include Vendor, Customer, Employee or Salesperson ',Updated=TO_DATE('2016-07-18 15:03:29','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=10416
;

-- Jul 18, 2016 3:03:40 PM WIT
--  
UPDATE AD_Field SET IsReadOnly='N',Updated=TO_DATE('2016-07-18 15:03:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=10416
;

-- Jul 18, 2016 3:04:05 PM WIT
--  
UPDATE AD_Field SET IsReadOnly='N',Updated=TO_DATE('2016-07-18 15:04:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=57959
;
