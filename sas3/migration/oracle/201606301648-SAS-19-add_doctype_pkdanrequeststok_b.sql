...
--  
UPDATE C_DocType SET Name='PK A', C_DocTypeOrder_ID=1000030,Updated=TO_DATE('2016-06-30 16:40:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=1000026
;
...
--  
UPDATE AD_Sequence SET Name='PK A',Updated=TO_DATE('2016-06-30 16:41:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Sequence_ID=550324
;

-- Jun 30, 2016 4:42:19 PM WIT
--  
UPDATE AD_Sequence SET StartNewYear='Y', CurrentNext=1, Prefix='PKA-@DateOrdered<yyMM>@-', DateColumn='DateOrdered', DecimalPattern='0000', StartNo=1, StartNewMonth='Y',Updated=TO_DATE('2016-06-30 16:42:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Sequence_ID=550324
;

-- Jun 30, 2016 4:42:28 PM WIT
--  
INSERT INTO AD_Sequence (StartNewYear,CurrentNextSys,IsTableID,CurrentNext,IsAudited,Prefix,IsAutoSequence,AD_Sequence_ID,DateColumn,DecimalPattern,Description,Name,IncrementNo,AD_Sequence_UU,AD_Org_ID,IsOrgLevelSequence,Updated,IsActive,StartNo,StartNewMonth,AD_Client_ID,Created,MaxValue,CreatedBy,UpdatedBy) VALUES ('Y',1000,'N',1,'N','PKB-@DateOrdered<yyMM>@-','Y',551776,'DateOrdered','0000','Binding offer','PK B',1,'d513b3eb-10a9-44df-bbe1-aab6c04de698',0,'N',TO_DATE('2016-06-30 16:42:27','YYYY-MM-DD HH24:MI:SS'),'Y',1,'Y',1000001,TO_DATE('2016-06-30 16:42:27','YYYY-MM-DD HH24:MI:SS'),0,100,100)
;

-- Jun 30, 2016 4:42:40 PM WIT
--  
UPDATE C_DocType SET DocNoSequence_ID=551776,Updated=TO_DATE('2016-06-30 16:42:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550269
;

-- Jun 30, 2016 4:43:26 PM WIT
--  
INSERT INTO C_DocType (GL_Category_ID,C_DocType_ID,IsDefault,DocBaseType,IsSOTrx,DocumentCopies,DocumentNote,IsCreateCounter,IsIndexed,IsShipConfirm,IsSplitWhenDifference,IsDefaultCounterDoc,IsInTransit,IsPickQAConfirm,IsOverwriteDateOnComplete,IsOverwriteSeqOnComplete,C_DocType_UU,IsPrepareSplitDocument,PrintName,Name,IsDocNoControlled,HasCharges,HasProforma,DocSubTypeSO,Updated,IsActive,IsChargeOrProductMandatory,DocNoSequence_ID,Created,EntityType,IsAROther,IsInternal,CreateTaxInvoice,CreatedBy,UpdatedBy,AD_Org_ID,AD_Client_ID) VALUES (1000001,550270,'N','SOO','Y',0,'Quotation Using Stock different Branch','Y','Y','N','N','N','N','N','N','N','d62c3be5-0200-4574-b898-ae8691231573','Y','Proposal','Request Stock A','Y','N','N','ON',TO_DATE('2016-06-30 16:43:25','YYYY-MM-DD HH24:MI:SS'),'Y','Y',550325,TO_DATE('2016-06-30 16:43:25','YYYY-MM-DD HH24:MI:SS'),'U','N','N','N',100,100,0,1000001)
;
...
--  
UPDATE C_DocType SET C_DocTypeOrder_ID=1000030,Updated=TO_DATE('2016-06-30 16:43:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550270
;

-- Jun 30, 2016 4:44:28 PM WIT
--  
UPDATE AD_Sequence SET StartNewYear='Y', CurrentNext=1, Prefix='RSA-@DateOrdered<yyMM>-', DateColumn='DateOrdered', DecimalPattern='0000', Name='Request Stock A', StartNo=1, StartNewMonth='Y',Updated=TO_DATE('2016-06-30 16:44:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Sequence_ID=550325
;

-- Jun 30, 2016 4:44:38 PM WIT
--  
INSERT INTO AD_Sequence (StartNewYear,CurrentNextSys,IsTableID,CurrentNext,IsAudited,Prefix,IsAutoSequence,AD_Sequence_ID,DateColumn,DecimalPattern,Description,Name,IncrementNo,AD_Sequence_UU,AD_Org_ID,IsOrgLevelSequence,Updated,IsActive,StartNo,StartNewMonth,AD_Client_ID,Created,MaxValue,CreatedBy,UpdatedBy) VALUES ('Y',2000,'N',1,'N','RSB-@DateOrdered<yyMM>-','Y',551777,'DateOrdered','0000','Non binding offer','Request Stock B',1,'1634ad91-9196-4ae9-a800-ae82e4e1a55f',0,'N',TO_DATE('2016-06-30 16:44:38','YYYY-MM-DD HH24:MI:SS'),'Y',1,'Y',1000001,TO_DATE('2016-06-30 16:44:38','YYYY-MM-DD HH24:MI:SS'),0,100,100)
;

-- Jun 30, 2016 4:46:08 PM WIT
--  
UPDATE C_DocType SET Name='Request Stock B', DocNoSequence_ID=551777, C_DocTypeOrder_ID=550265,Updated=TO_DATE('2016-06-30 16:46:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550270
;
...
--  
UPDATE C_DocType SET Name='Request Stock A', C_DocTypeOrder_ID=1000030,Updated=TO_DATE('2016-06-30 16:46:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=1000027
;
