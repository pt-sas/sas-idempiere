...
--  
INSERT INTO AD_Ref_Table (IsValueDisplayed,AD_Ref_Table_UU,Updated,Created,AD_Org_ID,IsActive,AD_Client_ID,EntityType,AD_Display,AD_Key,AD_Reference_ID,AD_Table_ID,CreatedBy,UpdatedBy) VALUES ('N','3d3f5d9b-52ff-470a-8b49-f64f88e81086',TO_DATE('2016-08-02 12:09:54','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2016-08-02 12:09:54','YYYY-MM-DD HH24:MI:SS'),0,'Y',0,'U',552191,212,550094,114,100,100)
;

-- Aug 2, 2016 12:10:17 PM WIT
--  
UPDATE AD_Column SET AD_Reference_Value_ID=550094, AD_Val_Rule_ID=164,Updated=TO_DATE('2016-08-02 12:10:17','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552057
;

-- Aug 2, 2016 12:10:39 PM WIT
--  
UPDATE AD_Column SET AD_Reference_Value_ID=550094, AD_Val_Rule_ID=164,Updated=TO_DATE('2016-08-02 12:10:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552058
;

-- Aug 2, 2016 12:10:54 PM WIT
--  
UPDATE AD_Column SET AD_Reference_Value_ID=550094, AD_Val_Rule_ID=164,Updated=TO_DATE('2016-08-02 12:10:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552052
;
