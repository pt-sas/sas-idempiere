...
--  
UPDATE C_DocType SET Name='OCT (SO Return Tax)',Updated=TO_DATE('2016-11-10 15:17:44','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550266
;
...
--  
UPDATE C_DocType SET Name='OCT (SO Return Non Tax)',Updated=TO_DATE('2016-11-10 15:17:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550291
;
...
--  
UPDATE C_DocType SET Name='PKN (Pengajuan Khusus Non Tax)',Updated=TO_DATE('2016-11-10 15:18:15','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550269
;
...
--  
UPDATE C_DocType SET Name='PKT (Pengajuan Khusus Tax)',Updated=TO_DATE('2016-11-10 15:18:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=1000026
;
...
--  
UPDATE C_DocType SET Name='RSN (Request Stock Non Tax)',Updated=TO_DATE('2016-11-10 15:18:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550270
;
...
--  
UPDATE C_DocType SET Name='RST (Request Stock Tax)',Updated=TO_DATE('2016-11-10 15:18:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=1000027
;
...
--  
UPDATE C_DocType SET Name='RMT (Customer RMA Tax)',Updated=TO_DATE('2016-11-10 15:19:45','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=1000029
;
...
--  
UPDATE C_DocType SET Name='RMN (Customer RMA Non Tax)',Updated=TO_DATE('2016-11-10 15:19:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550287
;
...
--  
UPDATE C_DocType SET Name='Surat Jalan Return Tax',Updated=TO_DATE('2016-11-10 15:21:07','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550268
;
...
--  
UPDATE AD_Sequence SET Prefix='@AD_Org_ID<Value>@@AD_OrgTrx_ID<Description>@-SCT-@MovementDate<yyMM>@-', Name='MM Shipment Return Tax',Updated=TO_DATE('2016-11-10 15:21:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Sequence_ID=551774
;

-- Nov 10, 2016 3:21:55 PM WIT
--  
INSERT INTO AD_Sequence (OrgColumn,StartNewYear,CurrentNextSys,IsTableID,CurrentNext,IsAudited,Prefix,IsAutoSequence,AD_Sequence_ID,DateColumn,DecimalPattern,Description,Name,IncrementNo,AD_Sequence_UU,AD_Org_ID,IsOrgLevelSequence,Updated,IsActive,StartNo,StartNewMonth,AD_Client_ID,Created,MaxValue,CreatedBy,UpdatedBy) VALUES ('AD_Org_ID','Y',50000,'N',1,'N','@AD_Org_ID<Value>@@AD_OrgTrx_ID<Description>@-SCN-@MovementDate<yyMM>@-','Y',551817,'MovementDate','000000','MM Shipment','MM Shipment Return Non Tax',1,'570f40ff-32b1-4f59-84d2-89ffffe894cd',0,'Y',TO_DATE('2016-11-10 15:21:54','YYYY-MM-DD HH24:MI:SS'),'Y',1,'Y',1000001,TO_DATE('2016-11-10 15:21:54','YYYY-MM-DD HH24:MI:SS'),0,100,100)
;

-- Nov 10, 2016 3:22:18 PM WIT
--  
UPDATE C_DocType SET DocNoSequence_ID=551817,Updated=TO_DATE('2016-11-10 15:22:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550292
;

-- Nov 10, 2016 3:23:13 PM WIT
--  
UPDATE C_DocType SET C_DocTypeShipment_ID=550292,Updated=TO_DATE('2016-11-10 15:23:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550291
;

-- Nov 10, 2016 3:23:26 PM WIT
--  
UPDATE C_DocType SET C_DocTypeInvoice_ID=550289,Updated=TO_DATE('2016-11-10 15:23:26','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550291
;

-- Nov 10, 2016 3:48:08 PM WIT
--  
UPDATE C_DocType SET C_DocTypeInvoice_ID=1000002,Updated=TO_DATE('2016-11-10 15:48:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550266
;

-- Nov 10, 2016 3:49:31 PM WIT
--  
INSERT INTO AD_Sequence (OrgColumn,StartNewYear,CurrentNextSys,IsTableID,CurrentNext,IsAudited,Prefix,IsAutoSequence,AD_Sequence_ID,DateColumn,DecimalPattern,Description,Name,IncrementNo,AD_Sequence_UU,AD_Org_ID,IsOrgLevelSequence,Updated,IsActive,StartNo,StartNewMonth,AD_Client_ID,Created,MaxValue,CreatedBy,UpdatedBy) VALUES ('AD_Org_ID','Y',10000,'N',1,'N','@AD_Org_ID<Value>@@AD_OrgTrx_ID<Description>@-FCT-@DateInvoiced<yyMM>@-','Y',551818,'DateInvoiced','000000','AR Invoice','Faktur Return Tax',1,'cfe20760-a73b-4f34-aaec-00983c315dcc',0,'Y',TO_DATE('2016-11-10 15:49:31','YYYY-MM-DD HH24:MI:SS'),'Y',1,'Y',1000001,TO_DATE('2016-11-10 15:49:31','YYYY-MM-DD HH24:MI:SS'),0,100,100)
;

-- Nov 10, 2016 3:49:42 PM WIT
--  
INSERT INTO AD_Sequence (OrgColumn,StartNewYear,CurrentNextSys,IsTableID,CurrentNext,IsAudited,Prefix,IsAutoSequence,AD_Sequence_ID,DateColumn,DecimalPattern,Description,Name,IncrementNo,AD_Sequence_UU,AD_Org_ID,IsOrgLevelSequence,Updated,IsActive,StartNo,StartNewMonth,AD_Client_ID,Created,MaxValue,CreatedBy,UpdatedBy) VALUES ('AD_Org_ID','Y',10000,'N',1,'N','@AD_Org_ID<Value>@@AD_OrgTrx_ID<Description>@-FCN-@DateInvoiced<yyMM>@-','Y',551819,'DateInvoiced','000000','AR Invoice','Faktur Return Non Tax',1,'9b545d29-94cf-4038-86b9-a99200df7d6e',0,'Y',TO_DATE('2016-11-10 15:49:42','YYYY-MM-DD HH24:MI:SS'),'Y',1,'Y',1000001,TO_DATE('2016-11-10 15:49:42','YYYY-MM-DD HH24:MI:SS'),0,100,100)
;

-- Nov 10, 2016 3:50:12 PM WIT
--  
INSERT INTO C_DocType (GL_Category_ID,C_DocType_ID,IsDefault,DocBaseType,IsSOTrx,DocumentCopies,IsCreateCounter,IsIndexed,IsShipConfirm,IsSplitWhenDifference,IsDefaultCounterDoc,IsInTransit,IsPickQAConfirm,IsOverwriteDateOnComplete,IsOverwriteSeqOnComplete,C_DocType_UU,IsPrepareSplitDocument,PrintName,Name,IsDocNoControlled,HasCharges,HasProforma,Updated,IsActive,IsChargeOrProductMandatory,DocNoSequence_ID,AD_PrintFormat_ID,Created,EntityType,IsAROther,C_DocTypeTaxInvoice_ID,IsInternal,CreateTaxInvoice,CreatedBy,UpdatedBy,AD_Org_ID,AD_Client_ID,C_DocTypeKwitansi_ID) VALUES (1000003,550293,'N','ARI','Y',0,'N','Y','N','N','N','N','N','N','N','987687c2-3dbc-4339-82c2-100224cbd68e','Y','Invoice Return','Faktur Return Tax','Y','N','N',TO_DATE('2016-11-10 15:50:12','YYYY-MM-DD HH24:MI:SS'),'Y','N',551818,1000040,TO_DATE('2016-11-10 15:50:12','YYYY-MM-DD HH24:MI:SS'),'U','N',550000,'N','N',100,100,0,1000001,550263)
;
...
--  
UPDATE C_DocType SET C_DocTypeInvoice_ID=550293,Updated=TO_DATE('2016-11-10 15:51:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550266
;

-- Nov 10, 2016 4:15:44 PM WIT
--  
UPDATE C_DocType SET Name='OCN (SO Return Non Tax)',Updated=TO_DATE('2016-11-10 16:15:44','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550291
;
...
--  
UPDATE C_DocType SET C_DocTypeInvoice_ID=550294,Updated=TO_DATE('2016-11-10 16:17:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550291
;
