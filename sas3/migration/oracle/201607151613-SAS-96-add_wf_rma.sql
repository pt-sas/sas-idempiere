...
--  
INSERT INTO AD_WF_Node (AD_WF_Node_ID,Cost,YPosition,OverlapUnits,UnitsCycles,Yield,WaitTime,Priority,Duration,IsCentrallyMaintained,JoinElement,Limit,WorkingTime,XPosition,WaitingTime,IsMilestone,IsSubcontracting,SplitElement,Action,Value,Name,AD_WF_Node_UU,DynPriorityChange,AD_Workflow_ID,IsActive,DocAction,AD_Client_ID,EntityType,AD_Org_ID,Created,Updated,CreatedBy,UpdatedBy) VALUES (550139,0,0,0,0,100,0,0,0,'Y','X',0,0,0,0,'N','N','X','Z','ApprovalRMA','Approval Cust RMA','e7fe1934-fbd4-4b27-9e85-b9f926bc2f93',0,123,'Y','CO',1000001,'U',0,TO_DATE('2016-07-15 16:07:36','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2016-07-15 16:07:36','YYYY-MM-DD HH24:MI:SS'),100,100)
;
...
--  
UPDATE AD_WF_Node SET AD_Column_ID=10838, Action='V', AttributeValue='Y',Updated=TO_DATE('2016-07-15 16:07:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_Node_ID=550138
;

-- Jul 15, 2016 4:08:10 PM WIT
--  
UPDATE AD_WF_Node SET AD_Column_ID=12122, Action='C',Updated=TO_DATE('2016-07-15 16:08:10','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_Node_ID=550139
;

-- Jul 15, 2016 4:08:59 PM WIT
--  
UPDATE AD_WF_Node SET UpdatedBy=100,Updated=TO_DATE('2016-07-15 16:08:59','YYYY-MM-DD HH24:MI:SS') WHERE AD_WF_Node_ID=550139
;
...
--  
INSERT INTO AD_WF_NodeNext (SeqNo,IsStdUserWorkflow,AD_WF_NodeNext_ID,AD_WF_Next_ID,AD_WF_Node_ID,EntityType,AD_WF_NodeNext_UU,AD_Org_ID,Updated,IsActive,AD_Client_ID,Created,CreatedBy,UpdatedBy) VALUES (10,'N',550217,550138,213,'U','643ef5ac-a081-43db-afa2-bd85eb50d1b9',0,TO_DATE('2016-07-15 16:10:07','YYYY-MM-DD HH24:MI:SS'),'Y',1000001,TO_DATE('2016-07-15 16:10:07','YYYY-MM-DD HH24:MI:SS'),100,100)
;

-- Jul 15, 2016 4:10:23 PM WIT
--  
INSERT INTO AD_WF_NextCondition (AndOr,Operation,AD_WF_NextCondition_ID,SeqNo,AD_WF_NextCondition_UU,EntityType,Value,IsActive,Updated,AD_Column_ID,Created,AD_WF_NodeNext_ID,AD_Org_ID,CreatedBy,UpdatedBy,AD_Client_ID) VALUES ('O','==',550174,10,'249d7651-d9f0-4794-a434-e1736ec2d5d8','U','Y','Y',TO_DATE('2016-07-15 16:10:22','YYYY-MM-DD HH24:MI:SS'),52000,TO_DATE('2016-07-15 16:10:22','YYYY-MM-DD HH24:MI:SS'),550217,0,100,100,1000001)
;

-- Jul 15, 2016 4:10:35 PM WIT
--  
INSERT INTO AD_WF_NextCondition (AndOr,Operation,AD_WF_NextCondition_ID,SeqNo,AD_WF_NextCondition_UU,EntityType,Value,IsActive,Updated,AD_Column_ID,Created,AD_WF_NodeNext_ID,AD_Org_ID,CreatedBy,UpdatedBy,AD_Client_ID) VALUES ('O','>>',550175,20,'2ced76c1-6d51-42ab-85af-bf334585e222','U','0','Y',TO_DATE('2016-07-15 16:10:35','YYYY-MM-DD HH24:MI:SS'),550082,TO_DATE('2016-07-15 16:10:35','YYYY-MM-DD HH24:MI:SS'),550217,0,100,100,1000001)
;

-- Jul 15, 2016 4:10:42 PM WIT
--  
UPDATE AD_WF_NextCondition SET IsActive='N',Updated=TO_DATE('2016-07-15 16:10:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_NextCondition_ID=550174
;
