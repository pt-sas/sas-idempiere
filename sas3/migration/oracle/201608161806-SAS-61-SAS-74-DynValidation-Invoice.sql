...
AND NOT EXISTS(SELECT 1 FROM R_Request r WHERE r.C_Invoice_ID = C_Invoice.C_Invoice_ID AND r.R_Status_ID NOT IN (1000004,1000006) AND r.R_RequestType_ID = @R_RequestType_ID@)',Updated=TO_DATE('2016-08-15 19:32:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=550212
;
...
AND NOT EXISTS(SELECT 1 FROM R_Request r WHERE r.C_Invoice_ID = C_Invoice.C_Invoice_ID AND r.R_RequestType_ID = @R_RequestType_ID@)	',Updated=TO_DATE('2016-08-15 19:34:46','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=550213
;
