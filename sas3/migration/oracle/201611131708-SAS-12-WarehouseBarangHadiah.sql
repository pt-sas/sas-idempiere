...
--  
INSERT INTO M_Locator (M_Locator_ID,X,Y,M_Warehouse_ID,Z,IsDefault,Value,PriorityNo,M_Locator_UU,IsActive,AD_Org_ID,AD_Client_ID,Created,Updated,UpdatedBy,CreatedBy,M_LocatorType_ID) VALUES (1000025,'0','0',1000019,'0','Y','Barang Hadiah',50,'691496ca-b8b2-4dcc-b9a7-560f66c8ae7e','Y',1000001,1000001,TO_DATE('2016-11-13 17:06:17','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2016-11-13 17:06:17','YYYY-MM-DD HH24:MI:SS'),100,100,1000001)
;

-- Nov 13, 2016 5:06:54 PM WIT
--  
UPDATE M_Warehouse SET M_ReserveLocator_ID=1000025,Updated=TO_DATE('2016-11-13 17:06:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE M_Warehouse_ID=1000019
;
