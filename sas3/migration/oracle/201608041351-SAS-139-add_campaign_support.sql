...
--  
INSERT INTO C_Campaign (C_Channel_ID,Costs,C_Campaign_ID,IsSummary,C_Campaign_UU,Value,Updated,IsActive,Created,Description,Name,CreatedBy,UpdatedBy,AD_Client_ID,AD_Org_ID) VALUES (1000000,0,1000001,'N','444a16ea-6dfa-4e92-9d26-ad7133b31d4d','Support',TO_DATE('2016-08-04 13:48:09','YYYY-MM-DD HH24:MI:SS'),'Y',TO_DATE('2016-08-04 13:48:09','YYYY-MM-DD HH24:MI:SS'),NULL,'Support',100,100,1000001,0)
;
