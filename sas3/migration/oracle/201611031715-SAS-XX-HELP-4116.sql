...
--  
UPDATE C_DocType SET Name='OPN (Order Penjualan Non Tax)',Updated=TO_DATE('2016-11-03 17:02:45','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550265
;
...
--  
UPDATE C_DocType SET Name='OPT (Order Penjualan Tax)',Updated=TO_DATE('2016-11-03 17:03:07','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=1000030
;
