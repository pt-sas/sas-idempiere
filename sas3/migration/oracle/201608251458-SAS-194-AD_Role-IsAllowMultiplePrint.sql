...
--  
ALTER TABLE AD_Role ADD IsAllowMultiplePrint CHAR(1) DEFAULT 'N' CHECK (IsAllowMultiplePrint IN ('Y','N'))
;

-- Aug 25, 2016 2:46:02 PM WIT
--  
UPDATE AD_Column SET IsAllowCopy='Y',Updated=TO_DATE('2016-08-25 14:46:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552249
;

-- Aug 25, 2016 2:48:36 PM WIT
--  
INSERT INTO AD_Field (SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,AD_Org_ID,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry,AD_Client_ID,ColumnSpan,NumLines,IsAdvancedField,IsDefaultFocus,AD_Column_ID,Created,EntityType,UpdatedBy,CreatedBy) VALUES (0,'N',119,0,'N','N',295,'Y',553407,'N','Allow Multiple Print','0f10626e-8dbe-40d7-9abf-78a401548f52','Y','N',0,TO_DATE('2016-08-25 14:48:36','YYYY-MM-DD HH24:MI:SS'),'Y','Y',440,2,'N',0,2,1,'N','N',552249,TO_DATE('2016-08-25 14:48:36','YYYY-MM-DD HH24:MI:SS'),'U',100,100)
;
...
--  
UPDATE AD_Field SET DisplayLogic='@IsMasterRole@=N',Updated=TO_DATE('2016-08-25 14:48:46','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553407
;
