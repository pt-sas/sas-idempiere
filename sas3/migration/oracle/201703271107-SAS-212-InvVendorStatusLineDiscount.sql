...
--  
INSERT INTO AD_StatusLineUsedIn (AD_StatusLineUsedIn_ID,AD_Client_ID,AD_Org_ID,AD_StatusLineUsedIn_UU,AD_StatusLine_ID,Created,CreatedBy,IsActive,Updated,UpdatedBy,AD_Window_ID,AD_Tab_ID,IsStatusLine,SeqNo) VALUES (1000001,0,0,'f96949bc-67ec-4181-8e07-d80dd9f61537',550001,TO_DATE('2017-03-27 10:50:02','YYYY-MM-DD HH24:MI:SS'),100,'Y',TO_DATE('2017-03-27 10:50:02','YYYY-MM-DD HH24:MI:SS'),100,183,291,'Y',0)
;
...
INNER JOIN C_Currency c ON (o.C_Currency_ID=c.C_Currency_ID)
LEFT JOIN C_InvoiceLine l ON (o.C_Invoice_ID=l.C_Invoice_ID)
WHERE l.C_InvoiceLine_ID=@C_InvoiceLine_ID@',Updated=TO_DATE('2017-03-27 11:04:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_StatusLine_ID=550001
;
