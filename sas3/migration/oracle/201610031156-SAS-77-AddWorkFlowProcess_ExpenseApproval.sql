...
--  
INSERT INTO AD_WF_NodeNext (SeqNo,IsStdUserWorkflow,AD_WF_NodeNext_ID,AD_WF_Next_ID,AD_WF_Node_ID,EntityType,AD_WF_NodeNext_UU,AD_Org_ID,Updated,IsActive,AD_Client_ID,Created,CreatedBy,UpdatedBy) VALUES (10,'N',550232,550148,550131,'U','c021bd11-8e96-4499-944c-c5f2bd36ae7e',0,TO_DATE('2016-10-03 11:14:38','YYYY-MM-DD HH24:MI:SS'),'Y',1000001,TO_DATE('2016-10-03 11:14:38','YYYY-MM-DD HH24:MI:SS'),100,100)
;

-- Oct 3, 2016 11:16:36 AM WIT
--  
INSERT INTO AD_WF_NextCondition (AndOr,Operation,AD_WF_NextCondition_ID,SeqNo,AD_WF_NextCondition_UU,EntityType,Value,IsActive,Updated,AD_Column_ID,Created,AD_WF_NodeNext_ID,AD_Org_ID,CreatedBy,UpdatedBy,AD_Client_ID) VALUES ('O','==',550183,10,'d6058a40-46d1-4215-a5f1-5210fd0b8cc2','U','550003','Y',TO_DATE('2016-10-03 11:16:36','YYYY-MM-DD HH24:MI:SS'),3493,TO_DATE('2016-10-03 11:16:36','YYYY-MM-DD HH24:MI:SS'),550232,0,100,100,1000001)
;

-- Oct 3, 2016 11:16:50 AM WIT
--  
UPDATE AD_WF_NodeNext SET SeqNo=20,Updated=TO_DATE('2016-10-03 11:16:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_NodeNext_ID=550204
;

-- Oct 3, 2016 11:17:31 AM WIT
--  
INSERT INTO AD_WF_NodeNext (SeqNo,IsStdUserWorkflow,AD_WF_NodeNext_ID,AD_WF_Next_ID,AD_WF_Node_ID,EntityType,AD_WF_NodeNext_UU,AD_Org_ID,Updated,IsActive,AD_Client_ID,Created,CreatedBy,UpdatedBy) VALUES (10,'N',550233,194,550148,'U','e20193ba-566b-4916-80c6-e3670fbad020',0,TO_DATE('2016-10-03 11:17:30','YYYY-MM-DD HH24:MI:SS'),'Y',1000001,TO_DATE('2016-10-03 11:17:30','YYYY-MM-DD HH24:MI:SS'),100,100)
;
