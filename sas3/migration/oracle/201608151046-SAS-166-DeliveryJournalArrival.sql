...
--  
INSERT INTO AD_Process_Access (AD_Process_ID,AD_Process_Access_UU,Updated,Created,IsActive,AD_Client_ID,AD_Org_ID,AD_Role_ID,UpdatedBy,CreatedBy) VALUES (550276,'cff46b51-7a51-4262-a9c0-dbb427f26358',TO_DATE('2016-08-15 10:39:22','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2016-08-15 10:39:22','YYYY-MM-DD HH24:MI:SS'),'Y',11,0,103,100,100)
;

-- Aug 15, 2016 10:39:22 AM WIT
--  
INSERT INTO AD_Process_Access (AD_Process_ID,AD_Process_Access_UU,Updated,Created,IsActive,AD_Client_ID,AD_Org_ID,AD_Role_ID,UpdatedBy,CreatedBy) VALUES (550276,'683c7b5e-24b3-47b6-b38a-c8d0e9183aad',TO_DATE('2016-08-15 10:39:22','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2016-08-15 10:39:22','YYYY-MM-DD HH24:MI:SS'),'Y',0,0,0,100,100)
;

-- Aug 15, 2016 10:39:22 AM WIT
--  
INSERT INTO AD_Process_Access (AD_Process_ID,AD_Process_Access_UU,Updated,Created,IsActive,AD_Client_ID,AD_Org_ID,AD_Role_ID,UpdatedBy,CreatedBy) VALUES (550276,'574d6f7b-b4ac-4b76-96a6-1877a2ca1986',TO_DATE('2016-08-15 10:39:22','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2016-08-15 10:39:22','YYYY-MM-DD HH24:MI:SS'),'Y',11,0,102,100,100)
;

-- Aug 15, 2016 10:39:22 AM WIT
--  
INSERT INTO AD_Process_Access (AD_Process_ID,AD_Process_Access_UU,Updated,Created,IsActive,AD_Client_ID,AD_Org_ID,AD_Role_ID,UpdatedBy,CreatedBy) VALUES (550276,'89f53836-7454-4f38-ab21-654c00d65f1c',TO_DATE('2016-08-15 10:39:22','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2016-08-15 10:39:22','YYYY-MM-DD HH24:MI:SS'),'Y',1000001,0,1000002,100,100)
;

-- Aug 15, 2016 10:39:22 AM WIT
--  
INSERT INTO AD_Process_Access (AD_Process_ID,AD_Process_Access_UU,Updated,Created,IsActive,AD_Client_ID,AD_Org_ID,AD_Role_ID,UpdatedBy,CreatedBy) VALUES (550276,'95a1e530-44d1-4cd3-9032-5ce69ee3925b',TO_DATE('2016-08-15 10:39:22','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2016-08-15 10:39:22','YYYY-MM-DD HH24:MI:SS'),'Y',1000001,0,1000003,100,100)
;

-- Aug 15, 2016 10:40:27 AM WIT
--  
INSERT INTO AD_Process_Para (IsRange,AD_Element_ID,AD_Process_Para_ID,AD_Process_Para_UU,Help,AD_Reference_ID,AD_Val_Rule_ID,IsMandatory,EntityType,Name,ColumnName,Description,FieldLength,IsCentrallyMaintained,SeqNo,IsActive,Updated,IsEncrypted,AD_Process_ID,AD_Reference_Value_ID,Created,UpdatedBy,CreatedBy,AD_Org_ID,AD_Client_ID) VALUES ('N',2158,550746,'ed64931a-38e8-4990-8f9f-a8f8df2b34b2','The remote organization used for data replication. If not selected, all organizations are replicated/synchronized.',18,550111,'Y','U','Remote Organization','Remote_Org_ID','Remote Organization to be used to replicate / synchronize data with.',0,'Y',10,'Y',TO_DATE('2016-08-15 10:40:27','YYYY-MM-DD HH24:MI:SS'),'N',550276,130,TO_DATE('2016-08-15 10:40:27','YYYY-MM-DD HH24:MI:SS'),100,100,0,0)
;
...
--  
INSERT INTO AD_Val_Rule (Code,AD_Val_Rule_ID,EntityType,Name,Type,AD_Val_Rule_UU,Updated,AD_Org_ID,IsActive,AD_Client_ID,Created,UpdatedBy,CreatedBy) VALUES ('R_StatusCategory_ID=1000000',550220,'U','Z SAS R_Status of Delivery Journal Arrival','S','dd50c447-f4b8-4280-977d-ccccca87bfde',TO_DATE('2016-08-15 10:43:13','YYYY-MM-DD HH24:MI:SS'),0,'Y',0,TO_DATE('2016-08-15 10:43:13','YYYY-MM-DD HH24:MI:SS'),100,100)
;

-- Aug 15, 2016 10:43:57 AM WIT
--  
INSERT INTO AD_Process_Para (IsRange,AD_Element_ID,AD_Process_Para_ID,AD_Process_Para_UU,Help,AD_Reference_ID,AD_Val_Rule_ID,IsMandatory,EntityType,Name,ColumnName,Description,FieldLength,IsCentrallyMaintained,SeqNo,DefaultValue,IsActive,Updated,IsEncrypted,AD_Process_ID,AD_Reference_Value_ID,Created,UpdatedBy,CreatedBy,AD_Org_ID,AD_Client_ID) VALUES ('N',2706,550748,'c2c814cc-65e3-4f6c-baca-d134fe7c5edb','Status if the request (open, closed, investigating, ..)',19,550220,'Y','U','Status','R_Status_ID','Request Status',0,'Y',30,'1000001','Y',TO_DATE('2016-08-15 10:43:57','YYYY-MM-DD HH24:MI:SS'),'N',550276,345,TO_DATE('2016-08-15 10:43:57','YYYY-MM-DD HH24:MI:SS'),100,100,0,0)
;
...
-- Aug 15, 2016 10:44:47 AM WIT
--  
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', SysDate, 100, SysDate, 100,t.AD_Tree_ID, 550144, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=550144)
;
