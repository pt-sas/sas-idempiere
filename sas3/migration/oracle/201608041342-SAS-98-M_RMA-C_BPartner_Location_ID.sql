...
--  
UPDATE AD_Column SET FKConstraintName='CBPartnerLocation_MRMA', FKConstraintType='N',Updated=TO_DATE('2016-08-04 13:39:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552195
;

-- Aug 4, 2016 1:39:01 PM WIT
--  
ALTER TABLE M_RMA ADD C_BPartner_Location_ID NUMBER(10) DEFAULT NULL 
;
...
--  
UPDATE AD_Field SET XPosition=1,Updated=TO_DATE('2016-08-04 13:41:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=10416
;
