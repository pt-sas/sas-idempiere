...
--  
UPDATE M_Product_Category SET Description=' ',Updated=TO_DATE('2016-07-11 15:03:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE M_Product_Category_ID=1000008
;
...
--  
INSERT INTO M_Product_Category (M_Product_Category_ID,IsDefault,PlannedMargin,MMPolicy,IsSelfService,Value,IsActive,M_Product_Category_UU,AD_PrintColor_ID,Created,Updated,Name,UpdatedBy,CreatedBy,AD_Client_ID,AD_Org_ID) VALUES (1000013,'N',0,'F','Y','1000001','Y','0810a74d-d51b-4710-bbb7-d78a4d03d0b3',100,TO_DATE('2016-07-11 15:04:52','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2016-07-11 15:04:52','YYYY-MM-DD HH24:MI:SS'),'Panasonic',100,100,1000001,0)
;
...
--  
INSERT INTO M_Product_Category (M_Product_Category_ID,IsDefault,PlannedMargin,MMPolicy,IsSelfService,Value,IsActive,M_Product_Category_UU,AD_PrintColor_ID,Created,Updated,Name,UpdatedBy,CreatedBy,AD_Client_ID,AD_Org_ID) VALUES (1000014,'N',0,'F','Y','1000002','Y','21188fed-a9a4-4dd4-b408-c6cdcbcb3dcc',100,TO_DATE('2016-07-11 15:04:56','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2016-07-11 15:04:56','YYYY-MM-DD HH24:MI:SS'),'Legrand',100,100,1000001,0)
;
...
--  
INSERT INTO M_Product_Category (M_Product_Category_ID,IsDefault,PlannedMargin,MMPolicy,IsSelfService,Value,IsActive,M_Product_Category_UU,AD_PrintColor_ID,Created,Updated,Name,UpdatedBy,CreatedBy,AD_Client_ID,AD_Org_ID) VALUES (1000015,'N',0,'F','Y','1000003','Y','8ba9edce-96f8-43d4-b15c-559ba1a691f3',100,TO_DATE('2016-07-11 15:05:11','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2016-07-11 15:05:11','YYYY-MM-DD HH24:MI:SS'),'Special Lighting',100,100,1000001,0)
;
...
--  
INSERT INTO M_Product_Category (M_Product_Category_ID,IsDefault,PlannedMargin,MMPolicy,IsSelfService,Value,IsActive,M_Product_Category_UU,AD_PrintColor_ID,Created,Updated,Name,UpdatedBy,CreatedBy,AD_Client_ID,AD_Org_ID) VALUES (1000016,'N',0,'F','Y','1000004','Y','ff0977f4-b938-4f44-b6ed-2c1b15277a09',100,TO_DATE('2016-07-11 15:05:20','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2016-07-11 15:05:20','YYYY-MM-DD HH24:MI:SS'),'Stanley & Becker',100,100,1000001,0)
;
...
--  
UPDATE M_Product_Category SET Value='A',Updated=TO_DATE('2016-07-11 15:08:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE M_Product_Category_ID=1000012
;

-- Jul 11, 2016 3:08:13 PM WIT
--  
UPDATE M_Product_Category SET Value='B',Updated=TO_DATE('2016-07-11 15:08:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE M_Product_Category_ID=1000013
;

-- Jul 11, 2016 3:08:33 PM WIT
--  
UPDATE M_Product_Category SET Value='C',Updated=TO_DATE('2016-07-11 15:08:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE M_Product_Category_ID=1000014
;

-- Jul 11, 2016 3:08:43 PM WIT
--  
UPDATE M_Product_Category SET Value='D',Updated=TO_DATE('2016-07-11 15:08:43','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE M_Product_Category_ID=1000015
;

-- Jul 11, 2016 3:08:47 PM WIT
--  
UPDATE M_Product_Category SET Value='E',Updated=TO_DATE('2016-07-11 15:08:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE M_Product_Category_ID=1000016
;

-- Jul 11, 2016 3:09:08 PM WIT
--  
UPDATE M_Product_Category SET Name='Stanley Black & Decker',Updated=TO_DATE('2016-07-11 15:09:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE M_Product_Category_ID=1000016
;
