...
--  
INSERT INTO M_Locator (M_Locator_ID,X,Y,M_Warehouse_ID,Z,IsDefault,Value,PriorityNo,M_Locator_UU,IsActive,AD_Org_ID,AD_Client_ID,Created,Updated,UpdatedBy,CreatedBy,M_LocatorType_ID) VALUES (1000026,'0','0',1000020,'0','Y','OM TR 1',50,'01645656-085e-47c3-994f-6ce9e24a09c2','Y',1000001,1000001,TO_DATE('2016-11-13 17:12:58','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2016-11-13 17:12:58','YYYY-MM-DD HH24:MI:SS'),100,100,1000001)
;

-- Nov 13, 2016 5:13:17 PM WIT
--  
UPDATE M_Warehouse SET M_ReserveLocator_ID=1000026,Updated=TO_DATE('2016-11-13 17:13:17','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE M_Warehouse_ID=1000020
;
