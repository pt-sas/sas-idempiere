...
--  
UPDATE AD_Field SET SeqNo=95, IsReadOnly='Y',Updated=TO_DATE('2016-08-25 11:21:12','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553203
;

-- Aug 25, 2016 11:23:36 AM WIT
--  
UPDATE AD_Field SET ReadOnlyLogic='@M_InOut_ID@>0',Updated=TO_DATE('2016-08-25 11:23:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553204
;

-- Aug 25, 2016 11:23:50 AM WIT
--  
UPDATE AD_Field SET ReadOnlyLogic='@C_Invoice_ID@>0',Updated=TO_DATE('2016-08-25 11:23:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553205
;
