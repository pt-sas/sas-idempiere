...
--  
ALTER TABLE M_Promotion ADD IsNatura CHAR(1) DEFAULT 'N' CHECK (IsNatura IN ('Y','N')) NOT NULL
;

-- Nov 10, 2016 6:20:18 PM WIT
--  
INSERT INTO AD_Field (SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,AD_Org_ID,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry,AD_Client_ID,ColumnSpan,NumLines,IsAdvancedField,IsDefaultFocus,AD_Column_ID,Created,EntityType,UpdatedBy,CreatedBy) VALUES (0,'N',53203,0,'Y','N',90,'Y',553485,'N','Natura','284d2e70-3810-4c71-a7b9-10f79335a2f1','Y','N',0,TO_DATE('2016-11-10 18:20:17','YYYY-MM-DD HH24:MI:SS'),'Y','Y',90,5,'N',0,2,1,'N','N',552348,TO_DATE('2016-11-10 18:20:17','YYYY-MM-DD HH24:MI:SS'),'U',100,100)
;
