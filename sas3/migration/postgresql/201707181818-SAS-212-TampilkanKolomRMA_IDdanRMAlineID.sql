...
--  
INSERT INTO AD_Field (SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,Description,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,AD_Org_ID,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry,AD_Client_ID,ColumnSpan,NumLines,IsAdvancedField,IsDefaultFocus,AD_Column_ID,Created,EntityType,UpdatedBy,CreatedBy) VALUES (0,'N',291,0,'N','N',330,'Y',553691,'N','Detail information about the returned goods','Return Material Authorization Line','RMA Line','4abe8b67-d5fd-47e2-8d67-a6d17baf688b','Y','N',0,TO_TIMESTAMP('2017-07-18 18:02:45','YYYY-MM-DD HH24:MI:SS'),'Y','Y',320,1,'N',0,1,1,'N','N',52008,TO_TIMESTAMP('2017-07-18 18:02:45','YYYY-MM-DD HH24:MI:SS'),'U',100,100)
;
