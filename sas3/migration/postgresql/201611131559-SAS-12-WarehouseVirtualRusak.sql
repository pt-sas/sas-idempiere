...
--  
INSERT INTO M_Locator (M_Locator_ID,X,Y,M_Warehouse_ID,Z,IsDefault,Value,PriorityNo,M_Locator_UU,IsActive,AD_Org_ID,AD_Client_ID,Created,Updated,UpdatedBy,CreatedBy,M_LocatorType_ID) VALUES (1000024,'0','0',1000018,'0','Y','Virtual Rusak',50,'3801f6df-2234-4167-8196-3213fdc58e19','Y',1000001,1000001,TO_TIMESTAMP('2016-11-13 15:54:22','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2016-11-13 15:54:22','YYYY-MM-DD HH24:MI:SS'),100,100,1000001)
;

-- Nov 13, 2016 3:54:38 PM WIT
--  
UPDATE M_Warehouse SET M_ReserveLocator_ID=1000024,Updated=TO_TIMESTAMP('2016-11-13 15:54:38','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE M_Warehouse_ID=1000018
;
