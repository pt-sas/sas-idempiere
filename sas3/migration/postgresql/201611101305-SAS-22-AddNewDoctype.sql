...
--  
UPDATE C_DocType SET Name='CB-Cash Payment Tax',Updated=TO_TIMESTAMP('2016-11-10 13:02:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=1000009
;
...
--  
UPDATE C_DocType SET DocNoSequence_ID=551815,Updated=TO_TIMESTAMP('2016-11-10 13:02:20','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550290
;
