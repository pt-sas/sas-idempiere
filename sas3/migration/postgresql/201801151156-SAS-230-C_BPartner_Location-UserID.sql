...
--  
ALTER TABLE C_BPartner_Location ADD COLUMN UserID VARCHAR(60) DEFAULT NULL 
;

-- Jan 15, 2018 11:53:51 AM WIT
--  
UPDATE AD_Field SET XPosition=5,Updated=TO_TIMESTAMP('2018-01-15 11:53:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=2189
;

-- Jan 15, 2018 11:54:20 AM WIT
--  
INSERT INTO AD_Field (SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,Description,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,AD_Org_ID,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry,AD_Client_ID,ColumnSpan,NumLines,IsAdvancedField,IsDefaultFocus,AD_Column_ID,Created,EntityType,UpdatedBy,CreatedBy) VALUES (0,'N',222,0,'N','N',47,'Y',554055,'N','The User ID identifies a user and allows access to records or processes.','User ID or account number','User ID','444cfde3-8986-4a22-a5ea-46f10268d98b','Y','N',0,TO_TIMESTAMP('2018-01-15 11:54:19','YYYY-MM-DD HH24:MI:SS'),'Y','Y',47,1,'N',0,2,1,'N','N',552614,TO_TIMESTAMP('2018-01-15 11:54:19','YYYY-MM-DD HH24:MI:SS'),'U',100,100)
;
