...
-- Jun 28, 2016 11:56:45 AM WIT
--  
UPDATE AD_Field SET SeqNo=580,IsDisplayed='Y' WHERE AD_Field_ID=60972
;
...
-- Jun 28, 2016 11:56:45 AM WIT
--  
UPDATE AD_Field SET SeqNo=600,IsDisplayed='Y' WHERE AD_Field_ID=550116
;
...
-- Jun 28, 2016 11:57:20 AM WIT
--  
UPDATE AD_Field SET XPosition=4,Updated=TO_TIMESTAMP('2016-06-28 11:57:20','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553046
;

SELECT register_migration_script('201606281158-SAS-31-edit_position_sample.sql') FROM dual
;
