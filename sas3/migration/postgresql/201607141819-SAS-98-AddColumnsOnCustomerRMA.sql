...
--  
UPDATE AD_Column SET FKConstraintName='ADOrgTrx_MRMA', FKConstraintType='N',Updated=TO_TIMESTAMP('2016-07-14 18:04:46','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552091
;

-- Jul 14, 2016 6:04:46 PM WIT
--  
ALTER TABLE M_RMA ADD COLUMN AD_OrgTrx_ID NUMERIC(10) DEFAULT NULL 
;
...
--  
UPDATE AD_Field SET ColumnSpan=2,Updated=TO_TIMESTAMP('2016-07-14 18:05:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553076
;
...
--  
UPDATE AD_Field SET XPosition=4, ColumnSpan=2,Updated=TO_TIMESTAMP('2016-07-14 18:07:30','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553078
;
