...
--  
UPDATE C_Charge SET Description=' ',Updated=TO_TIMESTAMP('2016-08-04 13:52:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_Charge_ID=1000012
;
...
--  
UPDATE C_Charge_Acct SET Ch_Expense_Acct=1000060,Updated=TO_TIMESTAMP('2016-08-04 13:59:52','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_Charge_ID=1000014 AND C_AcctSchema_ID=1000001
;
