...
--  
INSERT INTO AD_Ref_Table (IsValueDisplayed,AD_Ref_Table_UU,Updated,Created,AD_Org_ID,IsActive,AD_Client_ID,EntityType,AD_Display,AD_Key,AD_Reference_ID,AD_Table_ID,CreatedBy,UpdatedBy) VALUES ('N','e4358bb2-823e-4efb-b081-4ec5c425e5c4',TO_TIMESTAMP('2016-07-01 14:23:53','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2016-07-01 14:23:53','YYYY-MM-DD HH24:MI:SS'),0,'Y',0,'U',3828,3828,550079,333,100,100)
;

-- Jul 1, 2016 2:24:39 PM WIT
--  
UPDATE AD_Column SET AD_Reference_ID=30, AD_Reference_Value_ID=550079, FKConstraintType=NULL,Updated=TO_TIMESTAMP('2016-07-01 14:24:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552036
;

-- Jul 1, 2016 2:24:54 PM WIT
--  
UPDATE AD_Ref_Table SET AD_Display=3838,Updated=TO_TIMESTAMP('2016-07-01 14:24:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Reference_ID=550079
;

-- Jul 1, 2016 2:25:37 PM WIT
--  
UPDATE AD_Column SET FKConstraintName='CInvoiceLine_MRMALine', FKConstraintType='N',Updated=TO_TIMESTAMP('2016-07-01 14:25:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552036
;

-- Jul 1, 2016 2:25:37 PM WIT
--  
ALTER TABLE M_RMALine ADD COLUMN C_InvoiceLine_ID NUMERIC(10) DEFAULT NULL 
;
