...
--  
ALTER TABLE M_DiscountSchemaBreak ADD COLUMN Group1 VARCHAR(255) DEFAULT NULL 
;

-- Jul 11, 2016 4:32:58 PM WIT
--  
INSERT INTO AD_Field (SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,AD_Org_ID,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry,AD_Client_ID,ColumnSpan,NumLines,IsAdvancedField,IsDefaultFocus,AD_Column_ID,Created,EntityType,UpdatedBy,CreatedBy) VALUES (0,'N',406,0,'Y','N',55,'Y',553067,'N','Group1','c44539f6-82b6-4f29-9a81-53cbeea85fa9','Y','N',0,TO_TIMESTAMP('2016-07-11 16:32:58','YYYY-MM-DD HH24:MI:SS'),'Y','Y',55,4,'N',0,2,1,'N','N',552038,TO_TIMESTAMP('2016-07-11 16:32:58','YYYY-MM-DD HH24:MI:SS'),'U',100,100)
;
...
--  
UPDATE AD_Field SET Name='Product Group',Updated=TO_TIMESTAMP('2016-07-11 16:33:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553067
;

-- Jul 11, 2016 4:33:25 PM WIT
--  
UPDATE AD_Column SET AD_Reference_ID=17, AD_Reference_Value_ID=550080, FKConstraintType=NULL,Updated=TO_TIMESTAMP('2016-07-11 16:33:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552038
;
