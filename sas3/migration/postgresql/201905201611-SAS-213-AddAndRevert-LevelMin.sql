...
LEFT JOIN M _Replenish r ON (r.M_Product_ID = p.M_Product_ID AND r.IsActive=''Y'')',Updated=TO_TIMESTAMP('2019-05-20 15:39:07','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoWindow_ID=200000
;
...
',240,'058591f1-175b-4a8d-bf6c-69a9d5a5ecb9',550210,'N','U','Minimum Inventory level for this product',TO_TIMESTAMP('2019-05-20 15:41:12','YYYY-MM-DD HH24:MI:SS'),'Minimum Level','Y','Level_Min','Y','Y','=','r.Level_Min',0,'N',435,200000,29,TO_TIMESTAMP('2019-05-20 15:41:12','YYYY-MM-DD HH24:MI:SS'),'N',100,0,100,0,'N')
;
...
LEFT JOIN M_PriceList_Version plv ON (plv.M_PriceList_Version_ID = pr.M_PriceList_Version_ID)
LEFT JOIN M_PriceList pl ON (pl.M_PriceList_ID = plv.M_PriceList_ID)
LEFT JOIN M_Replenish r ON (r.M_Product_ID = p.M_Product_ID AND r.IsActive=''Y'')',Updated=TO_TIMESTAMP('2019-05-20 15:48:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoWindow_ID=200000
;

-- May 20, 2019 3:56:07 PM GMT+07:00
--  
UPDATE AD_InfoColumn SET IsActive='N',Updated=TO_TIMESTAMP('2019-05-20 15:56:07','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoColumn_ID=550210
;

-- May 20, 2019 3:56:26 PM GMT+07:00
--  
UPDATE AD_InfoColumn SET IsActive='Y',Updated=TO_TIMESTAMP('2019-05-20 15:56:26','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoColumn_ID=550210
;
...
LEFT OUTER JOIN C_BPartner bp ON (ppo.C_BPartner_ID=bp.C_BPartner_ID)
LEFT JOIN M_PriceList_Version plv ON (plv.M_PriceList_Version_ID = pr.M_PriceList_Version_ID)
LEFT JOIN M_PriceList pl ON (pl.M_PriceList_ID = plv.M_PriceList_ID)',Updated=TO_TIMESTAMP('2019-05-20 15:56:46','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoWindow_ID=200000
;
