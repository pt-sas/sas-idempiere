...
--  
UPDATE AD_WF_Node SET AD_Column_ID=550080, "action"='V', Value='SwapCreditAging', Name='SwapCreditAging', AttributeValue='??!',Updated=TO_TIMESTAMP('2016-06-27 11:21:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_Node_ID=550112
;
...
--  
INSERT INTO AD_WF_Node (AD_WF_Node_ID,Cost,YPosition,OverlapUnits,UnitsCycles,Yield,WaitTime,Priority,Duration,IsCentrallyMaintained,JoinElement,AD_Column_ID,"limit",WorkingTime,XPosition,WaitingTime,IsMilestone,IsSubcontracting,SplitElement,"action",Value,Name,AD_WF_Node_UU,DynPriorityChange,AD_Workflow_ID,IsActive,DocAction,AD_Client_ID,EntityType,AD_Org_ID,Created,Updated,CreatedBy,UpdatedBy) VALUES (550120,0,0,0,0,100,0,0,0,'Y','X',2175,0,0,0,0,'N','N','X','C','Approval Credit Aging','Approval Credit Aging','942e6f89-a515-4173-b788-129d7629082e',0,116,'Y','CO',1000001,'U',0,TO_TIMESTAMP('2016-06-27 11:22:12','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2016-06-27 11:22:12','YYYY-MM-DD HH24:MI:SS'),100,100)
;
...
--  
INSERT INTO AD_WF_NodeNext (SeqNo,IsStdUserWorkflow,AD_WF_NodeNext_ID,AD_WF_Next_ID,AD_WF_Node_ID,EntityType,AD_WF_NodeNext_UU,AD_Org_ID,Updated,IsActive,AD_Client_ID,Created,CreatedBy,UpdatedBy) VALUES (10,'N',550174,550120,550119,'U','ec6aee5b-9652-473a-b9cd-0f2bf26e61a3',0,TO_TIMESTAMP('2016-06-27 11:23:43','YYYY-MM-DD HH24:MI:SS'),'Y',1000001,TO_TIMESTAMP('2016-06-27 11:23:43','YYYY-MM-DD HH24:MI:SS'),100,100)
;

-- Jun 27, 2016 11:24:07 AM WIT
--  
UPDATE AD_WF_NodeNext SET AD_WF_Next_ID=550112,Updated=TO_TIMESTAMP('2016-06-27 11:24:07','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_NodeNext_ID=550162
;
...
--  
INSERT INTO AD_WF_NodeNext (SeqNo,IsStdUserWorkflow,AD_WF_NodeNext_ID,AD_WF_Next_ID,AD_WF_Node_ID,EntityType,AD_WF_NodeNext_UU,AD_Org_ID,Updated,IsActive,AD_Client_ID,Created,CreatedBy,UpdatedBy) VALUES (10,'N',550175,550116,550120,'U','3ef9db70-4828-488c-a712-8fb943a01a4f',0,TO_TIMESTAMP('2016-06-27 11:25:19','YYYY-MM-DD HH24:MI:SS'),'Y',1000001,TO_TIMESTAMP('2016-06-27 11:25:19','YYYY-MM-DD HH24:MI:SS'),100,100)
;

-- Jun 27, 2016 11:25:32 AM WIT
--  
INSERT INTO AD_WF_NextCondition (AndOr,Operation,AD_WF_NextCondition_ID,SeqNo,AD_WF_NextCondition_UU,EntityType,Value,IsActive,Updated,AD_Column_ID,Created,AD_WF_NodeNext_ID,AD_Org_ID,CreatedBy,UpdatedBy,AD_Client_ID) VALUES ('O','>=',550129,10,'a2b78beb-46a3-4f18-9ce4-4af6f5c9af29','U','0','Y',TO_TIMESTAMP('2016-06-27 11:25:32','YYYY-MM-DD HH24:MI:SS'),550086,TO_TIMESTAMP('2016-06-27 11:25:32','YYYY-MM-DD HH24:MI:SS'),550175,0,100,100,1000001)
;

-- Jun 27, 2016 11:25:52 AM WIT
--  
INSERT INTO AD_WF_NodeNext (SeqNo,IsStdUserWorkflow,AD_WF_NodeNext_ID,AD_WF_Next_ID,AD_WF_Node_ID,EntityType,AD_WF_NodeNext_UU,AD_Org_ID,Updated,IsActive,AD_Client_ID,Created,CreatedBy,UpdatedBy) VALUES (100,'N',550176,186,550120,'U','42e0264b-50ad-4417-bcc8-a55fd7633bb3',0,TO_TIMESTAMP('2016-06-27 11:25:52','YYYY-MM-DD HH24:MI:SS'),'Y',1000001,TO_TIMESTAMP('2016-06-27 11:25:52','YYYY-MM-DD HH24:MI:SS'),100,100)
;

-- Jun 27, 2016 11:26:10 AM WIT
--  
UPDATE AD_WF_Node SET Value='SwapCreditLimit', Name='SwapCreditLimit',Updated=TO_TIMESTAMP('2016-06-27 11:26:10','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_Node_ID=550110
;
...
--  
UPDATE AD_WF_Node SET Value='LockCreditLimit', Name='LockCreditLimit',Updated=TO_TIMESTAMP('2016-06-27 11:26:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_Node_ID=550115
;
