...
--  
UPDATE AD_WF_Node SET UpdatedBy=100,Updated=TO_TIMESTAMP('2016-06-27 11:02:40','YYYY-MM-DD HH24:MI:SS') WHERE AD_WF_Node_ID=550115
;
...
--  
INSERT INTO AD_WF_Node (AD_WF_Node_ID,Cost,YPosition,OverlapUnits,UnitsCycles,Yield,WaitTime,Priority,Duration,IsCentrallyMaintained,JoinElement,AD_Column_ID,"limit",WorkingTime,XPosition,WaitingTime,IsMilestone,IsSubcontracting,SplitElement,"action",Value,Name,AD_WF_Node_UU,DynPriorityChange,AD_Workflow_ID,IsActive,DocAction,AD_Client_ID,EntityType,AD_Org_ID,Created,Updated,CreatedBy,UpdatedBy) VALUES (550118,0,0,0,0,100,0,0,0,'Y','X',2175,0,0,0,0,'N','N','X','C','Approval Total Discount','Approval Total Discount','6708369a-bfa6-44fa-a5c0-554591b1196c',0,116,'Y','CO',1000001,'U',0,TO_TIMESTAMP('2016-06-27 11:03:25','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2016-06-27 11:03:25','YYYY-MM-DD HH24:MI:SS'),100,100)
;
...
--  
INSERT INTO AD_WF_NodeNext (SeqNo,IsStdUserWorkflow,AD_WF_NodeNext_ID,AD_WF_Next_ID,AD_WF_Node_ID,EntityType,AD_WF_NodeNext_UU,AD_Org_ID,Updated,IsActive,AD_Client_ID,Created,CreatedBy,UpdatedBy) VALUES (10,'N',550169,550117,550111,'U','015f8f68-1737-4abf-82af-bea3b1ddcc68',0,TO_TIMESTAMP('2016-06-27 11:03:39','YYYY-MM-DD HH24:MI:SS'),'Y',1000001,TO_TIMESTAMP('2016-06-27 11:03:39','YYYY-MM-DD HH24:MI:SS'),100,100)
;

-- Jun 27, 2016 11:03:52 AM WIT
--  
INSERT INTO AD_WF_NodeNext (SeqNo,IsStdUserWorkflow,AD_WF_NodeNext_ID,AD_WF_Next_ID,AD_WF_Node_ID,EntityType,AD_WF_NodeNext_UU,AD_Org_ID,Updated,IsActive,AD_Client_ID,Created,CreatedBy,UpdatedBy) VALUES (10,'N',550170,550118,550117,'U','130898ac-0331-46e0-ae0a-2d48282578b5',0,TO_TIMESTAMP('2016-06-27 11:03:51','YYYY-MM-DD HH24:MI:SS'),'Y',1000001,TO_TIMESTAMP('2016-06-27 11:03:51','YYYY-MM-DD HH24:MI:SS'),100,100)
;

-- Jun 27, 2016 11:05:51 AM WIT
--  
INSERT INTO AD_WF_NodeNext (SeqNo,IsStdUserWorkflow,AD_WF_NodeNext_ID,AD_WF_Next_ID,AD_WF_Node_ID,EntityType,AD_WF_NodeNext_UU,AD_Org_ID,Updated,IsActive,AD_Client_ID,Created,CreatedBy,UpdatedBy) VALUES (10,'N',550171,186,550118,'U','2af6da55-d334-4926-9b93-f292c3b49b58',0,TO_TIMESTAMP('2016-06-27 11:05:51','YYYY-MM-DD HH24:MI:SS'),'Y',1000001,TO_TIMESTAMP('2016-06-27 11:05:51','YYYY-MM-DD HH24:MI:SS'),100,100)
;
