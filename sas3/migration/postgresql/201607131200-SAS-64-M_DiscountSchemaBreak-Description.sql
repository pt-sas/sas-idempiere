...
--  
ALTER TABLE M_DiscountSchemaBreak ADD COLUMN Description VARCHAR(255) DEFAULT NULL 
;

-- Jul 13, 2016 11:59:13 AM WIT
--  
INSERT INTO AD_Field (SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,Description,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,AD_Org_ID,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry,AD_Client_ID,ColumnSpan,NumLines,IsAdvancedField,IsDefaultFocus,AD_Column_ID,Created,EntityType,UpdatedBy,CreatedBy) VALUES (0,'N',406,0,'N','N',45,'Y',553071,'N','A description is limited to 255 characters.','Optional short description of the record','Description','471674f7-fe23-45c1-b5f4-60c09db32bd8','Y','N',0,TO_TIMESTAMP('2016-07-13 11:59:13','YYYY-MM-DD HH24:MI:SS'),'Y','Y',110,1,'N',0,5,1,'N','N',552080,TO_TIMESTAMP('2016-07-13 11:59:13','YYYY-MM-DD HH24:MI:SS'),'U',100,100)
;
