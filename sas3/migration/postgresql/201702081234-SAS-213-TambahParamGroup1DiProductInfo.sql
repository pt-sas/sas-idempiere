...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_InfoColumn SET IsActive='N',Updated=TO_TIMESTAMP('2017-02-08 12:12:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoColumn_ID=200019
;

-- Feb 8, 2017 12:13:03 PM WIT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_InfoColumn SET IsActive='N',Updated=TO_TIMESTAMP('2017-02-08 12:13:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoColumn_ID=200021
;

-- Feb 8, 2017 12:34:31 PM WIT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_InfoColumn SET Name='Product Group',Updated=TO_TIMESTAMP('2017-02-08 12:34:31','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_InfoColumn_ID=550128
;
