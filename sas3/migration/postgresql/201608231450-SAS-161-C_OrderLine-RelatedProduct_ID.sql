...
--  
UPDATE AD_Column SET FKConstraintName='RelatedProduct_COrderLine', FKConstraintType='C',Updated=TO_TIMESTAMP('2016-08-23 14:38:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552230
;

-- Aug 23, 2016 2:38:32 PM WIT
--  
ALTER TABLE C_OrderLine ADD COLUMN RelatedProduct_ID NUMERIC(10) DEFAULT NULL 
;
...
--  
UPDATE AD_Column SET FKConstraintType='N',Updated=TO_TIMESTAMP('2016-08-23 14:38:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552230
;

-- Aug 23, 2016 2:38:57 PM WIT
--  
INSERT INTO t_alter_column values('c_orderline','RelatedProduct_ID','NUMERIC(10)',null,'NULL')
;
...
--  
UPDATE AD_Field SET DisplayLogic='@RelatedProduct_ID@>0',Updated=TO_TIMESTAMP('2016-08-23 14:43:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553387
;
