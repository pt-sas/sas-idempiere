...
-- Nov 10, 2016 6:09:35 PM WIT
--  
INSERT INTO AD_TreeNode (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNode_UU) SELECT t.AD_Client_ID, 0, 'Y', statement_timestamp(), 100, statement_timestamp(), 100,t.AD_Tree_ID, 1001174, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=1000001 AND t.IsActive='Y' AND EXISTS (SELECT * FROM C_Element ae WHERE ae.C_Element_ID=1000001 AND t.AD_Tree_ID=ae.AD_Tree_ID) AND NOT EXISTS (SELECT * FROM AD_TreeNode e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=1001174)
;

-- Nov 10, 2016 6:09:59 PM WIT
--  
INSERT INTO C_ElementValue (IsSummary,PostEncumbrance,AccountSign,IsDocControlled,C_ElementValue_ID,PostStatistical,AccountType,C_Element_ID,PostActual,IsForeignCurrency,IsBankAccount,PostBudget,C_BankAccount_ID,C_ElementValue_UU,Value,Updated,AD_Client_ID,IsActive,Name,AD_Org_ID,Created,Parent_ID,IsReadOnly,IsDetailBPartner,IsDetailProduct,UpdatedBy,CreatedBy) VALUES ('N','Y','N','Y',1001175,'Y','A',1000001,'Y','N','Y','Y',1000124,'760bd1b7-d08f-450b-bab5-99febe11b1b3','1111.2604',TO_TIMESTAMP('2016-11-10 18:09:59','YYYY-MM-DD HH24:MI:SS'),1000001,'Y','Victoria - 187102110 In Transit',0,TO_TIMESTAMP('2016-11-10 18:09:59','YYYY-MM-DD HH24:MI:SS'),1000492,'N','N','N',100,100)
;
...
-- Nov 10, 2016 6:09:59 PM WIT
--  
INSERT INTO AD_TreeNode (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNode_UU) SELECT t.AD_Client_ID, 0, 'Y', statement_timestamp(), 100, statement_timestamp(), 100,t.AD_Tree_ID, 1001175, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=1000001 AND t.IsActive='Y' AND EXISTS (SELECT * FROM C_Element ae WHERE ae.C_Element_ID=1000001 AND t.AD_Tree_ID=ae.AD_Tree_ID) AND NOT EXISTS (SELECT * FROM AD_TreeNode e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=1001175)
;
...
-- Nov 10, 2016 6:10:07 PM WIT
--  
UPDATE AD_TreeNode SET Parent_ID=1001136, SeqNo=1, Updated=statement_timestamp() WHERE AD_Tree_ID=1000030 AND Node_ID=1001175
;

-- Nov 10, 2016 6:10:07 PM WIT
--  
UPDATE AD_TreeNode SET Parent_ID=1001136, SeqNo=2, Updated=statement_timestamp() WHERE AD_Tree_ID=1000030 AND Node_ID=1001147
;
...
-- Nov 10, 2016 6:10:11 PM WIT
--  
UPDATE AD_TreeNode SET Parent_ID=1001136, SeqNo=1, Updated=statement_timestamp() WHERE AD_Tree_ID=1000030 AND Node_ID=1001174
;

-- Nov 10, 2016 6:10:12 PM WIT
--  
UPDATE AD_TreeNode SET Parent_ID=1001136, SeqNo=2, Updated=statement_timestamp() WHERE AD_Tree_ID=1000030 AND Node_ID=1001175
;

-- Nov 10, 2016 6:10:12 PM WIT
--  
UPDATE AD_TreeNode SET Parent_ID=1001136, SeqNo=3, Updated=statement_timestamp() WHERE AD_Tree_ID=1000030 AND Node_ID=1001147
;
...
-- Nov 10, 2016 6:10:14 PM WIT
--  
UPDATE AD_TreeNode SET Parent_ID=1001136, SeqNo=2, Updated=statement_timestamp() WHERE AD_Tree_ID=1000030 AND Node_ID=1001174
;

-- Nov 10, 2016 6:10:14 PM WIT
--  
UPDATE AD_TreeNode SET Parent_ID=1001136, SeqNo=3, Updated=statement_timestamp() WHERE AD_Tree_ID=1000030 AND Node_ID=1001175
;

-- Nov 10, 2016 6:10:14 PM WIT
--  
UPDATE AD_TreeNode SET Parent_ID=1001136, SeqNo=4, Updated=statement_timestamp() WHERE AD_Tree_ID=1000030 AND Node_ID=1001147
;
