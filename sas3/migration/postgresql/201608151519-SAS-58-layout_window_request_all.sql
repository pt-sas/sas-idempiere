...
--  
UPDATE AD_Field SET XPosition=4,Updated=TO_TIMESTAMP('2016-08-15 13:56:14','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=5860
;

-- Aug 15, 2016 1:57:42 PM WIT
--  
UPDATE AD_Field SET IsDisplayed='N',Updated=TO_TIMESTAMP('2016-08-15 13:57:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=11454
;

-- Aug 15, 2016 1:57:51 PM WIT
--  
UPDATE AD_Field SET IsDisplayedGrid='N',Updated=TO_TIMESTAMP('2016-08-15 13:57:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=11454
;

-- Aug 15, 2016 1:57:57 PM WIT
--  
UPDATE AD_Field SET IsDisplayed='N', IsDisplayedGrid='N',Updated=TO_TIMESTAMP('2016-08-15 13:57:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=11458
;

-- Aug 15, 2016 1:58:02 PM WIT
--  
UPDATE AD_Field SET IsDisplayed='N', IsDisplayedGrid='N',Updated=TO_TIMESTAMP('2016-08-15 13:58:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=11457
;

-- Aug 15, 2016 1:58:13 PM WIT
--  
UPDATE AD_Field SET IsDisplayed='N', IsDisplayedGrid='N',Updated=TO_TIMESTAMP('2016-08-15 13:58:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=11460
;
...
--  
UPDATE AD_Field SET IsReadOnly='Y',Updated=TO_TIMESTAMP('2016-08-15 14:27:55','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553377
;

-- Aug 15, 2016 2:29:16 PM WIT
--  
UPDATE AD_Field SET ReadOnlyLogic='@SAS_RequestBundle_ID@ ! NULL',Updated=TO_TIMESTAMP('2016-08-15 14:29:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=5860
;

-- Aug 15, 2016 2:32:29 PM WIT
--  
UPDATE AD_Field SET DisplayLogic=NULL,Updated=TO_TIMESTAMP('2016-08-15 14:32:29','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553150
;

-- Aug 15, 2016 2:37:24 PM WIT
--  
UPDATE AD_Field SET ReadOnlyLogic='@SAS_RequestBundle_ID@!NULL',Updated=TO_TIMESTAMP('2016-08-15 14:37:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=5860
;

-- Aug 15, 2016 2:45:50 PM WIT
--  
UPDATE AD_Field SET ReadOnlyLogic='@SAS_RequestBundle_ID@ ! NULL',Updated=TO_TIMESTAMP('2016-08-15 14:45:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=5860
;

-- Aug 15, 2016 2:45:59 PM WIT
--  
UPDATE AD_Field SET ReadOnlyLogic='@SAS_RequestBundle_ID@!NULL',Updated=TO_TIMESTAMP('2016-08-15 14:45:59','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=5860
;
