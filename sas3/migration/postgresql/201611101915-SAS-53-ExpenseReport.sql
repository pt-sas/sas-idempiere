...
--  
UPDATE AD_Field SET IsReadOnly='Y',Updated=TO_TIMESTAMP('2016-11-10 18:32:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553480
;

-- Nov 10, 2016 6:35:53 PM WIT
--  
INSERT INTO AD_UserDef_Win (IsDefault,Help,IsReadOnly,AD_UserDef_Win_ID,AD_UserDef_Win_UU,IsUserUpdateable,Description,Updated,IsActive,Name,AD_Window_ID,AD_Language,AD_Role_ID,Created,AD_Org_ID,CreatedBy,UpdatedBy,AD_Client_ID) VALUES ('N','The time and expense report allows you to capture time spent on a project, billable time and to claim expenses.','N',1000024,'d0d7af75-b8a3-44fb-9d31-f7468d08bdb7','N','Time and Expense Report',TO_TIMESTAMP('2016-11-10 18:35:53','YYYY-MM-DD HH24:MI:SS'),'Y','Expense Report',235,'en_US',1000002,TO_TIMESTAMP('2016-11-10 18:35:53','YYYY-MM-DD HH24:MI:SS'),0,100,100,1000001)
;
...
--  
UPDATE AD_Field SET IsReadOnly='N',Updated=TO_TIMESTAMP('2016-11-10 19:14:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553480
;
