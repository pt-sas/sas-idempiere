...
--  
UPDATE AD_Field SET DisplayLogic='@AllocatedAmt@!0',Updated=TO_TIMESTAMP('2016-08-05 17:24:20','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=4361
;

-- Aug 5, 2016 5:30:16 PM WIT
--  
UPDATE AD_Field SET IsDisplayed='Y',Updated=TO_TIMESTAMP('2016-08-05 17:30:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553366
;

-- Aug 5, 2016 5:34:12 PM WIT
--  
UPDATE AD_Field SET DisplayLogic='@AllocatedAmt@=0',Updated=TO_TIMESTAMP('2016-08-05 17:34:12','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=4361
;

-- Aug 5, 2016 5:34:24 PM WIT
--  
UPDATE AD_Field SET Name='Allocated Amount',Updated=TO_TIMESTAMP('2016-08-05 17:34:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553366
;
