...
--  
INSERT INTO AD_Column (SeqNoSelection,IsSyncDatabase,Version,AD_Column_ID,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,IsKey,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Description,Help,Name,IsAllowCopy,Updated,AD_Org_ID,IsActive,Created,IsAlwaysUpdateable,AD_Client_ID,EntityType,IsEncrypted,IsSecure,AD_Element_ID,AD_Reference_ID,AD_Table_ID,IsToolbarButton,CreatedBy,UpdatedBy) VALUES (0,'N',0,552037,'N','N','N',0,'N',7,'N','N','N','Y','ba56a1a5-b40c-41ce-99af-2e5b25967bde','Y','DueDate','Date when the payment is due','Date when the payment is due without deductions or discount','Due Date','Y',TO_TIMESTAMP('2016-07-11 09:44:42','YYYY-MM-DD HH24:MI:SS'),0,'Y',TO_TIMESTAMP('2016-07-11 09:44:42','YYYY-MM-DD HH24:MI:SS'),'N',0,'U','N','N',2000,15,318,'Y',100,100)
;
...
--  
ALTER TABLE C_Invoice ADD COLUMN DueDate TIMESTAMP DEFAULT NULL 
;

-- Jul 11, 2016 9:46:12 AM WIT
--  
INSERT INTO AD_Field (SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,Description,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,AD_Org_ID,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry,AD_Client_ID,ColumnSpan,NumLines,IsAdvancedField,IsDefaultFocus,AD_Column_ID,Created,EntityType,UpdatedBy,CreatedBy) VALUES (0,'N',290,0,'N','N',440,'Y',553066,'N','Date when the payment is due without deductions or discount','Date when the payment is due','Due Date','a51f5471-9be8-4c6a-8067-2033ee62e4a5','Y','N',0,TO_TIMESTAMP('2016-07-11 09:46:12','YYYY-MM-DD HH24:MI:SS'),'Y','Y',430,1,'N',0,1,1,'N','N',552037,TO_TIMESTAMP('2016-07-11 09:46:12','YYYY-MM-DD HH24:MI:SS'),'U',100,100)
;
...
--  
UPDATE AD_Field SET XPosition=4, ColumnSpan=2,Updated=TO_TIMESTAMP('2016-07-11 10:04:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553066
;

-- Jul 11, 2016 10:04:33 AM WIT
--  
UPDATE AD_Field SET IsAlwaysUpdateable='Y',Updated=TO_TIMESTAMP('2016-07-11 10:04:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553066
;

-- Jul 11, 2016 10:05:24 AM WIT
--  
UPDATE AD_Field SET XPosition=1, ColumnSpan=1,Updated=TO_TIMESTAMP('2016-07-11 10:05:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=200048
;
...
--  
UPDATE AD_Field SET XPosition=2,Updated=TO_TIMESTAMP('2016-07-11 10:07:12','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=200048
;

-- Jul 11, 2016 10:08:01 AM WIT
--  
UPDATE AD_Field SET XPosition=2,Updated=TO_TIMESTAMP('2016-07-11 10:08:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553066
;

-- Jul 11, 2016 10:08:11 AM WIT
--  
UPDATE AD_Field SET XPosition=4,Updated=TO_TIMESTAMP('2016-07-11 10:08:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553066
;

-- Jul 11, 2016 10:08:19 AM WIT
--  
UPDATE AD_Field SET ColumnSpan=2,Updated=TO_TIMESTAMP('2016-07-11 10:08:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=200048
;
