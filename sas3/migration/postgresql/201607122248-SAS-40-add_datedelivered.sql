...
--  
INSERT INTO AD_Column (SeqNoSelection,IsSyncDatabase,Version,AD_Column_ID,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,IsKey,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Description,Name,IsAllowCopy,Updated,AD_Org_ID,IsActive,Created,IsAlwaysUpdateable,AD_Client_ID,EntityType,IsEncrypted,IsSecure,AD_Element_ID,AD_Reference_ID,AD_Table_ID,IsToolbarButton,CreatedBy,UpdatedBy) VALUES (0,'N',0,552069,'N','N','N',0,'N',29,'N','N','N','Y','3152ad3f-3ae5-43d3-91be-44030bf2a823','N','DateDelivered','Date when the product was delivered','Date Delivered','Y',TO_TIMESTAMP('2016-07-12 22:37:55','YYYY-MM-DD HH24:MI:SS'),0,'Y',TO_TIMESTAMP('2016-07-12 22:37:55','YYYY-MM-DD HH24:MI:SS'),'N',0,'U','N','N',264,16,319,'Y',100,100)
;
...
--  
UPDATE AD_Column SET IsUpdateable='Y',Updated=TO_TIMESTAMP('2016-07-12 22:38:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552069
;

-- Jul 12, 2016 10:38:41 PM WIT
--  
UPDATE AD_Column SET AD_Reference_ID=15, FKConstraintType=NULL,Updated=TO_TIMESTAMP('2016-07-12 22:38:41','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552069
;

-- Jul 12, 2016 10:39:08 PM WIT
--  
ALTER TABLE M_InOut ADD COLUMN DateDelivered TIMESTAMP DEFAULT NULL 
;

-- Jul 12, 2016 10:41:38 PM WIT
--  
INSERT INTO AD_Field (SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Description,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,AD_Org_ID,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry,AD_Client_ID,ColumnSpan,NumLines,IsAdvancedField,IsDefaultFocus,AD_Column_ID,Created,EntityType,UpdatedBy,CreatedBy) VALUES (0,'N',296,0,'N','N',410,'Y',553070,'N','Date when the product was delivered','Date Delivered','8a49e556-134f-43e5-a737-85815631e164','Y','N',0,TO_TIMESTAMP('2016-07-12 22:41:38','YYYY-MM-DD HH24:MI:SS'),'Y','Y',420,1,'N',0,1,1,'N','N',552069,TO_TIMESTAMP('2016-07-12 22:41:38','YYYY-MM-DD HH24:MI:SS'),'U',100,100)
;
...
--  
UPDATE AD_Field SET IsReadOnly='Y',Updated=TO_TIMESTAMP('2016-07-12 22:43:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3490
;

-- Jul 12, 2016 10:43:49 PM WIT
--  
UPDATE AD_Field SET XPosition=41, ColumnSpan=2,Updated=TO_TIMESTAMP('2016-07-12 22:43:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553070
;

-- Jul 12, 2016 10:43:55 PM WIT
--  
UPDATE AD_Field SET ColumnSpan=1,Updated=TO_TIMESTAMP('2016-07-12 22:43:55','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553070
;

-- Jul 12, 2016 10:44:14 PM WIT
--  
UPDATE AD_Field SET XPosition=4,Updated=TO_TIMESTAMP('2016-07-12 22:44:14','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553070
;
