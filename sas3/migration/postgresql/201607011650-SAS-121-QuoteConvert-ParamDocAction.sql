...
--  
UPDATE AD_Process_Para SET IsMandatory='N', DisplayLogic='1=1',Updated=TO_TIMESTAMP('2016-07-01 16:33:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=375
;

-- Jul 1, 2016 4:36:34 PM WIT
--  
UPDATE AD_Process_Para SET DisplayLogic=NULL, IsActive='N',Updated=TO_TIMESTAMP('2016-07-01 16:36:34','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=375
;
