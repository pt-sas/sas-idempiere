...
--  
ALTER TABLE C_Payment ADD COLUMN BankName VARCHAR(255) DEFAULT NULL 
;

-- Aug 2, 2016 11:15:54 AM WIT
--  
INSERT INTO AD_Field (SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,AD_Org_ID,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry,AD_Client_ID,ColumnSpan,NumLines,IsAdvancedField,IsDefaultFocus,AD_Column_ID,Created,EntityType,UpdatedBy,CreatedBy) VALUES (0,'N',330,0,'N','N',345,'Y',553342,'N','Bank Name','6543eb0c-5235-4081-adbb-1c9a0bf11462','Y','N',0,TO_TIMESTAMP('2016-08-02 11:15:54','YYYY-MM-DD HH24:MI:SS'),'Y','Y',790,1,'N',0,2,1,'N','N',552190,TO_TIMESTAMP('2016-08-02 11:15:54','YYYY-MM-DD HH24:MI:SS'),'U',100,100)
;
...
--  
UPDATE AD_Field SET DisplayLogic='@TenderType@=K', MandatoryLogic='@TenderType@=K',Updated=TO_TIMESTAMP('2016-08-02 11:18:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553342
;

-- Aug 2, 2016 11:30:01 AM WIT
--  
UPDATE AD_Column SET AD_Reference_ID=17, AD_Reference_Value_ID=550093, FKConstraintType=NULL,Updated=TO_TIMESTAMP('2016-08-02 11:30:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552190
;
