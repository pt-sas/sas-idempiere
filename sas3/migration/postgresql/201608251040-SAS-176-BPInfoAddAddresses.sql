...
--  
INSERT INTO AD_InfoColumn (Help,SeqNo,AD_InfoColumn_UU,AD_InfoColumn_ID,IsQueryCriteria,EntityType,Description,Updated,Name,IsCentrallyMaintained,ColumnName,IsDisplayed,IsActive,SelectClause,SeqNoSelection,IsIdentifier,AD_Element_ID,AD_InfoWindow_ID,AD_Reference_ID,Created,IsMandatory,CreatedBy,AD_Org_ID,UpdatedBy,AD_Client_ID,IsKey) VALUES ('The Address 2 provides additional address information for an entity.  It can be used for building location, apartment number or similar information.',132,'c9294d69-a481-455b-a734-b35756df8730',550118,'N','U','Address Line 3 for the location',TO_TIMESTAMP('2016-08-25 10:22:07','YYYY-MM-DD HH24:MI:SS'),'Address 3','Y','Address3','Y','Y','a.Address3',0,'N',2555,200001,10,TO_TIMESTAMP('2016-08-25 10:22:07','YYYY-MM-DD HH24:MI:SS'),'N',100,0,100,0,'N')
;
...
--  
INSERT INTO AD_InfoColumn (Help,SeqNo,AD_InfoColumn_UU,AD_InfoColumn_ID,IsQueryCriteria,EntityType,Description,Updated,Name,IsCentrallyMaintained,ColumnName,IsDisplayed,IsActive,SelectClause,SeqNoSelection,IsIdentifier,AD_Element_ID,AD_InfoWindow_ID,AD_Reference_ID,Created,IsMandatory,CreatedBy,AD_Org_ID,UpdatedBy,AD_Client_ID,IsKey) VALUES ('The Address 4 provides additional address information for an entity.  It can be used for building location, apartment number or similar information.',133,'474bc157-92fb-44c7-bb46-8d85bb69ac5e',550119,'N','U','Address Line 4 for the location',TO_TIMESTAMP('2016-08-25 10:22:26','YYYY-MM-DD HH24:MI:SS'),'Address 4','Y','Address4','Y','Y','a.Address4',0,'N',2556,200001,10,TO_TIMESTAMP('2016-08-25 10:22:26','YYYY-MM-DD HH24:MI:SS'),'N',100,0,100,0,'N')
;
