...
AND
(M_Locator.M_Locator_ID NOT IN (SELECT l.M_Locator_ID FROM M_Locator l WHERE UPPER(l.Value) LIKE ''%DELIVERY%''))',550235,'U','Z SAS M_LocatorTo Inventory Move CopyFrom','S','c0f6ccd3-c285-4e2e-8076-268105ba933f',TO_TIMESTAMP('2016-11-04 18:54:10','YYYY-MM-DD HH24:MI:SS'),0,'Y',0,TO_TIMESTAMP('2016-11-04 18:54:10','YYYY-MM-DD HH24:MI:SS'),100,100)
;

-- Nov 4, 2016 6:54:42 PM WIT
--  
UPDATE AD_Process_Para SET AD_Val_Rule_ID=550235,Updated=TO_TIMESTAMP('2016-11-04 18:54:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=550719
;
