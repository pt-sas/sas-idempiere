...
--  
INSERT INTO AD_Field (SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Description,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,AD_Org_ID,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry,AD_Client_ID,ColumnSpan,NumLines,IsAdvancedField,IsDefaultFocus,AD_Column_ID,Created,EntityType,UpdatedBy,CreatedBy) VALUES (0,'N',550126,0,'N','N',62,'Y',553378,'N','Document Organization (independent from account organization)','Document Org','2249e6ea-99c3-413f-ba6c-7ccd49dad88e','Y','N',0,TO_TIMESTAMP('2016-08-19 11:26:24','YYYY-MM-DD HH24:MI:SS'),'Y','Y',260,1,'N',0,2,1,'N','N',552223,TO_TIMESTAMP('2016-08-19 11:26:24','YYYY-MM-DD HH24:MI:SS'),'U',100,100)
;
...
--  
UPDATE AD_Field SET SeqNo=95, IsReadOnly='Y',Updated=TO_TIMESTAMP('2016-08-19 11:31:31','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553253
;

-- Aug 19, 2016 11:31:53 AM WIT
--  
UPDATE AD_Field SET ReadOnlyLogic='@M_InOut_ID@>0',Updated=TO_TIMESTAMP('2016-08-19 11:31:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553262
;

-- Aug 19, 2016 11:32:15 AM WIT
--  
UPDATE AD_Field SET ReadOnlyLogic='@C_Invoice_ID@>0',Updated=TO_TIMESTAMP('2016-08-19 11:32:15','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553263
;

-- Aug 19, 2016 11:33:22 AM WIT
--  
UPDATE AD_Field SET SeqNo=115,Updated=TO_TIMESTAMP('2016-08-19 11:33:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=553253
;

-- Aug 19, 2016 11:41:47 AM WIT
--  
UPDATE AD_Column SET ColumnSQL='(SELECT MAX(o.AD_Org_ID) FROM AD_Org o LEFT JOIN C_Invoice i ON (i.C_Invoice_ID = R_Request.C_Invoice_ID) LEFT JOIN M_InOut io ON (io.M_InOut_ID = R_Request.M_InOut_ID) WHERE i.AD_Org_ID = o.AD_Org_ID OR io.AD_Org_ID = o.AD_Org_ID)',Updated=TO_TIMESTAMP('2016-08-19 11:41:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552223
;
