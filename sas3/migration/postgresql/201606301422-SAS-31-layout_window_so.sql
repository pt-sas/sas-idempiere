-- Jun 30, 2016 2:13:23 PM WIT
--  
UPDATE AD_Field SET SeqNo=90,IsDisplayed='Y' WHERE AD_Field_ID=6562
;

-- Jun 30, 2016 2:13:24 PM WIT
--  
UPDATE AD_Field SET SeqNo=100,IsDisplayed='Y' WHERE AD_Field_ID=1110
;

-- Jun 30, 2016 2:13:27 PM WIT
--  
UPDATE AD_Field SET SeqNo=90,IsDisplayed='Y' WHERE AD_Field_ID=1110
;
...
-- Jun 30, 2016 2:13:38 PM WIT
--  
UPDATE AD_Field SET SeqNo=590,IsDisplayed='Y' WHERE AD_Field_ID=552935
;

-- Jun 30, 2016 2:13:38 PM WIT
--  
UPDATE AD_Field SET SeqNo=600,IsDisplayed='Y' WHERE AD_Field_ID=553047
;

-- Jun 30, 2016 2:13:38 PM WIT
--  
UPDATE AD_Field SET SeqNo=610,IsDisplayed='Y' WHERE AD_Field_ID=200756
;

-- Jun 30, 2016 2:13:41 PM WIT
--  
...
-- Jun 30, 2016 2:14:05 PM WIT
--  
UPDATE AD_Field SET SeqNo=420,IsDisplayed='Y' WHERE AD_Field_ID=553046
;
...
-- Jun 30, 2016 2:14:05 PM WIT
--  
UPDATE AD_Field SET SeqNo=600,IsDisplayed='Y' WHERE AD_Field_ID=552935
;

-- Jun 30, 2016 2:14:05 PM WIT
--  
UPDATE AD_Field SET SeqNo=610,IsDisplayed='Y' WHERE AD_Field_ID=553045
;

-- Jun 30, 2016 2:14:06 PM WIT
--  
UPDATE AD_Field SET SeqNo=620,IsDisplayed='Y' WHERE AD_Field_ID=6562
;

-- Jun 30, 2016 2:15:21 PM WIT
--  
...
-- Jun 30, 2016 2:15:21 PM WIT
--  
UPDATE AD_Field SET SeqNo=110,IsDisplayed='Y' WHERE AD_Field_ID=1086
;

-- Jun 30, 2016 2:15:42 PM WIT
--  
UPDATE AD_Field SET AD_FieldGroup_ID=NULL,Updated=TO_TIMESTAMP('2016-06-30 14:15:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1110
;

-- Jun 30, 2016 2:17:01 PM WIT
--  
UPDATE AD_Field SET IsAlwaysUpdateable=NULL,Updated=TO_TIMESTAMP('2016-06-30 14:17:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1110
;

SELECT register_migration_script('201606301422-SAS-31-layout_window_so.sql') FROM dual
;
