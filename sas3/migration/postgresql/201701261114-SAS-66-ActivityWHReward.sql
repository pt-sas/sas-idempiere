...
--  
INSERT INTO C_Activity (C_Activity_ID,Value,IsSummary,C_Activity_UU,Updated,IsActive,Created,Description,Name,AD_Org_ID,UpdatedBy,CreatedBy,AD_Client_ID) VALUES (1000016,'MMM-WarehouseReward','N','3956729c-9f33-45eb-ab63-478dc30b9bfc',TO_TIMESTAMP('2017-01-26 11:11:30','YYYY-MM-DD HH24:MI:SS'),'Y',TO_TIMESTAMP('2017-01-26 11:11:30','YYYY-MM-DD HH24:MI:SS'),'WH Reward Movement','WH Reward Movement',0,100,100,1000001)
;
...
-- Jan 26, 2017 11:11:31 AM WIT
--  
INSERT INTO AD_TreeNode (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNode_UU) SELECT t.AD_Client_ID, 0, 'Y', statement_timestamp(), 100, statement_timestamp(), 100,t.AD_Tree_ID, 1000016, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=1000001 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='AY' AND NOT EXISTS (SELECT * FROM AD_TreeNode e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=1000016)
;
