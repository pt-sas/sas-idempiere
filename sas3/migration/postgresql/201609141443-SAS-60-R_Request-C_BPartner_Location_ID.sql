...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Column SET IsAllowCopy='N',Updated=TO_TIMESTAMP('2016-09-14 14:37:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552296
;

-- Sep 14, 2016 2:37:59 PM WIT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Column SET FKConstraintName='CBPartnerLocation_RRequest', FKConstraintType='N',Updated=TO_TIMESTAMP('2016-09-14 14:37:59','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552296
;

-- Sep 14, 2016 2:37:59 PM WIT
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
ALTER TABLE R_Request ADD COLUMN C_BPartner_Location_ID NUMERIC(10) DEFAULT NULL 
;
