...
--  
UPDATE C_DocType SET Name='Customer RMA A',Updated=TO_TIMESTAMP('2016-08-04 10:02:30','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=1000029
;
...
--  
UPDATE C_DocType SET Name='Customer Return A',Updated=TO_TIMESTAMP('2016-08-04 10:13:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=1000015
;
...
--  
UPDATE C_DocType SET C_DocTypeShipment_ID=550288,Updated=TO_TIMESTAMP('2016-08-04 10:16:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550287
;

-- Aug 4, 2016 10:16:57 AM WIT
--  
UPDATE C_DocType SET Name='AR Credit Memo Tax',Updated=TO_TIMESTAMP('2016-08-04 10:16:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=1000004
;
...
--  
UPDATE AD_Sequence SET StartNewYear='Y', CurrentNext=1, Prefix='ARA-@DateInvoiced<yyMM>@-', DateColumn='DateInvoiced', DecimalPattern='0000', Name='AR Credit Memo Tax', StartNo=1, StartNewMonth='Y',Updated=TO_TIMESTAMP('2016-08-04 10:19:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Sequence_ID=550307
;

-- Aug 4, 2016 10:19:23 AM WIT
--  
INSERT INTO AD_Sequence (StartNewYear,CurrentNextSys,IsTableID,CurrentNext,IsAudited,Prefix,IsAutoSequence,AD_Sequence_ID,DateColumn,DecimalPattern,Description,Name,IncrementNo,AD_Sequence_UU,AD_Org_ID,IsOrgLevelSequence,Updated,IsActive,StartNo,StartNewMonth,AD_Client_ID,Created,MaxValue,CreatedBy,UpdatedBy) VALUES ('Y',17000,'N',1,'N','ARA-@DateInvoiced<yyMM>@-','Y',551798,'DateInvoiced','0000','AR Credit Memo','AR Credit Memo Non Tax',1,'913c8db3-47f6-4e26-bf77-c64086ca90e3',0,'N',TO_TIMESTAMP('2016-08-04 10:19:23','YYYY-MM-DD HH24:MI:SS'),'Y',1,'Y',1000001,TO_TIMESTAMP('2016-08-04 10:19:23','YYYY-MM-DD HH24:MI:SS'),0,100,100)
;

-- Aug 4, 2016 10:19:33 AM WIT
--  
UPDATE AD_Sequence SET Prefix='ARB-@DateInvoiced<yyMM>@-',Updated=TO_TIMESTAMP('2016-08-04 10:19:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Sequence_ID=551798
;

-- Aug 4, 2016 10:19:53 AM WIT
--  
UPDATE C_DocType SET DocNoSequence_ID=551798,Updated=TO_TIMESTAMP('2016-08-04 10:19:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550289
;

-- Aug 4, 2016 10:20:00 AM WIT
--  
UPDATE C_DocType SET C_DocTypeTaxInvoice_ID=NULL,Updated=TO_TIMESTAMP('2016-08-04 10:20:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550289
;

-- Aug 4, 2016 10:20:16 AM WIT
--  
UPDATE C_DocType SET C_DocTypeInvoice_ID=550289,Updated=TO_TIMESTAMP('2016-08-04 10:20:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=550287
;

-- Aug 4, 2016 10:39:13 AM WIT
--  
UPDATE AD_Sequence SET Prefix='RB-@MovementDate<yyMM>@-',Updated=TO_TIMESTAMP('2016-08-04 10:39:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Sequence_ID=551797
;

-- Aug 4, 2016 10:39:35 AM WIT
--  
UPDATE AD_Sequence SET Prefix='RA-@MovementDate<yyMM>@-',Updated=TO_TIMESTAMP('2016-08-04 10:39:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Sequence_ID=550313
;
