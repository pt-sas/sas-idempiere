...
--  
ALTER TABLE S_TimeExpense ADD COLUMN IsTax CHAR(1) DEFAULT 'N' CHECK (IsTax IN ('Y','N')) NOT NULL
;

-- Nov 7, 2016 6:19:55 PM WIT
--  
INSERT INTO AD_Field (SortNo,IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,AD_Org_ID,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,XPosition,IsQuickEntry,AD_Client_ID,ColumnSpan,NumLines,IsAdvancedField,IsDefaultFocus,AD_Column_ID,Created,EntityType,UpdatedBy,CreatedBy) VALUES (0,'N',412,0,'Y','N',55,'Y',553480,'N','Tax','555c497e-49bd-428a-a482-b6eba29315d3','Y','N',0,TO_TIMESTAMP('2016-11-07 18:19:55','YYYY-MM-DD HH24:MI:SS'),'Y','Y',210,5,'N',0,2,1,'N','N',552345,TO_TIMESTAMP('2016-11-07 18:19:55','YYYY-MM-DD HH24:MI:SS'),'U',100,100)
;
