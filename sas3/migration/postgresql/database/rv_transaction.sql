...
SELECT t.m_transaction_id,
	...
	t.c_projectissue_id,
	COALESCE(iol.C_Project_ID,i.C_Project_ID,m.C_Project_ID,io.C_Project_ID,pjl.C_Project_ID) C_Project_ID, -- ISY
...
LEFT JOIN AD_TreeNode tn ON (tn.Node_ID = COALESCE(iol.AD_OrgTrx_ID,io.AD_OrgTrx_ID) AND tn.AD_Tree_ID = 1000024)
;