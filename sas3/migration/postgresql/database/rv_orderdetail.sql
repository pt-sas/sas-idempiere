...
CREATE OR REPLACE VIEW rv_orderdetail AS 
 SELECT l.ad_client_id,
	...
	(l.QtyEntered * l.PriceEntered) AS EnteredAmt,
	(l.QtyOrdered * l.PriceActual) AS OrderedAmt,
	(l.QtyDelivered * l.PriceActual) AS DeliveredAmt,
	(l.QtyInvoiced * l.PriceActual) AS InvoicedAmt,
	((l.QtyOrdered - l.QtyDelivered) * l.PriceActual) AS AmtToDeliver,
	CURRENCYBASE((l.QtyEntered * l.PriceEntered),o.C_Currency_ID,o.DateOrdered,o.AD_Client_ID,o.AD_Org_ID) AS ConvertedEnteredAmt,
	CURRENCYBASE((l.QtyOrdered * l.PriceActual),o.C_Currency_ID,o.DateOrdered,o.AD_Client_ID,o.AD_Org_ID) AS ConvertedOrderedAmt,
	CURRENCYBASE((l.QtyDelivered * l.PriceActual),o.C_Currency_ID,o.DateOrdered,o.AD_Client_ID,o.AD_Org_ID) AS ConvertedDeliveredAmt,
	CURRENCYBASE((l.QtyInvoiced * l.PriceActual),o.C_Currency_ID,o.DateOrdered,o.AD_Client_ID,o.AD_Org_ID) AS ConvertedInvoicedAmt,
	CURRENCYBASE(((l.QtyOrdered - l.QtyDelivered) * l.PriceActual),o.C_Currency_ID,o.DateOrdered,o.AD_Client_ID,o.AD_Org_ID) AS ConvertedAmtToDeliver,
	CURRENCYBASE(((l.QtyOrdered - l.QtyInvoiced) * l.PriceActual),o.C_Currency_ID,o.DateOrdered,o.AD_Client_ID,o.AD_Org_ID) AS ConvertedNetAmtToInvoice,
	--SAS
    tn.parent_id AS parent_org_id
   FROM c_order o
     ...
     LEFT JOIN ad_treenode tn ON tn.node_id = COALESCE(l.ad_orgtrx_id, o.ad_orgtrx_id) AND tn.ad_tree_id = 1000024;