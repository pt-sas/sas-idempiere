...
--  
INSERT INTO GL_Category (CategoryType,GL_Category_ID,GL_Category_UU,IsDefault,Updated,IsActive,Created,Name,AD_Org_ID,UpdatedBy,CreatedBy,AD_Client_ID) VALUES ('D',1000038,'cf24f92f-4230-4744-b096-c5ec72e2671b','N',TO_TIMESTAMP('2016-07-18 19:29:26','YYYY-MM-DD HH24:MI:SS'),'Y',TO_TIMESTAMP('2016-07-18 19:29:26','YYYY-MM-DD HH24:MI:SS'),'Request Bundle',0,100,100,1000001)
;
...
--  
INSERT INTO AD_Sequence (StartNewYear,CurrentNextSys,IsTableID,CurrentNext,IsAudited,Prefix,IsAutoSequence,AD_Sequence_ID,DateColumn,DecimalPattern,Description,Name,IncrementNo,AD_Sequence_UU,AD_Org_ID,IsOrgLevelSequence,Updated,IsActive,StartNo,StartNewMonth,AD_Client_ID,Created,MaxValue,CreatedBy,UpdatedBy) VALUES ('Y',5000,'N',1,'N','DJ-@DateDoc<yyMM>@-','Y',551782,'DateDoc','0000','Delivery Journal','Delivery Journal',1,'2c802e46-88ac-415f-9eaa-e0230ef356bc',0,'N',TO_TIMESTAMP('2016-07-18 19:34:11','YYYY-MM-DD HH24:MI:SS'),'Y',1,'Y',1000001,TO_TIMESTAMP('2016-07-18 19:34:11','YYYY-MM-DD HH24:MI:SS'),0,100,100)
;

-- Jul 18, 2016 7:35:00 PM WIT
--  
INSERT INTO AD_Sequence (StartNewYear,CurrentNextSys,IsTableID,CurrentNext,IsAudited,Prefix,IsAutoSequence,AD_Sequence_ID,DateColumn,DecimalPattern,Description,Name,IncrementNo,AD_Sequence_UU,AD_Org_ID,IsOrgLevelSequence,Updated,IsActive,StartNo,StartNewMonth,AD_Client_ID,Created,MaxValue,CreatedBy,UpdatedBy) VALUES ('Y',5000,'N',1,'N','DTO-@DateDoc<yyMM>@-','Y',551783,'DateDoc','0000','Daftar Tagihan Office','Daftar Tagihan Office',1,'6c1de8f0-892d-468c-b546-e972fbdd5209',0,'N',TO_TIMESTAMP('2016-07-18 19:35:00','YYYY-MM-DD HH24:MI:SS'),'Y',1,'Y',1000001,TO_TIMESTAMP('2016-07-18 19:35:00','YYYY-MM-DD HH24:MI:SS'),0,100,100)
;

-- Jul 18, 2016 7:35:29 PM WIT
--  
INSERT INTO AD_Sequence (StartNewYear,CurrentNextSys,IsTableID,CurrentNext,IsAudited,Prefix,IsAutoSequence,AD_Sequence_ID,DateColumn,DecimalPattern,Description,Name,IncrementNo,AD_Sequence_UU,AD_Org_ID,IsOrgLevelSequence,Updated,IsActive,StartNo,StartNewMonth,AD_Client_ID,Created,MaxValue,CreatedBy,UpdatedBy) VALUES ('Y',5000,'N',1,'N','STD-@DateDoc<yyMM>@-','Y',551784,'DateDoc','0000','Serah Terima Delivery','Serah Terima Delivery',1,'a1c8c3d8-aa8a-4072-9b74-03a1e0e78216',0,'N',TO_TIMESTAMP('2016-07-18 19:35:29','YYYY-MM-DD HH24:MI:SS'),'Y',1,'Y',1000001,TO_TIMESTAMP('2016-07-18 19:35:29','YYYY-MM-DD HH24:MI:SS'),0,100,100)
;

-- Jul 18, 2016 7:35:48 PM WIT
--  
INSERT INTO AD_Sequence (StartNewYear,CurrentNextSys,IsTableID,CurrentNext,IsAudited,Prefix,IsAutoSequence,AD_Sequence_ID,DateColumn,DecimalPattern,Description,Name,IncrementNo,AD_Sequence_UU,AD_Org_ID,IsOrgLevelSequence,Updated,IsActive,StartNo,StartNewMonth,AD_Client_ID,Created,MaxValue,CreatedBy,UpdatedBy) VALUES ('Y',5000,'N',1,'N','STB-@DateDoc<yyMM>@-','Y',551785,'DateDoc','0000','Serah Terima Billing','Serah Terima Billing',1,'04cc513a-68a7-4091-a10c-e48e166c8fa2',0,'N',TO_TIMESTAMP('2016-07-18 19:35:48','YYYY-MM-DD HH24:MI:SS'),'Y',1,'Y',1000001,TO_TIMESTAMP('2016-07-18 19:35:48','YYYY-MM-DD HH24:MI:SS'),0,100,100)
;

-- Jul 18, 2016 7:36:25 PM WIT
--  
INSERT INTO C_DocType (GL_Category_ID,C_DocType_ID,IsDefault,DocBaseType,IsSOTrx,DocumentCopies,IsCreateCounter,IsIndexed,IsShipConfirm,IsSplitWhenDifference,IsDefaultCounterDoc,IsInTransit,IsPickQAConfirm,IsOverwriteDateOnComplete,IsOverwriteSeqOnComplete,C_DocType_UU,IsPrepareSplitDocument,PrintName,Name,IsDocNoControlled,HasCharges,HasProforma,Updated,IsActive,IsChargeOrProductMandatory,DocNoSequence_ID,Created,EntityType,IsAROther,IsInternal,CreateTaxInvoice,CreatedBy,UpdatedBy,AD_Org_ID,AD_Client_ID) VALUES (1000038,550275,'N','SRB','Y',1,'N','Y','N','N','N','N','N','N','N','b39392c3-9ae6-4f69-9cd7-7bace1a645cd','Y','Delivery Journal','Delivery Journal','Y','N','N',TO_TIMESTAMP('2016-07-18 19:36:25','YYYY-MM-DD HH24:MI:SS'),'Y','N',551782,TO_TIMESTAMP('2016-07-18 19:36:25','YYYY-MM-DD HH24:MI:SS'),'U','N','N','N',100,100,0,1000001)
;
...
--  
INSERT INTO C_DocType (GL_Category_ID,C_DocType_ID,IsDefault,DocBaseType,IsSOTrx,DocumentCopies,IsCreateCounter,IsIndexed,IsShipConfirm,IsSplitWhenDifference,IsDefaultCounterDoc,IsInTransit,IsPickQAConfirm,IsOverwriteDateOnComplete,IsOverwriteSeqOnComplete,C_DocType_UU,IsPrepareSplitDocument,PrintName,Name,IsDocNoControlled,HasCharges,HasProforma,Updated,IsActive,IsChargeOrProductMandatory,DocNoSequence_ID,Created,EntityType,IsAROther,IsInternal,CreateTaxInvoice,CreatedBy,UpdatedBy,AD_Org_ID,AD_Client_ID) VALUES (1000038,550276,'N','SRB','Y',1,'N','Y','N','N','N','N','N','N','N','ead2a7a3-ee4b-406b-94b8-bc57370e08c3','Y','Daftar Tagihan Office','Daftar Tagihan Office','Y','N','N',TO_TIMESTAMP('2016-07-18 19:36:59','YYYY-MM-DD HH24:MI:SS'),'Y','N',551783,TO_TIMESTAMP('2016-07-18 19:36:59','YYYY-MM-DD HH24:MI:SS'),'U','N','N','N',100,100,0,1000001)
;
