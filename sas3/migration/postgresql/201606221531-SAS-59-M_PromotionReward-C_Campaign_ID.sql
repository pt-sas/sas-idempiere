...
--  
UPDATE AD_Column SET FKConstraintName='CCampaign_MPromotionReward', FKConstraintType='N',Updated=TO_TIMESTAMP('2016-06-22 15:26:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=552000
;

-- Jun 22, 2016 3:26:33 PM WIT
--  
ALTER TABLE M_PromotionReward ADD COLUMN C_Campaign_ID NUMERIC(10) DEFAULT NULL 
;
