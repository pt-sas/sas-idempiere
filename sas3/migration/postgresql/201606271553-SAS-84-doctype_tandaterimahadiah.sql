...
--  
UPDATE C_DocType SET PrintName='Tanda Terima Hadiah', Name='TTH',Updated=TO_TIMESTAMP('2016-06-27 15:52:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=1000012
;
