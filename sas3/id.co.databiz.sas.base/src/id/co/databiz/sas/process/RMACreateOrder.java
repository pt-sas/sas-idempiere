...
public class RMACreateOrder extends SvrProcess
{
    ...
    protected String doIt() throws Exception
    {
        ...
        order.setAD_OrgTrx_ID(originalOrder.getAD_OrgTrx_ID()); //SAS-238
        order.setC_Project_ID(SASSystemID.PROJECT_RETAIL); //SAS-238
        order.setInvoiceRule(SASSystemID.INVOICE_RULE_AFTER_DELIVERY);  //SAS-238
        ...
        order.setC_DocTypeTarget_ID(SASSystemID.DOCTYPE_ORDER_LAIN_LAIN); //SAS-238
