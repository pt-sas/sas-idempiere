...
public class MOrder extends org.compiere.model.MOrder implements DocAction
{
	 ...
	 *	@return shipment or null
	 */
	public static MInOut createShipment(MDocType dt, Timestamp movementDate, org.compiere.model.MOrder order)
	{
//		if (log.isLoggable(Level.INFO)) log.info("For " + dt);
...
//			return null;
	 ...
	 *	@return invoice or null
	 */
	public static MInvoice createInvoice (MDocType dt, org.compiere.model.MInOut shipment, Timestamp invoiceDate, org.compiere.model.MOrder order)
	{
//		if (log.isLoggable(Level.INFO)) log.info(dt.toString());
