...
.desktop-header {
	...
	width: 100%;
	height: 30px;
	border-bottom: 3px solid rgb(230,160, 8);
}
...
.z-panel-hm {
	background-image: none; 
	background-color: rgb(232, 240, 191);
}
...
.desktop-header .z-label , .desktop-header .z-toolbarbutton-cnt{
	color: white;
}
