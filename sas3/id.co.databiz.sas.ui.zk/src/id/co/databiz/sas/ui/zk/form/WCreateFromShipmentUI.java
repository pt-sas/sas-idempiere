...
//import static org.compiere.model.SystemIDs.WINDOW_SHIPMENT_CUSTOMER;
...
public class WCreateFromShipmentUI extends CreateFromShipment implements EventListener<Event>, ValueChangeListener
{
	...
	protected void zkInit() throws Exception
	{
    	...
    	boolean isShipmentWindow = getGridTab().getAD_Window_ID() == 169; // Shipment(Customer HardCoded)

    	bPartnerLabel.setText(Msg.getElement(Env.getCtx(), "C_BPartner_ID"));
		orderLabel.setText(Msg.getElement(Env.getCtx(), "C_Order_ID"));
    	...
    	if (! isRMAWindow && ! isShipmentWindow) {
